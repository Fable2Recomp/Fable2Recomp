...
loc_82BCD3D8:
	...
	// bgt cr6,0x82bcd438
	if (ctx.cr6.gt) goto loc_82BCD438;
	// lwz r11,44(r31)
	...
	// bge cr6,0x82bcd434
	if (!ctx.cr6.lt) goto loc_82BCD434;
	// addi r4,r11,1
...
PPC_FUNC_IMPL(__imp__sub_82BCD460) {
	...
	// blt cr6,0x82bcd49c
	if (ctx.cr6.lt) goto loc_82BCD49C;
	// mr r3,r31
	ctx.r3.u64 = ctx.r31.u64;
	// bl 0x8227b8b8
	ctx.lr = 0x82BCD49C;
...
loc_82BCD49C:
	...
	// bne cr6,0x82bcd4b0
	if (!ctx.cr6.eq) goto loc_82BCD4B0;
	// lis r11,-32066
...
loc_82BCD4B8:
	...
	// beq cr6,0x82bcd580
	if (ctx.cr6.eq) goto loc_82BCD580;
	// addi r28,r24,20
...
loc_82BCD508:
	...
	// beq cr6,0x82bcd5d4
	if (ctx.cr6.eq) goto loc_82BCD5D4;
	// lwz r10,68(r29)
	...
	// blt cr6,0x82bcd508
	if (ctx.cr6.lt) goto loc_82BCD508;
loc_82BCD580:
	// lwz r11,8(r31)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 8);
	// li r10,6
	...
	ctx.cr6.compare<int32_t>(ctx.r7.s32, 8, ctx.xer);
	// bgt cr6,0x82bcd5c0
	if (ctx.cr6.gt) goto loc_82BCD5C0;
	// lwz r11,44(r31)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 44);
	// mr r3,r31
	ctx.r3.u64 = ctx.r31.u64;
	...
	ctx.r4.u64 = __builtin_rotateleft64(ctx.r11.u32 | (ctx.r11.u64 << 32), 1) & 0xFFFFFFFE;
	// bge cr6,0x82bcd5bc
	if (!ctx.cr6.lt) goto loc_82BCD5BC;
	// addi r4,r11,1
	ctx.r4.s64 = ctx.r11.s64 + 1;
loc_82BCD5BC:
	// bl 0x82bccd58
...
PPC_FUNC_IMPL(__imp__sub_82BCD5E0) {
	...
	// bne cr6,0x82bcd624
	if (!ctx.cr6.eq) goto loc_82BCD624;
	// li r11,1
	ctx.r11.s64 = 1;
	// lbz r10,6(r6)
...
__attribute__((alias("__imp__sub_82BCD694"))) PPC_WEAK_FUNC(sub_82BCD694);
PPC_FUNC_IMPL(__imp__sub_82BCD694) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
...
PPC_FUNC_IMPL(__imp__sub_82BCD698) {
	...
	// beq cr6,0x82bcd7a8
	if (ctx.cr6.eq) goto loc_82BCD7A8;
	// lis r11,16383
	...
	ctx.cr6.compare<uint32_t>(ctx.r10.u32, ctx.r9.u32, ctx.xer);
	// bgt cr6,0x82bcd6e8
	if (ctx.cr6.gt) goto loc_82BCD6E8;
...
loc_82BCD6F8:
	...
	// ble cr6,0x82bcd724
	if (!ctx.cr6.gt) goto loc_82BCD724;
	// mr r11,r31
	...
	// beq cr6,0x82bcd724
	if (ctx.cr6.eq) goto loc_82BCD724;
	// mtctr r29
...
loc_82BCD718:
	...
	// bdnz 0x82bcd718
	--ctx.ctr.u64;
	if (ctx.ctr.u32 != 0) goto loc_82BCD718;
loc_82BCD724:
	// lwz r11,8(r30)
	...
	ctx.cr6.compare<int32_t>(ctx.r11.s32, 0, ctx.xer);
	// ble cr6,0x82bcd788
	if (!ctx.cr6.gt) goto loc_82BCD788;
	// li r7,0
	ctx.r7.s64 = 0;
loc_82BCD738:
	// lwz r11,0(r30)
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// beq cr6,0x82bcd774
	if (ctx.cr6.eq) goto loc_82BCD774;
	// addi r8,r29,-1
...
loc_82BCD74C:
	...
	// bne cr6,0x82bcd74c
	if (!ctx.cr6.eq) goto loc_82BCD74C;
loc_82BCD774:
	// lwz r11,8(r30)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r30.u32 + 8);
	// addi r6,r6,1
	...
	// blt cr6,0x82bcd738
	if (ctx.cr6.lt) goto loc_82BCD738;
loc_82BCD788:
	// lwz r11,8(r30)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r30.u32 + 8);
	// li r6,0
...
PPC_FUNC_IMPL(__imp__sub_82BCD7B0) {
	...
	// ble cr6,0x82bcd7e8
	if (!ctx.cr6.gt) goto loc_82BCD7E8;
	// lis r11,-32241
	ctx.r11.s64 = -2112946176;
	// addi r4,r11,11760
	ctx.r4.s64 = ctx.r11.s64 + 11760;
...
PPC_FUNC_IMPL(__imp__sub_82BCD8A8) {
	...
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq cr6,0x82bcd914
	if (ctx.cr6.eq) goto loc_82BCD914;
	// lwz r11,80(r1)
...
__attribute__((alias("__imp__sub_82BCD92C"))) PPC_WEAK_FUNC(sub_82BCD92C);
PPC_FUNC_IMPL(__imp__sub_82BCD92C) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
...
PPC_FUNC_IMPL(__imp__sub_82BCD930) {
	...
	// ble cr6,0x82bcd99c
	if (!ctx.cr6.gt) goto loc_82BCD99C;
	// cmplwi cr6,r30,32
	ctx.cr6.compare<uint32_t>(ctx.r30.u32, 32, ctx.xer);
	// bge cr6,0x82bcd964
	if (!ctx.cr6.lt) goto loc_82BCD964;
	// li r30,32
	ctx.r30.s64 = 32;
loc_82BCD964:
	// addi r11,r30,1
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, ctx.r10.u32, ctx.xer);
	// bgt cr6,0x82bcd984
	if (ctx.cr6.gt) goto loc_82BCD984;
	// mr r6,r30
...
PPC_FUNC_IMPL(__imp__sub_82BCD9B8) {
	...
	// ble cr6,0x82bcda48
	if (!ctx.cr6.gt) goto loc_82BCDA48;
	// lis r10,32767
	...
	// blt cr6,0x82bcda04
	if (ctx.cr6.lt) goto loc_82BCDA04;
	// lis r11,-32241
	ctx.r11.s64 = -2112946176;
	// li r5,0
	ctx.r5.s64 = 0;
...
loc_82BCDA04:
	...
	ctx.cr6.compare<uint32_t>(ctx.r10.u32, ctx.r11.u32, ctx.xer);
	// bgt cr6,0x82bcda30
	if (ctx.cr6.gt) goto loc_82BCDA30;
	// mr r6,r29
...
PPC_FUNC_IMPL(__imp__sub_82BCDA68) {
	...
	// bge cr6,0x82bcdacc
	if (!ctx.cr6.lt) goto loc_82BCDACC;
	// bl 0x82cb7d90
	ctx.lr = 0x82BCDA90;
	...
	// beq cr6,0x82bcdabc
	if (ctx.cr6.eq) goto loc_82BCDABC;
	// lis r11,-32241
	ctx.r11.s64 = -2112946176;
	// addi r4,r11,12860
...
__attribute__((alias("__imp__sub_82BCDBA4"))) PPC_WEAK_FUNC(sub_82BCDBA4);
PPC_FUNC_IMPL(__imp__sub_82BCDBA4) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
...
PPC_FUNC_IMPL(__imp__sub_82BCDBA8) {
	...
	// bne cr6,0x82bcdc04
	if (!ctx.cr6.eq) goto loc_82BCDC04;
	// li r10,1
	ctx.r10.s64 = 1;
	// stw r10,0(r11)
	PPC_STORE_U32(ctx.r11.u32 + 0, ctx.r10.u32);
...
__attribute__((alias("__imp__sub_82BCDC1C"))) PPC_WEAK_FUNC(sub_82BCDC1C);
PPC_FUNC_IMPL(__imp__sub_82BCDC1C) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
...
PPC_FUNC_IMPL(__imp__sub_82BCDC20) {
	...
	// beq cr6,0x82bcdc6c
	if (ctx.cr6.eq) goto loc_82BCDC6C;
	// lwz r11,36(r31)
...
loc_82BCDC74:
	...
	// beq cr6,0x82bcdc88
	if (ctx.cr6.eq) goto loc_82BCDC88;
	// cmpwi cr6,r3,13
	ctx.cr6.compare<int32_t>(ctx.r3.s32, 13, ctx.xer);
	// bne cr6,0x82bcdccc
	if (!ctx.cr6.eq) goto loc_82BCDCCC;
loc_82BCDC88:
	// cmpw cr6,r3,r30
	...
	PPC_STORE_U32(ctx.r10.u32 + 0, ctx.r9.u32);
	// beq cr6,0x82bcdcc0
	if (ctx.cr6.eq) goto loc_82BCDCC0;
	// lwz r11,36(r31)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 36);
	// lwz r10,4(r11)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r11.u32 + 4);
...
loc_82BCDCCC:
	...
	// blt cr6,0x82bcdcfc
	if (ctx.cr6.lt) goto loc_82BCDCFC;
	// lis r11,-32241
	ctx.r11.s64 = -2112946176;
	// lwz r5,12(r31)
...
__attribute__((alias("__imp__sub_82BCDD14"))) PPC_WEAK_FUNC(sub_82BCDD14);
PPC_FUNC_IMPL(__imp__sub_82BCDD14) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
...
PPC_FUNC_IMPL(__imp__sub_82BCDD18) {
	...
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// bne cr6,0x82bcdd98
	if (!ctx.cr6.eq) goto loc_82BCDD98;
	// li r4,4
	ctx.r4.s64 = 4;
	// mr r3,r29
	ctx.r3.u64 = ctx.r29.u64;
...
loc_82BCDD98:
	...
	// beq cr6,0x82bcddf4
	if (ctx.cr6.eq) goto loc_82BCDDF4;
	// lwz r11,36(r31)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 36);
	// lwz r10,4(r11)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r11.u32 + 4);
...
PPC_FUNC_IMPL(__imp__sub_82BCDE08) {
	...
	PPC_STORE_U32(ctx.r10.u32 + 0, ctx.r9.u32);
	// beq cr6,0x82bcde58
	if (ctx.cr6.eq) goto loc_82BCDE58;
	// lwz r11,36(r31)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 36);
	// lwz r10,4(r11)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r11.u32 + 4);
...
PPC_FUNC_IMPL(__imp__sub_82BCDE80) {
	...
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq cr6,0x82bcdeb8
	if (ctx.cr6.eq) goto loc_82BCDEB8;
	// lwz r11,0(r3)
...
loc_82BCDEDC:
	...
	// bne cr6,0x82bcdef4
	if (!ctx.cr6.eq) goto loc_82BCDEF4;
	// stbx r9,r10,r11
...
loc_82BCDEF4:
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// bne cr6,0x82bcdedc
	if (!ctx.cr6.eq) goto loc_82BCDEDC;
loc_82BCDEFC:
	// lwz r11,40(r31)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 40);
	// mr r4,r30
	...
	// bne cr6,0x82bcdfbc
	if (!ctx.cr6.eq) goto loc_82BCDFBC;
	// lwz r10,40(r31)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r31.u32 + 40);
	// lbz r9,48(r31)
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// beq cr6,0x82bcdf50
	if (ctx.cr6.eq) goto loc_82BCDF50;
	// extsb r9,r9
...
loc_82BCDF30:
	...
	// bne cr6,0x82bcdf48
	if (!ctx.cr6.eq) goto loc_82BCDF48;
	// stbx r29,r10,r11
...
loc_82BCDF48:
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// bne cr6,0x82bcdf30
	if (!ctx.cr6.eq) goto loc_82BCDF30;
loc_82BCDF50:
	// lwz r11,44(r31)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 44);
	// li r5,80
...
__attribute__((alias("__imp__sub_82BCDFC4"))) PPC_WEAK_FUNC(sub_82BCDFC4);
PPC_FUNC_IMPL(__imp__sub_82BCDFC4) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
...
loc_82BCDFDC:
	...
	PPC_STORE_U32(ctx.r10.u32 + 0, ctx.r9.u32);
	// beq cr6,0x82bce018
	if (ctx.cr6.eq) goto loc_82BCE018;
	// lwz r11,36(r31)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 36);
	// lwz r10,4(r11)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r11.u32 + 4);
...
loc_82BCE090:
	...
	ctx.cr6.compare<uint32_t>(ctx.r9.u32, 0, ctx.xer);
	// bne cr6,0x82bce0b8
	if (!ctx.cr6.eq) goto loc_82BCE0B8;
	// cmpwi cr6,r30,95
	ctx.cr6.compare<int32_t>(ctx.r30.s32, 95, ctx.xer);
	// bne cr6,0x82bce108
	if (!ctx.cr6.eq) goto loc_82BCE108;
loc_82BCE0B8:
	// mr r4,r30
	ctx.r4.u64 = ctx.r30.u64;
	// mr r3,r31
...
loc_82BCE108:
	...
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r10.u32 + 0);
	// beq cr6,0x82bce148
	if (ctx.cr6.eq) goto loc_82BCE148;
loc_82BCE12C:
	// addi r11,r11,-1
	ctx.r11.s64 = ctx.r11.s64 + -1;
	// lbzx r8,r10,r11
	...
	// bne cr6,0x82bce140
	if (!ctx.cr6.eq) goto loc_82BCE140;
	// stbx r9,r10,r11
	PPC_STORE_U8(ctx.r10.u32 + ctx.r11.u32, ctx.r9.u8);
loc_82BCE140:
	// cmplwi cr6,r11,0
...
__attribute__((alias("__imp__sub_82BCE174"))) PPC_WEAK_FUNC(sub_82BCE174);
PPC_FUNC_IMPL(__imp__sub_82BCE174) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
...
loc_82BCE1DC:
	...
	PPC_STORE_U32(ctx.r10.u32 + 0, ctx.r9.u32);
	// beq cr6,0x82bce218
	if (ctx.cr6.eq) goto loc_82BCE218;
	// lwz r11,36(r31)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 36);
	// lwz r10,4(r11)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r11.u32 + 4);
...
loc_82BCE234:
	...
	// beq cr6,0x82bce248
	if (ctx.cr6.eq) goto loc_82BCE248;
	// subfic r3,r30,-1
