...
PPC_FUNC_IMPL(__imp__sub_82C60CD0) {
	...
	r11.s64 = -2094071808;
	// lwz r5,-22688(r11)
	ctx.r5.u64 = PPC_LOAD_U32(r11.u32 + -22688);
	// b 0x82c60c90
...
PPC_FUNC_IMPL(__imp__sub_82C60ED8) {
	...
	ctx.r3.u64 = r31.u64;
	// lwz r5,-22684(r29)
	ctx.r5.u64 = PPC_LOAD_U32(r29.u32 + -22684);
	// bl 0x82c60ce0
	sub_82C60CE0(ctx, base);
	// mr r10,r3
	ctx.r10.u64 = ctx.r3.u64;
...
PPC_FUNC_IMPL(__imp__sub_82C61178) {
	...
	r11.s64 = -2091974656;
	// lwz r10,29588(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + 29588);
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beq cr6,0x82c61194
...
PPC_FUNC_IMPL(__imp__sub_82C611A0) {
	...
	r11.s64 = -2091974656;
	// lwz r10,29592(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + 29592);
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_82C611C0) {
	...
	r11.s64 = -2091974656;
	// lwz r10,29580(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + 29580);
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_82C611E0) {
	...
	r11.s64 = -2091974656;
	// lwz r10,29584(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + 29584);
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
loc_82C615C8:
	// fmadds f8,f13,f9,f0
	ctx.fpscr.disableFlushMode();
	ctx.f8.f64 = double(float(ctx.f13.f64 * ctx.f9.f64 + f0.f64));
	// stfs f8,28(r3)
...
PPC_FUNC_IMPL(__imp__sub_82C63258) {
	...
	// lwz r11,22452(r9)
	r11.u64 = PPC_LOAD_U32(ctx.r9.u32 + 22452);
	// clrlwi r10,r11,31
	ctx.r10.u64 = r11.u32 & 0x1;
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
...
PPC_FUNC_IMPL(__imp__sub_82C63320) {
	...
	ctx.r9.s64 = -2093809664;
	// lwz r11,22460(r9)
	r11.u64 = PPC_LOAD_U32(ctx.r9.u32 + 22460);
	// clrlwi r10,r11,31
	ctx.r10.u64 = r11.u32 & 0x1;
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
...
loc_82C63A0C:
	...
	r31.s64 = -2093809664;
	// lwz r11,22468(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + 22468);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82c63a28
...
loc_82C63A98:
	...
	// lwz r22,15052(r6)
	r22.u64 = PPC_LOAD_U32(ctx.r6.u32 + 15052);
	// lwz r22,15052(r6)
	r22.u64 = PPC_LOAD_U32(ctx.r6.u32 + 15052);
	// lwz r22,15260(r6)
	r22.u64 = PPC_LOAD_U32(ctx.r6.u32 + 15260);
	// lwz r22,15260(r6)
	r22.u64 = PPC_LOAD_U32(ctx.r6.u32 + 15260);
loc_82C63ACC:
	// bl 0x82c63320
...
PPC_FUNC_IMPL(__imp__sub_82C64708) {
	...
	ctx.r6.s64 = 1;
	// lwz r4,22488(r11)
	ctx.r4.u64 = PPC_LOAD_U32(r11.u32 + 22488);
	// addi r5,r1,96
	ctx.r5.s64 = ctx.r1.s64 + 96;
	// stw r30,120(r1)
...
loc_82C65190:
	...
	sub_82C64B28(ctx, base);
	// lwz r8,104(r24)
	ctx.r8.u64 = PPC_LOAD_U32(r24.u32 + 104);
	// cmplw cr6,r22,r8
...
loc_82C65DE0:
	...
	// lwz r11,22484(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 22484);
	// clrlwi r9,r11,31
...
loc_82C65FC8:
	...
	ctx.r3.u64 = r28.u64;
	// lwz r11,22476(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 22476);
	// mr r31,r11
	r31.u64 = r11.u64;
	// addi r11,r11,1
	r11.s64 = r11.s64 + 1;
...
loc_82C66654:
	...
	// lwz r26,60(r29)
	r26.u64 = PPC_LOAD_U32(r29.u32 + 60);
	// addi r3,r1,104
	ctx.r3.s64 = ctx.r1.s64 + 104;
	// lwz r30,4(r31)
...
loc_82C66744:
	...
	// lwz r6,60(r29)
	ctx.r6.u64 = PPC_LOAD_U32(r29.u32 + 60);
	// lwz r7,0(r31)
...
loc_82C67CC0:
	...
	// lwz r6,60(r21)
	ctx.r6.u64 = PPC_LOAD_U32(r21.u32 + 60);
	// addi r4,r21,44
...
loc_82C6806C:
	// lwz r3,100(r21)
	ctx.r3.u64 = PPC_LOAD_U32(r21.u32 + 100);
	// addi r11,r21,96
	r11.s64 = r21.s64 + 96;
	// stw r29,100(r21)
	PPC_STORE_U32(r21.u32 + 100, r29.u32);
	// lwz r4,104(r21)
	ctx.r4.u64 = PPC_LOAD_U32(r21.u32 + 104);
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// stw r29,104(r21)
...
loc_82C68CE8:
	...
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
	// rotlwi r24,r3,0
	r24.u64 = __builtin_rotateleft32(ctx.r3.u32, 0);
	// lwz r22,88(r1)
