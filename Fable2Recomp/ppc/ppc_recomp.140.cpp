...
PPC_FUNC_IMPL(__imp__sub_82D7F5B0) {
	...
	// lwz r22,-2568(r23)
	r22.u64 = PPC_LOAD_U32(r23.u32 + -2568);
	// lwz r22,-2532(r23)
	r22.u64 = PPC_LOAD_U32(r23.u32 + -2532);
	// lwz r22,-2496(r23)
	r22.u64 = PPC_LOAD_U32(r23.u32 + -2496);
	// lwz r22,-2488(r23)
	r22.u64 = PPC_LOAD_U32(r23.u32 + -2488);
	// lwz r22,-2452(r23)
	r22.u64 = PPC_LOAD_U32(r23.u32 + -2452);
	// lwz r22,-2416(r23)
	r22.u64 = PPC_LOAD_U32(r23.u32 + -2416);
	// lwz r22,-2408(r23)
	r22.u64 = PPC_LOAD_U32(r23.u32 + -2408);
	// lwz r22,-2372(r23)
	r22.u64 = PPC_LOAD_U32(r23.u32 + -2372);
	// lwz r22,-2336(r23)
	r22.u64 = PPC_LOAD_U32(r23.u32 + -2336);
loc_82D7F5F8:
	// lis r11,-32256
	r11.s64 = -2113929216;
	// li r10,2
...
loc_82D81460:
	...
	// lwz r22,6592(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 6592);
	// lwz r22,6400(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 6400);
	// lwz r22,6436(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 6436);
	// lwz r22,5356(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 5356);
	// lwz r22,5440(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 5440);
	// lwz r22,5524(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 5524);
	// lwz r22,5572(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 5572);
	// lwz r22,5624(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 5624);
	// lwz r22,5672(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 5672);
	// lwz r22,5708(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 5708);
	// lwz r22,5748(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 5748);
	// lwz r22,5800(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 5800);
	// lwz r22,5852(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 5852);
	// lwz r22,5904(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 5904);
	// lwz r22,6176(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 6176);
	// lwz r22,6232(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 6232);
	// lwz r22,5952(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 5952);
	// lwz r22,6008(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 6008);
	// lwz r22,6064(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 6064);
	// lwz r22,6120(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 6120);
	// lwz r22,6288(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 6288);
	// lwz r22,6344(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 6344);
	// lwz r22,6476(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 6476);
	// lwz r22,6516(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 6516);
	// lwz r22,6540(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 6540);
loc_82D814EC:
	// lvx128 v0,r0,r31
	...
	// lvx128 v12,r4,r25
	_mm_store_si128((__m128i*)ctx.v12.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r4.u32 + r25.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// vspltw v0,v0,2
	_mm_store_si128((__m128i*)ctx.v0.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)ctx.v0.u32), 0x55));
	// lvx128 v11,r4,r26
	_mm_store_si128((__m128i*)ctx.v11.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r4.u32 + r26.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// addi r10,r1,224
...
loc_82D81540:
	...
	_mm_store_si128((__m128i*)ctx.v9.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)ctx.v0.u32), 0xAA));
	// lvx128 v12,r10,r25
	_mm_store_si128((__m128i*)ctx.v12.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r10.u32 + r25.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// vspltw v0,v0,2
	_mm_store_si128((__m128i*)ctx.v0.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)ctx.v0.u32), 0x55));
	// lvx128 v11,r10,r26
	_mm_store_si128((__m128i*)ctx.v11.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r10.u32 + r26.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// addi r9,r1,224
...
loc_82D81674:
	...
	// lvx128 v0,r4,r25
	_mm_store_si128((__m128i*)ctx.v0.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r4.u32 + r25.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// stvx128 v0,r0,r11
	_mm_store_si128((__m128i*)(base + ((r11.u32) & ~0xF)), _mm_shuffle_epi8(_mm_load_si128((__m128i*)ctx.v0.u8), _mm_load_si128((__m128i*)VectorMaskL)));
	// addi r11,r1,304
	r11.s64 = ctx.r1.s64 + 304;
	// lvx128 v0,r4,r26
	_mm_store_si128((__m128i*)ctx.v0.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r4.u32 + r26.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// stvx128 v0,r0,r11
	_mm_store_si128((__m128i*)(base + ((r11.u32) & ~0xF)), _mm_shuffle_epi8(_mm_load_si128((__m128i*)ctx.v0.u8), _mm_load_si128((__m128i*)VectorMaskL)));
	// lwz r10,372(r1)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r1.u32 + 372);
...
PPC_FUNC_IMPL(__imp__sub_82D81B48) {
	...
	r11.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 4) & 0xFFFFFFF0;
	// lvx128 v13,r10,r31
	_mm_store_si128((__m128i*)ctx.v13.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r10.u32 + r31.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// addi r10,r1,96
	ctx.r10.s64 = ctx.r1.s64 + 96;
	// stvx128 v13,r0,r10
	_mm_store_si128((__m128i*)(base + ((ctx.r10.u32) & ~0xF)), _mm_shuffle_epi8(_mm_load_si128((__m128i*)ctx.v13.u8), _mm_load_si128((__m128i*)VectorMaskL)));
...
PPC_FUNC_IMPL(__imp__sub_82D81F68) {
	...
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r9.u32 + 0);
	// lvx128 v13,r31,r6
	_mm_store_si128((__m128i*)ctx.v13.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((r31.u32 + ctx.r6.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// lwz r11,0(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 0);
	// addi r9,r9,2
	ctx.r9.s64 = ctx.r9.s64 + 2;
...
PPC_FUNC_IMPL(__imp__sub_82D822F0) {
	...
	ctx.r10.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 2) & 0xFFFFFFFC;
	// lwz r26,76(r29)
	r26.u64 = PPC_LOAD_U32(r29.u32 + 76);
	// addi r11,r11,5
	r11.s64 = r11.s64 + 5;
	// addi r4,r30,16
...
loc_82D8241C:
	...
	f0.f64 = double(float(-(f31.f64 * f0.f64 + f29.f64)));
	// rlwinm r11,r11,3,0,28
	r11.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 3) & 0xFFFFFFF8;
	// ldx r11,r11,r26
	r11.u64 = PPC_LOAD_U64(r11.u32 + r26.u32);
...
loc_82D82B60:
	...
	// lwz r22,11488(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11488);
	// lwz r22,11476(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11476);
	// lwz r22,11476(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11476);
	// lwz r22,11472(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11472);
	// lwz r22,11472(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11472);
	// lwz r22,11472(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11472);
	// lwz r22,11240(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11240);
	// lwz r22,11260(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11260);
	// lwz r22,11476(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11476);
	// lwz r22,11476(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11476);
	...
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11476);
	// lwz r22,11300(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11300);
	// lwz r22,11260(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11260);
	// lwz r22,11384(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11384);
	// lwz r22,11396(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11396);
	// lwz r22,11328(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11328);
	// lwz r22,11240(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11240);
	// lwz r22,11240(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11240);
	// lwz r22,11340(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11340);
	// lwz r22,11416(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11416);
	// lwz r22,11436(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11436);
	// lwz r22,11476(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11476);
	// lwz r22,11476(r24)
	r22.u64 = PPC_LOAD_U32(r24.u32 + 11476);
...
loc_82D830D8:
	...
	// lvx128 v0,r29,r8
	_mm_store_si128((__m128i*)ctx.v0.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((r29.u32 + ctx.r8.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// stvx128 v0,r0,r11
	_mm_store_si128((__m128i*)(base + ((r11.u32) & ~0xF)), _mm_shuffle_epi8(_mm_load_si128((__m128i*)ctx.v0.u8), _mm_load_si128((__m128i*)VectorMaskL)));
	// lwz r11,4(r30)
	r11.u64 = PPC_LOAD_U32(r30.u32 + 4);
...
PPC_FUNC_IMPL(__imp__sub_82D847A8) {
	...
	// lvx128 v0,r9,r28
	_mm_store_si128((__m128i*)ctx.v0.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r9.u32 + r28.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// stvx128 v0,r8,r28
	...
	// lvx128 v0,r3,r30
	_mm_store_si128((__m128i*)ctx.v0.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r3.u32 + r30.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// stvx128 v0,r4,r30
	_mm_store_si128((__m128i*)(base + ((ctx.r4.u32 + r30.u32) & ~0xF)), _mm_shuffle_epi8(_mm_load_si128((__m128i*)ctx.v0.u8), _mm_load_si128((__m128i*)VectorMaskL)));
	// lvx128 v0,r3,r31
	...
	// stvx128 v0,r4,r31
	_mm_store_si128((__m128i*)(base + ((ctx.r4.u32 + r31.u32) & ~0xF)), _mm_shuffle_epi8(_mm_load_si128((__m128i*)ctx.v0.u8), _mm_load_si128((__m128i*)VectorMaskL)));
	// lbz r11,9(r3)
