...
PPC_FUNC_IMPL(__imp__sub_82C44020) {
	...
	PPC_STORE_U32(r30.u32 + 0, ctx.r9.u32);
	// lwz r11,19988(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 19988);
	// addic. r11,r11,-1
	xer.ca = r11.u32 > 0;
	r11.s64 = r11.s64 + -1;
...
loc_82C447E4:
	...
	// rotlwi r27,r3,0
	r27.u64 = __builtin_rotateleft32(ctx.r3.u32, 0);
	// lwz r4,104(r1)
...
loc_82C4484C:
	...
	r30.u64 = __builtin_rotateleft64(ctx.r4.u32 | (ctx.r4.u64 << 32), 27) & 0x1;
	// beq cr6,0x82c448cc
...
loc_82C466CC:
	...
	// lwz r11,20044(r8)
	r11.u64 = PPC_LOAD_U32(ctx.r8.u32 + 20044);
	// stw r7,100(r1)
...
loc_82C48ABC:
	...
	f0.f64 = double(float(ctx.f11.f64 * ctx.f11.f64 + ctx.f10.f64));
	// fcmpu cr6,f0,f31
...
loc_82C49800:
	...
	// fmadds f12,f5,f7,f0
	ctx.f12.f64 = double(float(ctx.f5.f64 * ctx.f7.f64 + f0.f64));
loc_82C4983C:
	...
	// fmadds f13,f4,f6,f0
	ctx.f13.f64 = double(float(ctx.f4.f64 * ctx.f6.f64 + f0.f64));
loc_82C49894:
...
loc_82C498C0:
	...
	// fmadds f0,f3,f5,f0
	f0.f64 = double(float(ctx.f3.f64 * ctx.f5.f64 + f0.f64));
	// fmuls f0,f0,f13
	f0.f64 = double(float(f0.f64 * ctx.f13.f64));
	// fmuls f1,f0,f12
	ctx.f1.f64 = double(float(f0.f64 * ctx.f12.f64));
...
loc_82C49D0C:
	...
	ctx.r6.u64 = PPC_LOAD_U32(ctx.r9.u32 + 32);
	// lwz r31,32(r8)
	r31.u64 = PPC_LOAD_U32(ctx.r8.u32 + 32);
	// cmplw cr6,r6,r31
	cr6.compare<uint32_t>(ctx.r6.u32, r31.u32, xer);
	// bge cr6,0x82c49d34
...
PPC_FUNC_IMPL(__imp__sub_82C4BF98) {
	...
	// lwz r11,20380(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 20380);
	// cmpwi cr6,r11,0
	cr6.compare<int32_t>(r11.s32, 0, xer);
	// bgt cr6,0x82c4bfe4
...
loc_82C4CAA0:
	...
	ctx.f10.f64 = double(temp.f32);
	// stvx128 v125,r0,r5
	_mm_store_si128((__m128i*)(base + ((ctx.r5.u32) & ~0xF)), _mm_shuffle_epi8(_mm_load_si128((__m128i*)v125.u8), _mm_load_si128((__m128i*)VectorMaskL)));
	// mr r3,r31
	ctx.r3.u64 = r31.u64;
	// lfs f0,88(r1)
