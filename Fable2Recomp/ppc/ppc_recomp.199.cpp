...
PPC_FUNC_IMPL(__imp__sub_831FBA60) {
	...
	// bgt cr6,0x831fbac0
	if (ctx.cr6.gt) goto loc_831FBAC0;
	// lis r12,-32247
...
PPC_FUNC_IMPL(__imp__sub_831FBAC8) {
	...
	// bgt cr6,0x831fbb24
	if (ctx.cr6.gt) goto loc_831FBB24;
	// lis r12,-32247
	ctx.r12.s64 = -2113339392;
	// addi r12,r12,-31424
...
PPC_FUNC_IMPL(__imp__sub_831FBB30) {
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 36, ctx.xer);
	// bgt cr6,0x831fbb84
	if (ctx.cr6.gt) goto loc_831FBB84;
	// lis r12,-32247
	ctx.r12.s64 = -2113339392;
	// addi r12,r12,-31320
...
PPC_FUNC_IMPL(__imp__sub_831FBB90) {
	...
	// bgt cr6,0x831fbd0c
	if (ctx.cr6.gt) goto loc_831FBD0C;
	// lis r12,-32247
	ctx.r12.s64 = -2113339392;
	// addi r12,r12,-31280
...
PPC_FUNC_IMPL(__imp__sub_831FBD28) {
	...
	// bgt cr6,0x831fbe78
	if (ctx.cr6.gt) goto loc_831FBE78;
	// lis r12,-32247
	ctx.r12.s64 = -2113339392;
	// addi r12,r12,-31216
