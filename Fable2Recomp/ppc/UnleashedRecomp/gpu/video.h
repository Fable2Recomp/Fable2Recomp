...
#include "UnleashedRecomp/xenia/base/memory.h"
...
struct GuestResource
{
    ...
    void AddRef()
    {
        ...
        } while (!refCount.atomic_compare_exchange_weak(originalValue, incrementedValue));
    }
    ...
    void Release()
    {
        ...
        } while (!refCount.atomic_compare_exchange_weak(originalValue, decrementedValue));
