...
PPC_FUNC_IMPL(__imp__sub_83297770) {
	...
	// lwz r11,-25016(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-25016) );
	// stw r11,80(r10)
...
PPC_FUNC_IMPL(__imp__sub_83297E98) {
	...
	// lwz r11,-20136(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-20136) );
	// stw r11,104(r10)
...
PPC_FUNC_IMPL(__imp__sub_83298D88) {
	...
	r11.s64 = -2094006272;
	// lwz r10,-22376(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-22376) );
	// lis r11,-31952
	r11.s64 = -2094006272;
	// addi r11,r11,-22320
	...
	ctx.r10.s64 = -2094006272;
	// lwz r10,-22384(r10)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(-22384) );
	// stw r10,32(r11)
...
PPC_FUNC_IMPL(__imp__sub_83298E20) {
	...
	// lwz r11,-22384(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-22384) );
	// stw r11,152(r10)
...
PPC_FUNC_IMPL(__imp__sub_83299110) {
	...
	// lwz r11,-21400(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-21400) );
	// stw r11,8(r10)
...
PPC_FUNC_IMPL(__imp__sub_83299648) {
	...
	// lwz r11,-21176(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-21176) );
	// stw r11,104(r10)
	PPC_STORE_U32(ctx.r10.u32 + 104, r11.u32);
	// stw r11,128(r10)
...
PPC_FUNC_IMPL(__imp__sub_8329ABF8) {
	...
	// lwz r11,-13280(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-13280) );
	// stw r11,128(r10)
	PPC_STORE_U32(ctx.r10.u32 + 128, r11.u32);
	// blr 
	return;
