...
PPC_FUNC_IMPL(__imp__sub_82EE7668) {
	...
	// bge cr6,0x82ee76f8
	if (!cr6.lt) goto loc_82EE76F8;
	// lis r11,-31946
	r11.s64 = -2093613056;
	// lbz r11,-29288(r11)
	r11.u64 = PPC_LOAD_U8(r11.u32 + -29288);
	// cmpwi r11,0
	cr0.compare<int32_t>(r11.s32, 0, xer);
	// bne 0x82ee76f8
	if (!cr0.eq) goto loc_82EE76F8;
	// lis r11,-31946
	r11.s64 = -2093613056;
	// addi r31,r11,-29288
...
PPC_FUNC_IMPL(__imp__sub_82EE7768) {
	...
	// blt cr6,0x82ee77e0
	if (cr6.lt) goto loc_82EE77E0;
	// lis r11,-31946
	r11.s64 = -2093613056;
	// lbz r11,-29287(r11)
	r11.u64 = PPC_LOAD_U8(r11.u32 + -29287);
	// cmpwi r11,0
	cr0.compare<int32_t>(r11.s32, 0, xer);
	// bne 0x82ee77e0
	if (!cr0.eq) goto loc_82EE77E0;
	// lis r11,-31946
	r11.s64 = -2093613056;
	// addi r31,r11,-29287
	r31.s64 = r11.s64 + -29287;
	// lis r11,-32252
	r11.s64 = -2113667072;
	// addi r6,r11,-14976
	ctx.r6.s64 = r11.s64 + -14976;
	// li r5,25
	ctx.r5.s64 = 25;
	// lis r11,-32252
	r11.s64 = -2113667072;
...
loc_82EE78C8:
	...
	r11.s64 = -2093613056;
	// lbz r11,-29286(r11)
	r11.u64 = PPC_LOAD_U8(r11.u32 + -29286);
	// cmpwi r11,0
	cr0.compare<int32_t>(r11.s32, 0, xer);
	// bne 0x82ee7910
	if (!cr0.eq) goto loc_82EE7910;
	// lis r11,-31946
	r11.s64 = -2093613056;
	// addi r31,r11,-29286
	r31.s64 = r11.s64 + -29286;
	// lis r11,-32246
	r11.s64 = -2113273856;
	// addi r6,r11,5664
...
PPC_FUNC_IMPL(__imp__sub_82EE7AB0) {
	...
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82ee7b1c
	if (!cr6.eq) goto loc_82EE7B1C;
	// lis r11,-31946
	r11.s64 = -2093613056;
	// lbz r11,-29284(r11)
	r11.u64 = PPC_LOAD_U8(r11.u32 + -29284);
	// cmpwi r11,0
	cr0.compare<int32_t>(r11.s32, 0, xer);
	// bne 0x82ee7b1c
	if (!cr0.eq) goto loc_82EE7B1C;
	// lis r11,-31946
	r11.s64 = -2093613056;
	// addi r31,r11,-29284
	r31.s64 = r11.s64 + -29284;
	// lis r11,-32252
	r11.s64 = -2113667072;
	// addi r6,r11,-14948
	ctx.r6.s64 = r11.s64 + -14948;
	// li r5,128
	ctx.r5.s64 = 128;
	// lis r11,-32252
	r11.s64 = -2113667072;
...
loc_82EE7B90:
	...
	r11.s64 = -2093613056;
	// lbz r11,-29285(r11)
	r11.u64 = PPC_LOAD_U8(r11.u32 + -29285);
	// cmpwi r11,0
	cr0.compare<int32_t>(r11.s32, 0, xer);
	// bne 0x82ee7bd8
	if (!cr0.eq) goto loc_82EE7BD8;
	// lis r11,-31946
	r11.s64 = -2093613056;
	// addi r31,r11,-29285
	r31.s64 = r11.s64 + -29285;
	// lis r11,-32246
	r11.s64 = -2113273856;
	// addi r6,r11,5664
	ctx.r6.s64 = r11.s64 + 5664;
...
PPC_FUNC_IMPL(__imp__sub_82EE7BF8) {
	...
	cr6.compare<int32_t>(r11.s32, 1, xer);
	// beq cr6,0x82ee7c64
	if (cr6.eq) goto loc_82EE7C64;
	// lis r11,-31946
	r11.s64 = -2093613056;
	// lbz r11,-29282(r11)
	r11.u64 = PPC_LOAD_U8(r11.u32 + -29282);
	// cmpwi r11,0
	cr0.compare<int32_t>(r11.s32, 0, xer);
	// bne 0x82ee7c64
	if (!cr0.eq) goto loc_82EE7C64;
	// lis r11,-31946
	r11.s64 = -2093613056;
	// addi r31,r11,-29282
	r31.s64 = r11.s64 + -29282;
	// lis r11,-32252
	r11.s64 = -2113667072;
	// addi r6,r11,-14916
	ctx.r6.s64 = r11.s64 + -14916;
	// li r5,147
	ctx.r5.s64 = 147;
	// lis r11,-32252
	r11.s64 = -2113667072;
...
loc_82EE7C64:
	...
	cr6.compare<uint32_t>(r11.u32, 997, xer);
	// beq cr6,0x82ee7cac
	if (cr6.eq) goto loc_82EE7CAC;
	// lwz r11,84(r1)
	r11.u64 = PPC_LOAD_U32(ctx.r1.u32 + 84);
	// cmplwi cr6,r11,996
	cr6.compare<uint32_t>(r11.u32, 996, xer);
	// bne cr6,0x82ee7cb0
	if (!cr6.eq) goto loc_82EE7CB0;
loc_82EE7CAC:
	// b 0x82ee7de0
	goto loc_82EE7DE0;
loc_82EE7CB0:
	...
	// ble cr6,0x82ee7d18
	if (!cr6.gt) goto loc_82EE7D18;
	// lis r11,-31946
	r11.s64 = -2093613056;
	// lbz r11,-29283(r11)
	r11.u64 = PPC_LOAD_U8(r11.u32 + -29283);
	// cmpwi r11,0
	cr0.compare<int32_t>(r11.s32, 0, xer);
	// bne 0x82ee7d18
	if (!cr0.eq) goto loc_82EE7D18;
	// lis r11,-31946
	r11.s64 = -2093613056;
	// addi r31,r11,-29283
	r31.s64 = r11.s64 + -29283;
	// lis r11,-32252
	r11.s64 = -2113667072;
	// addi r6,r11,-14924
	ctx.r6.s64 = r11.s64 + -14924;
	// li r5,159
	ctx.r5.s64 = 159;
	// lis r11,-32252
	r11.s64 = -2113667072;
