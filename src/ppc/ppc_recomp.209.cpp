...
PPC_FUNC_IMPL(__imp__sub_832595B8) {
	...
	// lfs f0,-28968(r11)
	ctx.fpscr.disableFlushMode();
	temp.u32 = PPC_LOAD_U32(r11.u32 + -28968);
	f0.f64 = double(temp.f32);
	// fmuls f0,f0,f0
