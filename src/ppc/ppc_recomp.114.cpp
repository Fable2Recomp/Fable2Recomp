...
PPC_FUNC_IMPL(__imp__sub_82C133D0) {
	...
	simd::store_i32(ctx.v63.u32, simd::permute_i32(simd::load_i32(ctx.v1.u32), 0xE7));
	// lvx128 v62,r3,r11
	ctx.v62 = simd::load_and_shuffle(base + ((ctx.r3.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// vpermwi128 v61,v62,24
	simd::store_i32(ctx.v61.u32, simd::permute_i32(simd::load_i32(ctx.v62.u32), 0xE7));
	// vcmpeqfp128. v60,v61,v63
	ctx.fpscr.enableFlushMode();
	simd::store_f32_aligned(ctx.v60.f32, simd::cmpeq_f32(simd::load_f32_aligned(ctx.v61.f32), simd::load_f32_aligned(ctx.v63.f32)));
	ctx.cr6.setFromMask(simd::load_f32_aligned(ctx.v60.f32), 0xF);
	// mfocrf r10,2
...
PPC_FUNC_IMPL(__imp__sub_82C14210) {
	...
	simd::store_f32(ctx.v62.f32, simd::blend_f32(simd::load_f32(ctx.v62.f32), simd::permute_f32(simd::load_f32(ctx.v60.f32), 78), 3));
	// stvx128 v62,r0,r10
	ea = (ctx.r10.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v62,
		VectorMaskL);
	// stvx128 v62,r10,r8
