...
PPC_FUNC_IMPL(__imp__sub_8320D350) {
	...
	// lwz r11,-15704(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + -15704);
	// stwx r10,r9,r11
...
loc_8320D51C:
	...
	// lwz r11,-15704(r28)
	r11.u64 = PPC_LOAD_U32(r28.u32 + -15704);
	// mr r3,r23
	ctx.r3.u64 = r23.u64;
	// rlwinm r9,r9,2,0,29
...
loc_8320D80C:
	...
	// lwz r29,-15704(r30)
	r29.u64 = PPC_LOAD_U32(r30.u32 + -15704);
	// lwz r3,1456(r10)
...
loc_8320DAD8:
	...
	ctx.r3.u64 = r31.u64;
	// lwz r5,-15704(r11)
	ctx.r5.u64 = PPC_LOAD_U32(r11.u32 + -15704);
	// bl 0x8320fe70
...
loc_8320DDCC:
	// lwz r3,-15708(r17)
	ctx.r3.u64 = PPC_LOAD_U32(r17.u32 + -15708);
loc_8320DDD0:
	// lwz r9,12(r25)
...
loc_8320DE14:
	// lwz r11,-15704(r16)
	r11.u64 = PPC_LOAD_U32(r16.u32 + -15704);
	// lwzx r11,r29,r11
...
loc_8320E154:
	...
	// lwz r8,-15708(r17)
	ctx.r8.u64 = PPC_LOAD_U32(r17.u32 + -15708);
	// lwzx r11,r11,r7
...
loc_8320E238:
	...
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 0);
	// lwz r10,-15708(r17)
	ctx.r10.u64 = PPC_LOAD_U32(r17.u32 + -15708);
	// lwz r11,0(r11)
...
loc_8320E2B0:
	// lwz r11,-15708(r17)
	r11.u64 = PPC_LOAD_U32(r17.u32 + -15708);
	// rlwinm r10,r30,2,0,29
	ctx.r10.u64 = rotl64(r30.u32 | (r30.u64 << 32), 2) & 0xFFFFFFFC;
	// mr r4,r24
	ctx.r4.u64 = r24.u64;
...
loc_8320E354:
	// lwz r8,-15704(r16)
	ctx.r8.u64 = PPC_LOAD_U32(r16.u32 + -15704);
	// addi r10,r10,1
	ctx.r10.s64 = ctx.r10.s64 + 1;
	// lwz r9,-15708(r17)
	ctx.r9.u64 = PPC_LOAD_U32(r17.u32 + -15708);
	// lwzx r8,r11,r8
...
loc_8320E430:
	...
	r11.s64 = -2093613056;
	// lwz r4,-15704(r11)
	ctx.r4.u64 = PPC_LOAD_U32(r11.u32 + -15704);
	// lwz r3,1456(r10)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r10.u32 + 1456);
	// bl 0x831c59e0
	sub_831C59E0(ctx, base);
