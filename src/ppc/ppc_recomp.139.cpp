...
loc_82D751AC:
	...
	ctx.f13.f64 = -double(std::fma(float(ctx.f13.f64), float(ctx.f11.f64), -float(ctx.f31.f64)));
	// stfs f13,8(r10)
	temp.f32 = float(ctx.f13.f64);
...
loc_82D75774:
	...
	// lvx128 v10,r0,r16
	ctx.v10 = simd::load_and_shuffle(base + ((ctx.r16.u32) & ~0xF), VectorMaskL);
	// lvx128 v12,r0,r18
	ctx.v12 = simd::load_and_shuffle(base + ((ctx.r18.u32) & ~0xF), VectorMaskL);
	// vsubfp v12,v10,v12
	ctx.fpscr.enableFlushModeUnconditional();
	...
	// lvx128 v10,r0,r18
	ctx.v10 = simd::load_and_shuffle(base + ((ctx.r18.u32) & ~0xF), VectorMaskL);
	// vxor v13,v10,v13
...
PPC_FUNC_IMPL(__imp__sub_82D7A8E8) {
	...
	ctx.f0.f64 = double(temp.f32);
	// fmadds f1,f13,f0,f1
	ctx.f1.f64 = double(std::fma(float(ctx.f13.f64), float(ctx.f0.f64), float(ctx.f1.f64)));
	// lwz r11,28(r11)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r11.u32 + 28);
	// mtctr r11
	ctx.ctr.u64 = ctx.r11.u64;
...
PPC_FUNC_IMPL(__imp__sub_82D7A9A0) {
	...
	simd::store_shuffled_i8(base + ea, ctx.v0,
		VectorMaskL);
	// lvx128 v0,r30,r5
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r30.u32 + ctx.r5.u32) & ~0xF), VectorMaskL);
	// stvx128 v0,r11,r5
	ea = (ctx.r11.u32 + ctx.r5.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v0,
		VectorMaskL);
	// lvx128 v0,r30,r6
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r30.u32 + ctx.r6.u32) & ~0xF), VectorMaskL);
	// stvx128 v0,r11,r6
	ea = (ctx.r11.u32 + ctx.r6.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v0,
		VectorMaskL);
	// lvx128 v0,r30,r7
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r30.u32 + ctx.r7.u32) & ~0xF), VectorMaskL);
	// stvx128 v0,r11,r7
...
loc_82D7AFE0:
	...
	// fsubs f12,f0,f10
	ctx.f12.f64 = static_cast<float>(ctx.f0.f64 - ctx.f10.f64);
	// fsubs f11,f0,f13
...
PPC_FUNC_IMPL(__imp__sub_82D7BDC0) {
	...
	simd::store_shuffled_i8(base + ea, ctx.v0,
		VectorMaskL);
	// lvx128 v0,r31,r7
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r31.u32 + ctx.r7.u32) & ~0xF), VectorMaskL);
	// stvx128 v0,r30,r6
	ea = (ctx.r30.u32 + ctx.r6.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v0,
		VectorMaskL);
	// lvx128 v0,r31,r5
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r31.u32 + ctx.r5.u32) & ~0xF), VectorMaskL);
	// stvx128 v0,r30,r4
...
PPC_FUNC_IMPL(__imp__sub_82D7D708) {
	...
	simd::store_shuffled_i8(base + ea, ctx.v0,
		VectorMaskL);
	// lvx128 v0,r11,r30
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r11.u32 + ctx.r30.u32) & ~0xF), VectorMaskL);
	// stvx128 v0,r10,r30
	ea = (ctx.r10.u32 + ctx.r30.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v0,
		VectorMaskL);
...
PPC_FUNC_IMPL(__imp__sub_82D7DBE0) {
	...
	ctx.r31.u64 = ctx.r3.u64;
	// lvx128 v11,r4,r28
	ctx.v11 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r28.u32) & ~0xF), VectorMaskL);
	// mr r30,r5
	ctx.r30.u64 = ctx.r5.u64;
	// mr r27,r6
	...
	ctx.r11.s64 = 2;
	// lvx128 v10,r4,r29
	ctx.v10 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r29.u32) & ~0xF), VectorMaskL);
	// addi r10,r1,144
...
loc_82D7DCBC:
	...
	ctx.r11.s64 = 2;
	// lvx128 v11,r30,r28
	ctx.v11 = simd::load_and_shuffle(base + ((ctx.r30.u32 + ctx.r28.u32) & ~0xF), VectorMaskL);
	// addi r10,r1,144
	ctx.r10.s64 = ctx.r1.s64 + 144;
	// lvx128 v10,r30,r29
	ctx.v10 = simd::load_and_shuffle(base + ((ctx.r30.u32 + ctx.r29.u32) & ~0xF), VectorMaskL);
	// addi r9,r31,128
