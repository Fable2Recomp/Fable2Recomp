...
loc_82DAF4A8:
	...
	// lvx128 v11,r0,r26
	ctx.v11 = simd::load_and_shuffle(base + ((ctx.r26.u32) & ~0xF), VectorMaskL);
	// vaddfp v9,v0,v11
...
loc_82DAF720:
	...
	// lvx128 v13,r3,r24
	ctx.v13 = simd::load_and_shuffle(base + ((ctx.r3.u32 + ctx.r24.u32) & ~0xF), VectorMaskL);
	// std r9,-176(r1)
...
loc_82DB1074:
	...
	// lvx128 v9,r31,r6
	ctx.v9 = simd::load_and_shuffle(base + ((ctx.r31.u32 + ctx.r6.u32) & ~0xF), VectorMaskL);
	// addi r9,r9,48
	ctx.r9.s64 = ctx.r9.s64 + 48;
	// addi r10,r10,5280
	ctx.r10.s64 = ctx.r10.s64 + 5280;
	// lvx128 v11,r28,r7
	ctx.v11 = simd::load_and_shuffle(base + ((ctx.r28.u32 + ctx.r7.u32) & ~0xF), VectorMaskL);
	// li r8,16
	ctx.r8.s64 = 16;
	...
	ctx.r10.s64 = ctx.r1.s64 + 96;
	// lvx128 v12,r28,r8
	ctx.v12 = simd::load_and_shuffle(base + ((ctx.r28.u32 + ctx.r8.u32) & ~0xF), VectorMaskL);
	// lvx128 v7,r28,r5
	ctx.v7 = simd::load_and_shuffle(base + ((ctx.r28.u32 + ctx.r5.u32) & ~0xF), VectorMaskL);
	// stvx128 v10,r0,r9
	ea = (ctx.r9.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v10,
		VectorMaskL);
	...
	ctx.r11.s64 = ctx.r1.s64 + 96;
	// vspltw v6,v10,0
	simd::store_i32(ctx.v6.u32, simd::permute_i32(simd::load_i32(ctx.v10.u32), 0xFF));
	// vspltw v5,v10,1
	simd::store_i32(ctx.v5.u32, simd::permute_i32(simd::load_i32(ctx.v10.u32), 0xAA));
	// vspltw v10,v10,2
	simd::store_i32(ctx.v10.u32, simd::permute_i32(simd::load_i32(ctx.v10.u32), 0x55));
	// vmulfp128 v6,v13,v6
	ctx.fpscr.enableFlushModeUnconditional();
	...
	// vspltw v4,v9,2
	simd::store_i32(ctx.v4.u32, simd::permute_i32(simd::load_i32(ctx.v9.u32), 0x55));
	// addi r11,r1,112
	ctx.r11.s64 = ctx.r1.s64 + 112;
	// vspltw v3,v9,1
	simd::store_i32(ctx.v3.u32, simd::permute_i32(simd::load_i32(ctx.v9.u32), 0xAA));
	// vspltw v9,v9,0
	...
	// lvx128 v2,r0,r11
	ctx.v2 = simd::load_and_shuffle(base + ((ctx.r11.u32) & ~0xF), VectorMaskL);
...
loc_82DB1204:
	...
	ctx.r4.u64 = ctx.r29.u64;
	// lvx128 v11,r29,r10
	ctx.v11 = simd::load_and_shuffle(base + ((ctx.r29.u32 + ctx.r10.u32) & ~0xF), VectorMaskL);
	// addi r3,r1,80
	ctx.r3.s64 = ctx.r1.s64 + 80;
	// vaddfp v11,v13,v11
	ctx.fpscr.enableFlushMode();
	...
	// lvx128 v10,r9,r11
	ctx.v10 = simd::load_and_shuffle(base + ((ctx.r9.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// addi r11,r1,176
	ctx.r11.s64 = ctx.r1.s64 + 176;
	// lwz r9,48(r8)
...
loc_82DB13C8:
	...
	ctx.r11.s64 = ctx.r1.s64 + 112;
	// lvx128 v13,r0,r15
	ctx.v13 = simd::load_and_shuffle(base + ((ctx.r15.u32) & ~0xF), VectorMaskL);
	// lvx128 v127,r0,r11
...
loc_82DB14B0:
	...
	simd::store_f32_aligned(ctx.v12.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v12.f32), simd::load_f32_aligned(ctx.v127.f32)));
	// extsw r10,r11
	...
	ctx.fpscr.enableFlushModeUnconditional();
	simd::store_f32_aligned(ctx.v12.f32, simd::add_f32(simd::mul_f32(simd::load_f32_aligned(ctx.v0.f32), simd::load_f32_aligned(ctx.v126.f32)), simd::load_f32_aligned(ctx.v12.f32)));
	// frsp f13,f0
	ctx.fpscr.disableFlushModeUnconditional();
...
loc_82DB18F4:
	...
	simd::store_f32_aligned(ctx.v13.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v13.f32), simd::load_f32_aligned(ctx.v127.f32)));
	// vmaddfp128 v13,v0,v126,v13
	simd::store_f32_aligned(ctx.v13.f32, simd::add_f32(simd::mul_f32(simd::load_f32_aligned(ctx.v0.f32), simd::load_f32_aligned(ctx.v126.f32)), simd::load_f32_aligned(ctx.v13.f32)));
	// stvx128 v13,r0,r11
	ea = (ctx.r11.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v13,
		VectorMaskL);
...
loc_82DB264C:
	...
	ctx.fpscr.enableFlushModeUnconditional();
	simd::store_f32_aligned(ctx.v126.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v13.f32), simd::load_f32_aligned(ctx.v0.f32)));
	// mtctr r11
	ctx.ctr.u64 = ctx.r11.u64;
	// bctrl 
	ctx.lr = 0x82DB2730;
	...
	ctx.fpscr.enableFlushModeUnconditional();
	simd::store_f32_aligned(ctx.v125.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v13.f32), simd::load_f32_aligned(ctx.v0.f32)));
	// lwz r11,44(r11)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r11.u32 + 44);
	// mtctr r11
	ctx.ctr.u64 = ctx.r11.u64;
	...
	ctx.fpscr.enableFlushModeUnconditional();
	simd::store_f32_aligned(ctx.v124.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v13.f32), simd::load_f32_aligned(ctx.v0.f32)));
	// lwz r11,48(r11)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r11.u32 + 48);
	// addi r3,r1,80
	ctx.r3.s64 = ctx.r1.s64 + 80;
...
PPC_FUNC_IMPL(__imp__sub_82DB2FF8) {
	...
	ctx.r11.s64 = -2113929216;
	// vspltw v6,v0,2
	simd::store_i32(ctx.v6.u32, simd::permute_i32(simd::load_i32(ctx.v0.u32), 0x55));
	// lvx128 v9,r4,r9
	ctx.v9 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r9.u32) & ~0xF), VectorMaskL);
	// vspltw v5,v0,1
	simd::store_i32(ctx.v5.u32, simd::permute_i32(simd::load_i32(ctx.v0.u32), 0xAA));
	// lvx128 v8,r4,r8
	...
	ctx.r10.s64 = ctx.r1.s64 + 112;
	// vspltw v7,v7,0
	simd::store_i32(ctx.v7.u32, simd::permute_i32(simd::load_i32(ctx.v7.u32), 0xFF));
	// addi r11,r11,48
...
PPC_FUNC_IMPL(__imp__sub_82DB3120) {
	...
	ctx.f0.u64 = ctx.f0.u64 ^ 0x8000000000000000;
	// lvx128 v12,r4,r6
	ctx.v12 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r6.u32) & ~0xF), VectorMaskL);
	// lwz r8,16(r27)
	...
	ctx.r11.s64 = ctx.r1.s64 + 112;
	// vspltw v0,v10,0
	simd::store_i32(ctx.v0.u32, simd::permute_i32(simd::load_i32(ctx.v10.u32), 0xFF));
	// vaddfp v10,v0,v12
	simd::store_f32_aligned(ctx.v10.f32, simd::add_f32(simd::load_f32_aligned(ctx.v0.f32), simd::load_f32_aligned(ctx.v12.f32)));
	// lvx128 v0,r27,r9
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r27.u32 + ctx.r9.u32) & ~0xF), VectorMaskL);
	// lvx128 v12,r27,r7
	ctx.v12 = simd::load_and_shuffle(base + ((ctx.r27.u32 + ctx.r7.u32) & ~0xF), VectorMaskL);
	// addi r9,r8,-1
...
PPC_FUNC_IMPL(__imp__sub_82DB3B60) {
	...
	simd::store_f32_aligned(ctx.v12.f32, simd::sub_f32(simd::load_f32_aligned(ctx.v12.f32), simd::load_f32_aligned(ctx.v127.f32)));
	// vmaxfp v0,v13,v0
...
loc_82DB3D70:
	...
	// lvx128 v0,r10,r3
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r10.u32 + ctx.r3.u32) & ~0xF), VectorMaskL);
	// lis r10,-32256
	ctx.r10.s64 = -2113929216;
	// stvx128 v0,r0,r5
	ea = (ctx.r5.u32) & ~0xF;
...
loc_82DB3F14:
	...
	// lvx128 v11,r30,r10
	ctx.v11 = simd::load_and_shuffle(base + ((ctx.r30.u32 + ctx.r10.u32) & ~0xF), VectorMaskL);
	...
	ctx.fpscr.enableFlushModeUnconditional();
	simd::store_f32_aligned(ctx.v127.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v0.f32), simd::load_f32_aligned(ctx.v13.f32)));
	// vmsum3fp128 v0,v12,v127
	simd::store_f32_aligned(ctx.v0.f32, simd::dp_f32(simd::load_f32_aligned(ctx.v12.f32), simd::load_f32_aligned(ctx.v127.f32), 0xEF));
	// stvewx v0,r0,r7
	ea = (
ctx.r7.u32) & ~0x3;
	uint32_t tmp_off = ea & 0xF;
	...
	ctx.r9.s64 = ctx.r1.s64 + 144;
	// lvx128 v13,r8,r30
	ctx.v13 = simd::load_and_shuffle(base + ((ctx.r8.u32 + ctx.r30.u32) & ~0xF), VectorMaskL);
	// lhz r10,20(r30)
	ctx.r10.u64 = PPC_LOAD_U16(ctx.r30.u32 + 20);
	// lvx128 v0,r6,r30
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r6.u32 + ctx.r30.u32) & ~0xF), VectorMaskL);
	// vsubfp v0,v13,v0
	...
	simd::store_f32_aligned(ctx.v13.f32, simd::dp_f32(simd::load_f32_aligned(ctx.v127.f32), simd::load_f32_aligned(ctx.v12.f32), 0xEF));
	// lis r10,-31948
...
loc_82DB4080:
	...
	simd::store_i32(ctx.v11.u32, simd::permute_i32(simd::load_i32(ctx.v127.u32), 0x78));
	// add r11,r31,r11
	ctx.r11.u64 = ctx.r31.u64 + ctx.r11.u64;
	// vpermwi128 v13,v127,99
	simd::store_i32(ctx.v13.u32, simd::permute_i32(simd::load_i32(ctx.v127.u32), 0x9C));
	// addi r5,r1,96
	ctx.r5.s64 = ctx.r1.s64 + 96;
	// mr r4,r26
	ctx.r4.u64 = ctx.r26.u64;
	...
	simd::store_f32_aligned(ctx.v13.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v127.f32), simd::load_f32_aligned(ctx.v126.f32)));
	// vmsum3fp128 v0,v0,v13
	simd::store_f32_aligned(ctx.v0.f32, simd::dp_f32(simd::load_f32_aligned(ctx.v0.f32), simd::load_f32_aligned(ctx.v13.f32), 0xEF));
	// stvewx v0,r0,r11
	ea = (
...
loc_82DB41FC:
	...
	ctx.fpscr.enableFlushMode();
	simd::store_f32_aligned(ctx.v12.f32, simd::dp_f32(simd::load_f32_aligned(ctx.v127.f32), simd::load_f32_aligned(ctx.v13.f32), 0xEF));
	// addi r10,r10,-22656
	ctx.r10.s64 = ctx.r10.s64 + -22656;
	// stvewx v12,r0,r9
	ea = (
ctx.r9.u32) & ~0x3;
	uint32_t tmp_off = ea & 0xF;
	uint32_t tmp_val = simd::extract_u32(ctx.v12, 3 - (tmp_off >> 2));
	PPC_STORE_U32(ea, tmp_val);
	// rlwinm r9,r11,1,0,30
	ctx.r9.u64 = __builtin_rotateleft64(ctx.r11.u32 | (ctx.r11.u64 << 32), 1) & 0xFFFFFFFE;
	// lfs f13,80(r1)
...
loc_82DB4270:
	...
	simd::store_i32(ctx.v12.u32, simd::permute_i32(simd::load_i32(ctx.v127.u32), 0x9C));
	// add r11,r11,r9
	ctx.r11.u64 = ctx.r11.u64 + ctx.r9.u64;
...
loc_82DB4384:
	...
	simd::store_i32(ctx.v9.u32, simd::permute_i32(simd::load_i32(ctx.v11.u32), 0x9C));
	// vpermwi128 v11,v11,135
	simd::store_i32(ctx.v11.u32, simd::permute_i32(simd::load_i32(ctx.v11.u32), 0x78));
	// vpermwi128 v0,v0,99
	simd::store_i32(ctx.v0.u32, simd::permute_i32(simd::load_i32(ctx.v0.u32), 0x9C));
...
ctx.r4.u32) & ~0x3;
	...
	PPC_STORE_U32(ea, tmp_val);
	// lvx128 v10,r5,r31
	ctx.v10 = simd::load_and_shuffle(base + ((ctx.r5.u32 + ctx.r31.u32) & ~0xF), VectorMaskL);
...
ctx.r11.u32) & ~0x3;
	...
	simd::store_i32(ctx.v10.u32, simd::permute_i32(simd::load_i32(ctx.v11.u32), 0x9C));
...
ctx.r7.u32) & ~0x3;
	uint32_t tmp_off = ea & 0xF;
	uint32_t tmp_val = simd::extract_u32(ctx.v7, 3 - (tmp_off >> 2));
	PPC_STORE_U32(ea, tmp_val);
	// lfs f10,-44(r1)
	ctx.fpscr.disableFlushModeUnconditional();
	temp.u32 = PPC_LOAD_U32(ctx.r1.u32 + -44);
...
PPC_FUNC_IMPL(__imp__sub_82DB4618) {
	...
	simd::store_i32(ctx.v8.u32, simd::permute_i32(simd::load_i32(ctx.v11.u32), 0x78));
	// vmulfp128 v10,v10,v9
	simd::store_f32_aligned(ctx.v10.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v10.f32), simd::load_f32_aligned(ctx.v9.f32)));
...
ctx.r10.u32) & ~0x3;
	...
	simd::store_i32(ctx.v10.u32, simd::permute_i32(simd::load_i32(ctx.v12.u32), 0x9C));
	// addi r11,r1,-16
	ctx.r11.s64 = ctx.r1.s64 + -16;
	// vpermwi128 v0,v0,99
	simd::store_i32(ctx.v0.u32, simd::permute_i32(simd::load_i32(ctx.v0.u32), 0x9C));
...
PPC_FUNC_IMPL(__imp__sub_82DB4770) {
	...
	simd::store_i32(ctx.v8.u32, simd::permute_i32(simd::load_i32(ctx.v10.u32), 0x9C));
	// vpermwi128 v7,v10,135
	simd::store_i32(ctx.v7.u32, simd::permute_i32(simd::load_i32(ctx.v10.u32), 0x78));
	// vpermwi128 v10,v12,135
	simd::store_i32(ctx.v10.u32, simd::permute_i32(simd::load_i32(ctx.v12.u32), 0x78));
	// vpermwi128 v6,v9,99
	simd::store_i32(ctx.v6.u32, simd::permute_i32(simd::load_i32(ctx.v9.u32), 0x9C));
	// vpermwi128 v12,v12,99
	simd::store_i32(ctx.v12.u32, simd::permute_i32(simd::load_i32(ctx.v12.u32), 0x9C));
	// vpermwi128 v9,v9,135
	simd::store_i32(ctx.v9.u32, simd::permute_i32(simd::load_i32(ctx.v9.u32), 0x78));
	...
	simd::store_i32(ctx.v12.u32, simd::permute_i32(simd::load_i32(ctx.v13.u32), 0x78));
...
loc_82DB4AA0:
	...
	ctx.fpscr.enableFlushMode();
	simd::store_f32_aligned(ctx.v127.f32, simd::min_f32(simd::load_f32_aligned(ctx.v127.f32), simd::load_f32_aligned(ctx.v0.f32)));
	// lvx128 v13,r0,r10
	ctx.v13 = simd::load_and_shuffle(base + ((ctx.r10.u32) & ~0xF), VectorMaskL);
	// vmaxfp128 v126,v126,v13
	simd::store_f32_aligned(ctx.v126.f32, simd::max_f32(simd::load_f32_aligned(ctx.v126.f32), simd::load_f32_aligned(ctx.v13.f32)));
	// blt cr6,0x82db4aa0
...
loc_82DB4AF0:
	...
	ctx.fpscr.enableFlushMode();
	simd::store_f32_aligned(ctx.v0.f32, simd::add_f32(simd::load_f32_aligned(ctx.v127.f32), simd::load_f32_aligned(ctx.v126.f32)));
	// addi r8,r1,80
	ctx.r8.s64 = ctx.r1.s64 + 80;
	// vsubfp128 v12,v126,v127
	simd::store_f32_aligned(ctx.v12.f32, simd::sub_f32(simd::load_f32_aligned(ctx.v126.f32), simd::load_f32_aligned(ctx.v127.f32)));
	// addi r11,r31,48
