...
PPC_FUNC_IMPL(__imp__sub_82E673A8) {
	...
	r22.s64 = r21.s64 + 44;
	// lwz r9,44(r21)
	ctx.r9.u64 = PPC_LOAD_U32(r21.u32 + 44);
	// lwz r11,16(r9)
...
PPC_FUNC_IMPL(__imp__sub_82E693B0) {
	...
	r11.s64 = -2093744128;
	// lwz r10,-19240(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + -19240);
	// addi r10,r10,1
	ctx.r10.s64 = ctx.r10.s64 + 1;
	// stw r10,-19240(r11)
...
PPC_FUNC_IMPL(__imp__sub_82E698B8) {
	...
	ctx.r10.u64 = ctx.r3.u64;
	// lwz r11,404(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 404);
	// cmplw cr6,r4,r11
	cr6.compare<uint32_t>(ctx.r4.u32, r11.u32, xer);
	// blt cr6,0x82e698d0
...
loc_82E69C34:
	// lwz r31,408(r30)
	r31.u64 = PPC_LOAD_U32(r30.u32 + 408);
	// cmplwi r31,0
...
PPC_FUNC_IMPL(__imp__sub_82E6E788) {
	...
	r11.s64 = -2093744128;
	// lwz r10,-17580(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + -17580);
	// addi r10,r10,1
	ctx.r10.s64 = ctx.r10.s64 + 1;
	// stw r10,-17580(r11)
...
loc_82E70CE4:
	...
	// lwz r10,-27056(r24)
	ctx.r10.u64 = PPC_LOAD_U32(r24.u32 + -27056);
	// and. r11,r11,r10
	r11.u64 = r11.u64 & ctx.r10.u64;
	cr0.compare<int32_t>(r11.s32, 0, xer);
	// beq 0x82e70ed8
