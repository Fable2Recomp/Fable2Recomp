...
loc_82C21854:
	...
	simd::store_f32(ctx.v61.f32, simd::blend_f32(simd::load_f32(ctx.v61.f32), simd::permute_f32(simd::load_f32(ctx.v62.f32), 57), 4));
	// vrlimi128 v63,v60,4,3
	simd::store_f32(ctx.v63.f32, simd::blend_f32(simd::load_f32(ctx.v63.f32), simd::permute_f32(simd::load_f32(ctx.v60.f32), 57), 4));
	// vrlimi128 v61,v63,3,2
	simd::store_f32(ctx.v61.f32, simd::blend_f32(simd::load_f32(ctx.v61.f32), simd::permute_f32(simd::load_f32(ctx.v63.f32), 78), 3));
	// stvx128 v61,r3,r5
...
loc_82C25DBC:
	...
	ctx.r3.s64 = ctx.r1.s64 + 96;
	// lvx128 v1,r31,r11
	ctx.v1 = simd::load_and_shuffle(base + ((ctx.r31.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// bl 0x82bfc910
	ctx.lr = 0x82C25DF8;
...
PPC_FUNC_IMPL(__imp__sub_82C29BF8) {
	...
	PPC_STORE_U32(ctx.r4.u32 + 0, ctx.r11.u32);
	// lvx128 v63,r0,r5
	ctx.v63 = simd::load_and_shuffle(base + ((ctx.r5.u32) & ~0xF), VectorMaskL);
	// stvx128 v63,r3,r10
...
loc_82C29C4C:
	...
	ctx.r3.s64 = ctx.r1.s64 + 96;
	// lvx128 v1,r29,r26
	ctx.v1 = simd::load_and_shuffle(base + ((ctx.r29.u32 + ctx.r26.u32) & ~0xF), VectorMaskL);
	// bl 0x82bfc910
	ctx.lr = 0x82C29C8C;
	sub_82BFC910(ctx, base);
	// lwz r10,0(r28)
...
PPC_WEAK_FUNC(sub_82C2BC68) {
	__imp__sub_82C2BC68(ctx, base);
}
