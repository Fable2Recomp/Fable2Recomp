...
loc_82C21854:
	...
	simd::store_f32(v61.f32, simd::blend_f32<3>(simd::load_f32(v61.f32), simd::permute_f32<78>(simd::load_f32(v63.f32))));
	// stvx128 v61,r3,r5
...
loc_82C267B8:
	...
	r11.u64 = rotl64(r29.u32 | (r29.u64 << 32), 15) & 0xFFFF8000;
	// rlwimi r3,r30,15,0,16
	ctx.r3.u64 = (rotl32(r30.u32, 15) & 0xFFFF8000) | (ctx.r3.u64 & 0xFFFFFFFF00007FFF);
	// ori r29,r11,32767
...
loc_82C276A0:
	...
	r27.u64 = rotl64(ctx.r7.u32 | (ctx.r7.u64 << 32), 2) & 0xFFFFFFFC;
	// lwzx r29,r8,r27
...
loc_82C29C4C:
	...
	ctx.r3.s64 = ctx.r1.s64 + 96;
	// lvx128 v1,r29,r26
	simd::store_shuffled(ctx.v1, simd::load_and_shuffle(base + ((r29.u32 + r26.u32) & ~0xF), VectorMaskL));
	// bl 0x82bfc910
	sub_82BFC910(ctx, base);
	// lwz r10,0(r28)
	ctx.r10.u64 = PPC_LOAD_U32(r28.u32 + 0);
...
loc_82C2C27C:
	...
	ctx.r8.s64 = r26.s64 - r30.s64;
	// rlwinm r7,r9,0,0,28
	ctx.r7.u64 = rotl64(ctx.r9.u32 | (ctx.r9.u64 << 32), 0) & 0xFFFFFFF8;
	// rlwinm r6,r8,0,0,28
	ctx.r6.u64 = rotl64(ctx.r8.u32 | (ctx.r8.u64 << 32), 0) & 0xFFFFFFF8;
	// cmpw cr6,r6,r7
	cr6.compare<int32_t>(ctx.r6.s32, ctx.r7.s32, xer);
	// mr r6,r28
	ctx.r6.u64 = r28.u64;
