...
PPC_FUNC_IMPL(__imp__sub_82F2ADD0) {
	...
	// lwz r3,108(r10)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(108) );
	// b 0x82f2ae24
	goto loc_82F2AE24;
loc_82F2ADFC:
	// lwz r11,108(r10)
...
loc_82F2AE0C:
	// lwz r4,104(r10)
	ctx.r4.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(104) );
	// cmplwi cr6,r4,0
...
PPC_FUNC_IMPL(__imp__sub_82F2AEE8) {
	...
	// lwz r11,264(r30)
	r11.u64 = PPC_LOAD_U32(r30.u32 + int32_t(264) );
...
PPC_FUNC_IMPL(__imp__sub_82F2AFD8) {
	...
	ctx.r3.u64 = r31.u64;
	// lwz r31,280(r30)
	r31.u64 = PPC_LOAD_U32(r30.u32 + int32_t(280) );
	// bl 0x832b226c
	__imp__RtlLeaveCriticalSection(ctx, base);
	// mr r3,r31
	ctx.r3.u64 = r31.u64;
...
loc_82F2B3C8:
	...
	ctx.r3.u64 = r30.u64;
	// lwz r11,-5364(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-5364) );
	// lwz r11,4(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + int32_t(4) );
	// mtctr r11
	ctr.u64 = r11.u64;
...
loc_82F2B9F8:
	...
	ctx.r3.u64 = r30.u64;
	// lwz r11,-5360(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-5360) );
	// lwz r11,4(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + int32_t(4) );
	// mtctr r11
	ctr.u64 = r11.u64;
...
PPC_FUNC_IMPL(__imp__sub_82F2BA50) {
	...
	// lwz r11,288(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + int32_t(288) );
	// cmpwi cr6,r11,0
...
PPC_FUNC_IMPL(__imp__sub_82F2C0F0) {
	...
	// lwz r7,40(r4)
	ctx.r7.u64 = PPC_LOAD_U32(ctx.r4.u32 + int32_t(40) );
	// lwz r6,44(r4)
...
PPC_FUNC_IMPL(__imp__sub_82F2C478) {
	...
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + int32_t(28) );
	// lwz r3,160(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(160) );
	// lwsync 
	// blr 
	return;
}
...
PPC_FUNC_IMPL(__imp__sub_82F2C498) {
	...
	r31.u64 = ctx.r3.u64;
	// lwz r5,24(r4)
	ctx.r5.u64 = PPC_LOAD_U32(ctx.r4.u32 + int32_t(24) );
	// lwz r4,16(r11)
	ctx.r4.u64 = PPC_LOAD_U32(r11.u32 + int32_t(16) );
	// bl 0x82f2b9a0
...
PPC_FUNC_IMPL(__imp__sub_82F2C998) {
	...
	ctx.r3.u64 = r30.u64;
	// lwz r29,116(r31)
	r29.u64 = PPC_LOAD_U32(r31.u32 + int32_t(116) );
	// bl 0x82ef43b8
	sub_82EF43B8(ctx, base);
	// li r11,1
	r11.s64 = 1;
...
loc_82F2DF1C:
	// lwz r23,112(r1)
	r23.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(112) );
	// lwz r11,116(r1)
...
loc_82F30A74:
	...
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(28) );
	// lwz r27,176(r10)
	r27.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(176) );
	// lwsync 
	// b 0x82f30ba0
	goto loc_82F30BA0;
loc_82F30AA0:
...
PPC_FUNC_IMPL(__imp__sub_82F30BF0) {
	...
	PPC_STORE_U32(ctx.r1.u32 + 84, r27.u32);
	// lwz r11,16(r15)
	r11.u64 = PPC_LOAD_U32(r15.u32 + int32_t(16) );
	// mr r14,r6
	r14.u64 = ctx.r6.u64;
	// lwz r10,4(r26)
	...
	// lwz r16,48(r11)
	r16.u64 = PPC_LOAD_U32(r11.u32 + int32_t(48) );
	// stw r10,88(r1)
...
loc_82F30CE4:
	// lwz r11,16(r14)
	r11.u64 = PPC_LOAD_U32(r14.u32 + int32_t(16) );
	// stw r27,104(r1)
...
loc_82F30DB8:
	// lwz r10,20(r15)
	ctx.r10.u64 = PPC_LOAD_U32(r15.u32 + int32_t(20) );
	// stb r27,80(r1)
...
loc_82F312A0:
	...
	r11.u64 = PPC_LOAD_U32(r11.u32 + int32_t(28) );
	// lwz r25,160(r11)
	r25.u64 = PPC_LOAD_U32(r11.u32 + int32_t(160) );
loc_82F312AC:
	// lwsync 
	// cmplwi cr6,r25,0
	cr6.compare<uint32_t>(r25.u32, 0, xer);
...
loc_82F31338:
	...
	r17.s64 = 0;
	// lwz r18,24(r11)
	r18.u64 = PPC_LOAD_U32(r11.u32 + int32_t(24) );
	// rlwinm. r11,r18,0,11,11
	r11.u64 = rotl64(r18.u32 | (r18.u64 << 32), 0) & 0x100000;
	cr0.compare<int32_t>(r11.s32, 0, xer);
	// lwz r24,32(r29)
	r24.u64 = PPC_LOAD_U32(r29.u32 + int32_t(32) );
	// bne 0x82f31644
	...
	r19.u64 = r17.u64;
	// lwz r30,20(r25)
	r30.u64 = PPC_LOAD_U32(r25.u32 + int32_t(20) );
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// ble cr6,0x82f31644
...
loc_82F316D4:
	...
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// lwz r30,24(r25)
	r30.u64 = PPC_LOAD_U32(r25.u32 + int32_t(24) );
	// ble cr6,0x82f318b4
...
loc_82F31860:
	...
	ctx.r4.s64 = ctx.r1.s64 + 96;
	// lwz r7,20(r24)
	ctx.r7.u64 = PPC_LOAD_U32(r24.u32 + int32_t(20) );
	// lwz r6,40(r24)
...
loc_82F318D0:
	...
	ctx.r10.u64 = PPC_LOAD_U32(r29.u32 + int32_t(36) );
	// lwz r11,160(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(160) );
	// addi r11,r11,1
	r11.s64 = r11.s64 + 1;
	// lwsync 
	// stw r11,160(r10)
...
PPC_FUNC_IMPL(__imp__sub_82F31CB8) {
	...
	// lwz r9,612(r28)
	ctx.r9.u64 = PPC_LOAD_U32(r28.u32 + int32_t(612) );
	// lwz r10,92(r28)
	ctx.r10.u64 = PPC_LOAD_U32(r28.u32 + int32_t(92) );
	// lwz r8,88(r28)
	ctx.r8.u64 = PPC_LOAD_U32(r28.u32 + int32_t(88) );
	// subf r10,r8,r10
...
loc_82F31D64:
	...
	// lwz r7,564(r31)
	ctx.r7.u64 = PPC_LOAD_U32(r31.u32 + int32_t(564) );
	// lwz r9,4(r9)
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r9.u32 + int32_t(4) );
	// add r6,r11,r10
...
loc_82F31E64:
	...
	// lwz r9,564(r31)
	ctx.r9.u64 = PPC_LOAD_U32(r31.u32 + int32_t(564) );
	// add r11,r11,r10
	r11.u64 = r11.u64 + ctx.r10.u64;
	// cmplw cr6,r11,r9
	cr6.compare<uint32_t>(r11.u32, ctx.r9.u32, xer);
...
loc_82F31EB0:
	...
	ctx.r3.u64 = r31.u64;
	// lwz r29,116(r30)
	r29.u64 = PPC_LOAD_U32(r30.u32 + int32_t(116) );
	// bl 0x82ef43b8
	sub_82EF43B8(ctx, base);
	// li r11,3
	r11.s64 = 3;
...
loc_82F31EE0:
	// lwz r11,728(r28)
	r11.u64 = PPC_LOAD_U32(r28.u32 + int32_t(728) );
	// mulli r10,r11,12
	ctx.r10.s64 = r11.s64 * 12;
	// add r10,r10,r28
	...
	// lwz r11,764(r28)
	r11.u64 = PPC_LOAD_U32(r28.u32 + int32_t(764) );
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bgt cr6,0x82f31f14
	if (cr6.gt) goto loc_82F31F14;
...
loc_82F32174:
	// lwz r29,24(r29)
	r29.u64 = PPC_LOAD_U32(r29.u32 + int32_t(24) );
	// lwsync 
	// cmplwi cr6,r29,0
	cr6.compare<uint32_t>(r29.u32, 0, xer);
	// bne cr6,0x82f320c4
...
loc_82F32478:
	...
	ctx.r9.u64 = PPC_LOAD_U32(r11.u32 + int32_t(4) );
	// lwz r7,80(r3)
	ctx.r7.u64 = PPC_LOAD_U32(ctx.r3.u32 + int32_t(80) );
	// cmplwi cr6,r9,0
	cr6.compare<uint32_t>(ctx.r9.u32, 0, xer);
	// bne cr6,0x82f324ac
...
loc_82F324E8:
	...
	// lwz r11,-27732(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(-27732) );
	// addi r11,r11,1
	r11.s64 = r11.s64 + 1;
	// stw r11,-27732(r10)
...
PPC_FUNC_IMPL(__imp__sub_82F325A8) {
	...
	PPC_STORE_U32(ctx.r4.u32 + 0, r11.u32);
	// lwz r11,240(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + int32_t(240) );
	// stw r11,0(r5)
...
loc_82F3268C:
	...
	ctx.r4.u64 = r29.u64;
	// lwz r11,204(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + int32_t(204) );
	// mtctr r11
	ctr.u64 = r11.u64;
	// bctrl 
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
...
PPC_FUNC_IMPL(__imp__sub_82F32E08) {
	...
	PPC_STORE_U32(ctx.r1.u32 + 80, r11.u32);
	// lwz r10,120(r10)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(120) );
	// mtctr r10
	ctr.u64 = ctx.r10.u64;
	// bctrl 
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
...
PPC_FUNC_IMPL(__imp__sub_82F32F10) {
	...
	// lwz r11,352(r29)
	r11.u64 = PPC_LOAD_U32(r29.u32 + int32_t(352) );
	// addi r3,r1,81
	...
	sub_82EF0A78(ctx, base);
	// lwz r11,312(r29)
	r11.u64 = PPC_LOAD_U32(r29.u32 + int32_t(312) );
	// addi r4,r1,80
	ctx.r4.s64 = ctx.r1.s64 + 80;
	// addi r3,r11,536
	ctx.r3.s64 = r11.s64 + 536;
...
PPC_FUNC_IMPL(__imp__sub_82F32F90) {
	...
	PPC_STORE_U32(ctx.r3.u32 + 8, ctx.r10.u32);
	// lwz r11,192(r29)
	r11.u64 = PPC_LOAD_U32(r29.u32 + int32_t(192) );
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// addi r5,r11,16
...
loc_82F331F4:
	...
	// lwz r11,-27732(r9)
	r11.u64 = PPC_LOAD_U32(ctx.r9.u32 + int32_t(-27732) );
	// addi r11,r11,1
	r11.s64 = r11.s64 + 1;
	// stw r11,-27732(r9)
...
PPC_FUNC_IMPL(__imp__sub_82F33238) {
	...
	// lwz r11,256(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + int32_t(256) );
	// b 0x82f332b4
	goto loc_82F332B4;
loc_82F332A8:
	// lwz r11,0(r31)
...
PPC_FUNC_IMPL(__imp__sub_82F33390) {
	...
	// lwz r3,308(r30)
	ctx.r3.u64 = PPC_LOAD_U32(r30.u32 + int32_t(308) );
	// cmpwi cr6,r3,0
	cr6.compare<int32_t>(ctx.r3.s32, 0, xer);
	// beq cr6,0x82f33598
	if (cr6.eq) goto loc_82F33598;
...
loc_82F3353C:
	...
	ctx.r10.s64 = 1;
	// lwz r9,244(r30)
	ctx.r9.u64 = PPC_LOAD_U32(r30.u32 + int32_t(244) );
	// slw r11,r10,r11
...
loc_82F33578:
	...
	r11.u64 = PPC_LOAD_U32(r30.u32 + int32_t(0) );
	// lwz r6,244(r30)
	ctx.r6.u64 = PPC_LOAD_U32(r30.u32 + int32_t(244) );
	// lwz r11,136(r11)
...
PPC_FUNC_IMPL(__imp__sub_82F335B0) {
	...
	PPCRegister r11{};
	// lwz r9,500(r3)
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r3.u32 + int32_t(500) );
	// li r10,0
	ctx.r10.s64 = 0;
	// cmplwi cr6,r9,0
	cr6.compare<uint32_t>(ctx.r9.u32, 0, xer);
	...
	if (cr6.eq) return;
	// lwz r8,496(r3)
	ctx.r8.u64 = PPC_LOAD_U32(ctx.r3.u32 + int32_t(496) );
	// mr r11,r8
	r11.u64 = ctx.r8.u64;
loc_82F335C8:
	// lwz r7,0(r11)
	...
	// lwz r7,52(r7)
	ctx.r7.u64 = PPC_LOAD_U32(ctx.r7.u32 + int32_t(52) );
	// cmpw cr6,r7,r4
	cr6.compare<int32_t>(ctx.r7.s32, ctx.r4.s32, xer);
	// beq cr6,0x82f335f8
...
PPC_FUNC_IMPL(__imp__sub_82F33610) {
	...
	// lwz r11,312(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + int32_t(312) );
	// lwz r4,8(r4)
...
PPC_FUNC_IMPL(__imp__sub_82F33A98) {
	...
	ctx.r1.u32 = ea;
	// lwz r11,416(r4)
	r11.u64 = PPC_LOAD_U32(ctx.r4.u32 + int32_t(416) );
	// mr r30,r3
	r30.u64 = ctx.r3.u64;
	// cmpwi cr6,r11,0
	cr6.compare<int32_t>(r11.s32, 0, xer);
...
loc_82F341FC:
	...
	// lwz r31,416(r3)
	r31.u64 = PPC_LOAD_U32(ctx.r3.u32 + int32_t(416) );
	// cmpwi cr6,r31,-1
...
loc_82F34378:
	...
	if (cr6.eq) goto loc_82F343A8;
	// lwz r11,528(r28)
	r11.u64 = PPC_LOAD_U32(r28.u32 + int32_t(528) );
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82f34398
...
PPC_FUNC_IMPL(__imp__sub_82F34600) {
	...
	// lwz r30,416(r3)
	r30.u64 = PPC_LOAD_U32(ctx.r3.u32 + int32_t(416) );
	// cmpwi cr6,r30,-1
	cr6.compare<int32_t>(r30.s32, -1, xer);
	// beq cr6,0x82f34658
...
loc_82F34770:
	...
	// lwz r11,528(r25)
	r11.u64 = PPC_LOAD_U32(r25.u32 + int32_t(528) );
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82f3479c
...
loc_82F34A08:
	...
	sub_82F6C328(ctx, base);
	// lwz r11,528(r27)
	r11.u64 = PPC_LOAD_U32(r27.u32 + int32_t(528) );
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82f34a34
