...
PPC_FUNC_IMPL(__imp__sub_82F32520) {
	...
	// fmadds f0,f10,f0,f9
	ctx.f0.f64 = double(std::fma(float(ctx.f10.f64), float(ctx.f0.f64), float(ctx.f9.f64)));
...
loc_82F334D0:
	...
	ctx.f0.f64 = double(std::fma(float(ctx.f0.f64), float(ctx.f12.f64), float(ctx.f11.f64)));
	// fctiwz f0,f0
	ctx.f0.u64 = uint64_t(int32_t(std::trunc(ctx.f0.f64)));
	// stfiwx f0,r30,r9
...
PPC_WEAK_FUNC(sub_82F356C8) {
	__imp__sub_82F356C8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F35728) {
	__imp__sub_82F35728(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F35820) {
	__imp__sub_82F35820(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F35A90) {
	__imp__sub_82F35A90(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F35CB8) {
	__imp__sub_82F35CB8(ctx, base);
}
...
loc_82F36004:
	// fctiwz f11,f5
	ctx.fpscr.disableFlushMode();
	ctx.f11.u64 = uint64_t(int32_t(std::trunc(ctx.f5.f64)));
	// stfd f11,144(r1)
	...
	// fctiwz f11,f6
	ctx.f11.u64 = uint64_t(int32_t(std::trunc(ctx.f6.f64)));
	// stfd f11,88(r1)
	...
	// fctiwz f0,f9
	ctx.f0.u64 = uint64_t(int32_t(std::trunc(ctx.f9.f64)));
	// stfd f0,80(r1)
	PPC_STORE_U64(ctx.r1.u32 + 80, ctx.f0.u64);
	// lhz r8,86(r1)
...
PPC_WEAK_FUNC(sub_82F35D38) {
	__imp__sub_82F35D38(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F36208) {
	__imp__sub_82F36208(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F362D8) {
	__imp__sub_82F362D8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F363D8) {
	__imp__sub_82F363D8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F36560) {
	__imp__sub_82F36560(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F365C0) {
	__imp__sub_82F365C0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F366F8) {
	__imp__sub_82F366F8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F36848) {
	__imp__sub_82F36848(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F36CB0) {
	__imp__sub_82F36CB0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F36E00) {
	__imp__sub_82F36E00(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F37320) {
	__imp__sub_82F37320(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F373D8) {
	__imp__sub_82F373D8(ctx, base);
}
...
loc_82F378F8:
	...
	ctx.r11.s64 = 1;
	// fsubs f8,f30,f31
	ctx.f8.f64 = static_cast<float>(ctx.f30.f64 - ctx.f31.f64);
	// fsubs f10,f10,f0
	ctx.f10.f64 = static_cast<float>(ctx.f10.f64 - ctx.f0.f64);
	// fmadds f13,f13,f28,f11
	ctx.f13.f64 = double(std::fma(float(ctx.f13.f64), float(ctx.f28.f64), float(ctx.f11.f64)));
	// fmadds f8,f8,f28,f31
	ctx.f8.f64 = double(std::fma(float(ctx.f8.f64), float(ctx.f28.f64), float(ctx.f31.f64)));
	// fmuls f10,f10,f28
...
loc_82F37938:
	...
	ctx.r11.u64 = ctx.r11.u32 & 0xFF;
	// fsubs f13,f29,f7
	ctx.f13.f64 = static_cast<float>(ctx.f29.f64 - ctx.f7.f64);
	// cmpwi cr6,r24,40
	ctx.cr6.compare<int32_t>(ctx.r24.s32, 40, ctx.xer);
	// fsubs f0,f0,f13
	ctx.f0.f64 = static_cast<float>(ctx.f0.f64 - ctx.f13.f64);
...
loc_82F37B68:
	...
	ctx.r11.s64 = 1;
	// fsubs f5,f30,f31
	ctx.f5.f64 = static_cast<float>(ctx.f30.f64 - ctx.f31.f64);
	// fsubs f11,f11,f0
	ctx.f11.f64 = static_cast<float>(ctx.f11.f64 - ctx.f0.f64);
	// fmadds f6,f6,f27,f13
	ctx.f6.f64 = double(std::fma(float(ctx.f6.f64), float(ctx.f27.f64), float(ctx.f13.f64)));
	// fmadds f5,f5,f27,f31
	ctx.f5.f64 = double(std::fma(float(ctx.f5.f64), float(ctx.f27.f64), float(ctx.f31.f64)));
	// fmuls f11,f11,f27
	ctx.f11.f64 = double(float(ctx.f11.f64 * ctx.f27.f64));
	// fsubs f6,f6,f0
	ctx.f6.f64 = static_cast<float>(ctx.f6.f64 - ctx.f0.f64);
	// fsubs f0,f5,f0
	...
	ctx.f0.f64 = double(float(ctx.f0.f64 + ctx.f11.f64));
	// fabs f11,f6
	ctx.f11.u64 = ctx.f6.u64 & 0x7FFFFFFFFFFFFFFF;
	// fabs f0,f0
	ctx.f0.u64 = ctx.f0.u64 & 0x7FFFFFFFFFFFFFFF;
	// fcmpu cr6,f11,f0
...
loc_82F37BA8:
	...
	// fsubs f11,f28,f8
	ctx.f11.f64 = static_cast<float>(ctx.f28.f64 - ctx.f8.f64);
	// fabs f11,f11
...
loc_82F37BD4:
	...
	if (ctx.cr6.lt) goto loc_82F37C0C;
	// fsubs f11,f7,f29
	ctx.f11.f64 = static_cast<float>(ctx.f7.f64 - ctx.f29.f64);
	// fabs f11,f11
	ctx.f11.u64 = ctx.f11.u64 & 0x7FFFFFFFFFFFFFFF;
	// fcmpu cr6,f0,f11
	ctx.cr6.compare(ctx.f0.f64, ctx.f11.f64);
...
PPC_WEAK_FUNC(sub_82F37478) {
	__imp__sub_82F37478(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F37CC8) {
	__imp__sub_82F37CC8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F37D68) {
	__imp__sub_82F37D68(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F37E48) {
	__imp__sub_82F37E48(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F37EF8) {
	__imp__sub_82F37EF8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F37F68) {
	__imp__sub_82F37F68(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F37FE0) {
	__imp__sub_82F37FE0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F38040) {
	__imp__sub_82F38040(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F381F0) {
	__imp__sub_82F381F0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F38450) {
	__imp__sub_82F38450(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F384A8) {
	__imp__sub_82F384A8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F38590) {
	__imp__sub_82F38590(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F38778) {
	__imp__sub_82F38778(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F38870) {
	__imp__sub_82F38870(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F389A8) {
	__imp__sub_82F389A8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F38A10) {
	__imp__sub_82F38A10(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F38AE8) {
	__imp__sub_82F38AE8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F38CC0) {
	__imp__sub_82F38CC0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F38D30) {
	__imp__sub_82F38D30(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F38D90) {
	__imp__sub_82F38D90(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F38DA0) {
	__imp__sub_82F38DA0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F38DB0) {
	__imp__sub_82F38DB0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F38E78) {
	__imp__sub_82F38E78(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F38EF8) {
	__imp__sub_82F38EF8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F38FC0) {
	__imp__sub_82F38FC0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F390D8) {
	__imp__sub_82F390D8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F39228) {
	__imp__sub_82F39228(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F39298) {
	__imp__sub_82F39298(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F39410) {
	__imp__sub_82F39410(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F39478) {
	__imp__sub_82F39478(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F39680) {
	__imp__sub_82F39680(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82F39828) {
	__imp__sub_82F39828(ctx, base);
}
