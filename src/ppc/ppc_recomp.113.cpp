...
PPC_FUNC_IMPL(__imp__sub_82C0B6A8) {
	...
	// lvx128 v63,r30,r11
	ctx.v63 = simd::load_and_shuffle(base + ((ctx.r30.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// stvx128 v63,r0,r10
	ea = (ctx.r10.u32) & ~0xF;
...
PPC_FUNC_IMPL(__imp__sub_82C0C9C8) {
	...
	ctx.r3.s64 = 1;
	// lvx128 v63,r11,r10
	ctx.v63 = simd::load_and_shuffle(base + ((ctx.r11.u32 + ctx.r10.u32) & ~0xF), VectorMaskL);
	// stvx128 v63,r0,r4
	ea = (ctx.r4.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v63,
		VectorMaskL);
	// lvx128 v62,r11,r9
	ctx.v62 = simd::load_and_shuffle(base + ((ctx.r11.u32 + ctx.r9.u32) & ~0xF), VectorMaskL);
	// stvx128 v62,r0,r5
	ea = (ctx.r5.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v62,
		VectorMaskL);
	// lvx128 v61,r11,r8
	ctx.v61 = simd::load_and_shuffle(base + ((ctx.r11.u32 + ctx.r8.u32) & ~0xF), VectorMaskL);
	// stvx128 v61,r0,r6
	ea = (ctx.r6.u32) & ~0xF;
...
PPC_FUNC_IMPL(__imp__sub_82C0CA18) {
	...
	simd::store_f32(ctx.v62.f32, simd::blend_f32(simd::load_f32(ctx.v62.f32), simd::permute_f32(simd::load_f32(ctx.v56.f32), 78), 3));
	// lvlx128 v52,r0,r7
	temp.u32 = ctx.r0.u32 + ctx.r7.u32;
	...
	simd::store_f32(ctx.v60.f32, simd::blend_f32(simd::load_f32(ctx.v60.f32), simd::permute_f32(simd::load_f32(ctx.v54.f32), 78), 3));
	// lvlx128 v59,r0,r11
	...
	simd::store_f32(ctx.v58.f32, simd::blend_f32(simd::load_f32(ctx.v58.f32), simd::permute_f32(simd::load_f32(ctx.v59.f32), 57), 4));
	// vrlimi128 v52,v58,3,2
	simd::store_f32(ctx.v52.f32, simd::blend_f32(simd::load_f32(ctx.v52.f32), simd::permute_f32(simd::load_f32(ctx.v58.f32), 78), 3));
	// stvx128 v52,r0,r4
	ea = (ctx.r4.u32) & ~0xF;
...
PPC_FUNC_IMPL(__imp__sub_82C0E288) {
	...
	ctx.cr6.compare<uint32_t>(ctx.r9.u32, 0, ctx.xer);
	// lvx128 v63,r3,r11
	ctx.v63 = simd::load_and_shuffle(base + ((ctx.r3.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// vsubfp128 v62,v1,v63
	ctx.fpscr.enableFlushMode();
	simd::store_f32_aligned(ctx.v62.f32, simd::sub_f32(simd::load_f32_aligned(ctx.v1.f32), simd::load_f32_aligned(ctx.v63.f32)));
	// vmsum3fp128 v61,v62,v62
	simd::store_f32_aligned(ctx.v61.f32, simd::dp_f32(simd::load_f32_aligned(ctx.v62.f32), simd::load_f32_aligned(ctx.v62.f32), 0xEF));
	// stvx128 v61,r0,r10
	ea = (ctx.r10.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v61,
		VectorMaskL);
...
loc_82C0E2C4:
	// lvx128 v60,r11,r9
	ctx.v60 = simd::load_and_shuffle(base + ((ctx.r11.u32 + ctx.r9.u32) & ~0xF), VectorMaskL);
	// addi r8,r1,-16
	ctx.r8.s64 = ctx.r1.s64 + -16;
	// vsubfp128 v59,v1,v60
	ctx.fpscr.enableFlushMode();
	simd::store_f32_aligned(ctx.v59.f32, simd::sub_f32(simd::load_f32_aligned(ctx.v1.f32), simd::load_f32_aligned(ctx.v60.f32)));
	// vmsum3fp128 v58,v59,v59
	simd::store_f32_aligned(ctx.v58.f32, simd::dp_f32(simd::load_f32_aligned(ctx.v59.f32), simd::load_f32_aligned(ctx.v59.f32), 0xEF));
	// stvx128 v58,r0,r8
	ea = (ctx.r8.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v58,
		VectorMaskL);
	// lfs f13,-16(r1)
	ctx.fpscr.disableFlushModeUnconditional();
	temp.u32 = PPC_LOAD_U32(ctx.r1.u32 + -16);
...
PPC_FUNC_IMPL(__imp__sub_82C0FFF8) {
	...
	ctx.r9.s64 = 592;
	// lvx128 v3,r28,r11
	ctx.v3 = simd::load_and_shuffle(base + ((ctx.r28.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// lvx128 v2,r28,r10
	ctx.v2 = simd::load_and_shuffle(base + ((ctx.r28.u32 + ctx.r10.u32) & ~0xF), VectorMaskL);
	// lvx128 v1,r28,r9
	ctx.v1 = simd::load_and_shuffle(base + ((ctx.r28.u32 + ctx.r9.u32) & ~0xF), VectorMaskL);
	// bl 0x82bffc68
	ctx.lr = 0x82C10034;
...
loc_82C10F50:
	...
	ctx.r3.s64 = ctx.r1.s64 + 96;
	// lvx128 v1,r0,r29
	ctx.v1 = simd::load_and_shuffle(base + ((ctx.r29.u32) & ~0xF), VectorMaskL);
	// bl 0x82bfc910
	ctx.lr = 0x82C10F78;
