...
PPC_FUNC_IMPL(__imp__sub_82CA5E20) {
	...
	r11.s64 = -2094071808;
	// lwz r3,-4912(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + -4912);
	// blr 
	return;
}
...
loc_82CA6060:
	...
	// lwz r10,-3224(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + -3224);
loc_82CA6078:
	// lwz r11,172(r10)
...
loc_82CA85C8:
	...
	// lwz r11,26932(r27)
	r11.u64 = PPC_LOAD_U32(r27.u32 + 26932);
	// cmpwi cr6,r11,0
	cr6.compare<int32_t>(r11.s32, 0, xer);
	// beq cr6,0x82ca8644
...
PPC_FUNC_IMPL(__imp__sub_82CA8710) {
	...
	r31.s64 = -2091974656;
	// lwz r3,29908(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + 29908);
	// cmpwi cr6,r3,0
	cr6.compare<int32_t>(ctx.r3.s32, 0, xer);
	// bne cr6,0x82ca873c
...
loc_82CA87A0:
	// lwz r3,29904(r30)
	ctx.r3.u64 = PPC_LOAD_U32(r30.u32 + 29904);
loc_82CA87A4:
	// stwx r11,r10,r3
...
loc_82CA8854:
	...
	r11.s64 = -2091974656;
	// lwz r3,29904(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + 29904);
	// bl 0x82ca5dc0
	sub_82CA5DC0(ctx, base);
	// addi r1,r1,96
	ctx.r1.s64 = ctx.r1.s64 + 96;
...
PPC_FUNC_IMPL(__imp__sub_82CA8C58) {
	...
	ctx.r4.u64 = r28.u64;
	// lwz r3,-4240(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + -4240);
	// bl 0x82cae2d0
	sub_82CAE2D0(ctx, base);
	// lhz r11,160(r1)
	r11.u64 = PPC_LOAD_U16(ctx.r1.u32 + 160);
...
PPC_FUNC_IMPL(__imp__sub_82CA9638) {
	...
	r11.s64 = -2093809664;
	// lwz r11,26852(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 26852);
	// cmpwi cr6,r11,1
	cr6.compare<int32_t>(r11.s32, 1, xer);
	// beq cr6,0x82ca9710
	...
	// lwz r11,26848(r9)
	r11.u64 = PPC_LOAD_U32(ctx.r9.u32 + 26848);
	// cmpwi cr6,r11,1
	cr6.compare<int32_t>(r11.s32, 1, xer);
	// bne cr6,0x82ca9688
...
loc_82CA9688:
	...
	ctx.r10.s64 = -2091974656;
	// lwz r30,29892(r11)
	r30.u64 = PPC_LOAD_U32(r11.u32 + 29892);
	// lwz r29,29896(r10)
	r29.u64 = PPC_LOAD_U32(ctx.r10.u32 + 29896);
	// cmplwi r29,0
...
loc_82CA9AC4:
	...
	r27.s64 = -2094071808;
	// lwz r9,-3224(r27)
	ctx.r9.u64 = PPC_LOAD_U32(r27.u32 + -3224);
	// lwz r11,20(r9)
...
loc_82CA9C30:
	// lwz r11,-3224(r27)
	r11.u64 = PPC_LOAD_U32(r27.u32 + -3224);
	// addi r10,r1,80
	ctx.r10.s64 = ctx.r1.s64 + 80;
	// li r9,0
	ctx.r9.s64 = 0;
...
PPC_FUNC_IMPL(__imp__sub_82CAA3A0) {
	...
	r30.u64 = ctx.r3.u64;
	// lwz r18,292(r1)
	r18.u64 = PPC_LOAD_U32(ctx.r1.u32 + 292);
	// li r20,0
	r20.s64 = 0;
	// mr r26,r4
	r26.u64 = ctx.r4.u64;
...
loc_82CAB52C:
	...
	ctx.r9.s64 = -2093809664;
	// lwz r11,26836(r9)
	r11.u64 = PPC_LOAD_U32(ctx.r9.u32 + 26836);
	// addi r11,r11,1
	r11.s64 = r11.s64 + 1;
	// stw r11,26836(r9)
...
PPC_FUNC_IMPL(__imp__sub_82CAB630) {
	...
	r11.s64 = -2091974656;
	// lwz r11,29888(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 29888);
	// cmplwi r11,0
	cr0.compare<uint32_t>(r11.u32, 0, xer);
	// beq 0x82cab658
...
loc_82CABD28:
	...
	r11.s64 = -2093809664;
	// lwz r11,27360(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 27360);
	// clrlwi. r11,r11,31
	r11.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(r11.s32, 0, xer);
	// beq 0x82cabd50
...
PPC_FUNC_IMPL(__imp__sub_82CAC418) {
	...
	r11.s64 = -2094071808;
	// lwz r3,-3792(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + -3792);
	// blr 
	return;
}
...
PPC_FUNC_IMPL(__imp__sub_82CAC428) {
	...
	r30.s64 = -2094071808;
	// lwz r3,-3788(r30)
	ctx.r3.u64 = PPC_LOAD_U32(r30.u32 + -3788);
	// bl 0x832b25ec
	__imp__KeTlsGetValue(ctx, base);
	// mr. r31,r3
	r31.u64 = ctx.r3.u64;
	...
	ctx.r3.u64 = PPC_LOAD_U32(r30.u32 + -3788);
	// lwz r4,26880(r11)
	ctx.r4.u64 = PPC_LOAD_U32(r11.u32 + 26880);
	// mr r31,r4
	r31.u64 = ctx.r4.u64;
	// bl 0x832b25fc
...
PPC_FUNC_IMPL(__imp__sub_82CAC480) {
	...
	r11.s64 = -2093809664;
	// lwz r11,26884(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 26884);
	// mtctr r11
	ctr.u64 = r11.u64;
	// bctr 
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
...
PPC_FUNC_IMPL(__imp__sub_82CAC490) {
	...
	r11.s64 = -2093809664;
	// lwz r11,26888(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 26888);
	// mtctr r11
	ctr.u64 = r11.u64;
	// bctrl 
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
...
PPC_FUNC_IMPL(__imp__sub_82CAC520) {
	...
	r28.u64 = ctx.r3.u64;
	// lwz r31,-3792(r30)
	r31.u64 = PPC_LOAD_U32(r30.u32 + -3792);
	// bl 0x82cac428
	...
	r29.s64 = -2093809664;
	// lwz r3,-3792(r30)
	ctx.r3.u64 = PPC_LOAD_U32(r30.u32 + -3792);
	// li r4,1
	ctx.r4.s64 = 1;
	// lwz r11,26884(r29)
	r11.u64 = PPC_LOAD_U32(r29.u32 + 26884);
	// mtctr r11
	ctr.u64 = r11.u64;
	// bctrl 
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
...
PPC_FUNC_IMPL(__imp__sub_82CAC700) {
	...
	r29.s64 = -2094071808;
	// lwz r11,-3792(r30)
	r11.u64 = PPC_LOAD_U32(r30.u32 + -3792);
	// cmpwi cr6,r11,-1
	cr6.compare<int32_t>(r11.s32, -1, xer);
	// beq cr6,0x82cac77c
	...
	// lwz r3,-3788(r29)
	ctx.r3.u64 = PPC_LOAD_U32(r29.u32 + -3788);
	// bl 0x832b25ec
	__imp__KeTlsGetValue(ctx, base);
	// cmplwi r3,0
	cr0.compare<uint32_t>(ctx.r3.u32, 0, xer);
...
PPC_FUNC_IMPL(__imp__sub_82CAC798) {
	...
	// lwz r4,26880(r31)
	ctx.r4.u64 = PPC_LOAD_U32(r31.u32 + 26880);
	// bl 0x832b25fc
	__imp__KeTlsSetValue(ctx, base);
	// cmpwi r3,0
	cr0.compare<int32_t>(ctx.r3.s32, 0, xer);
...
loc_82CAC970:
	...
	// lwz r11,-3656(r7)
	r11.u64 = PPC_LOAD_U32(ctx.r7.u32 + -3656);
	// add r10,r10,r11
...
loc_82CAE9E0:
	// lwz r28,4072(r19)
	r28.u64 = PPC_LOAD_U32(r19.u32 + 4072);
	// mr r11,r28
	r11.u64 = r28.u64;
	// mr r10,r28
	ctx.r10.u64 = r28.u64;
...
loc_82CAEA34:
	...
	// lwz r28,4076(r14)
	r28.u64 = PPC_LOAD_U32(r14.u32 + 4076);
loc_82CAEA5C:
	// li r16,1
	r16.s64 = 1;
	// mr r11,r28
...
loc_82CAF2CC:
	...
	// lwz r11,29908(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 29908);
	// cmpw cr6,r30,r11
