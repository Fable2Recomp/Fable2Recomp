...
PPC_FUNC_IMPL(__imp__sub_82A11500) {
	...
	// lwz r11,-6652(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + int32_t(-6652) );
	// mr r4,r25
	ctx.r4.u64 = r25.u64;
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
...
loc_82A11628:
	...
	// lwz r11,-6648(r27)
	r11.u64 = PPC_LOAD_U32(r27.u32 + int32_t(-6648) );
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82a11670
...
loc_82A11688:
	// lwz r11,-6644(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + int32_t(-6644) );
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82a11698
...
loc_82A117E4:
	...
	// lwz r10,12(r22)
	ctx.r10.u64 = PPC_LOAD_U32(r22.u32 + int32_t(12) );
	// lwz r11,92(r1)
...
PPC_FUNC_IMPL(__imp__sub_82A11CA8) {
	...
	// lwz r9,-28(r1)
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(-28) );
	// lwz r11,-24(r1)
...
loc_82A11D0C:
	// lwz r6,-32(r1)
	ctx.r6.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(-32) );
	// lwz r10,4(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + int32_t(4) );
	// lwz r11,4(r6)
...
loc_82A13CB0:
	...
	PPC_STORE_U32(r11.u32 + 0, ctx.r3.u32);
	// lwz r9,28(r6)
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r6.u32 + int32_t(28) );
	// stw r9,4(r11)
	PPC_STORE_U32(r11.u32 + 4, ctx.r9.u32);
	// lfs f0,32(r6)
	ctx.fpscr.disableFlushMode();
...
loc_82A14FB8:
	...
	// lwz r16,-272(r1)
	r16.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(-272) );
	// addi r14,r14,-1188
	...
	// lwz r15,-268(r1)
	r15.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(-268) );
	// lwz r11,20(r1)
	...
	// lwz r26,-224(r1)
	r26.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(-224) );
	// stw r10,444(r11)
	...
	// lwz r7,-256(r1)
	ctx.r7.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(-256) );
	// stw r26,216(r11)
	...
	// lwz r10,-272(r1)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(-272) );
	// stw r9,316(r11)
	...
	// lwz r26,-212(r1)
	r26.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(-212) );
	// stw r29,328(r11)
	...
	// lwz r26,-208(r1)
	r26.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(-208) );
	// lwz r9,-264(r1)
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(-264) );
	// lwz r31,-244(r1)
	r31.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(-244) );
	// lwz r30,-240(r1)
	...
	// lwz r28,-232(r1)
	r28.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(-232) );
	// lwz r27,-228(r1)
	...
	// lwz r26,-200(r1)
	r26.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(-200) );
	// stw r7,356(r11)
	...
	// lwz r26,-192(r1)
	r26.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(-192) );
	// stw r14,-252(r1)
	...
	// lwz r26,-176(r1)
	r26.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(-176) );
	// stw r26,236(r11)
	PPC_STORE_U32(r11.u32 + 236, r26.u32);
	// lwz r26,-172(r1)
	r26.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(-172) );
	// stw r16,364(r11)
	...
	// lwz r26,-168(r1)
	r26.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(-168) );
	// stw r6,172(r11)
...
loc_82A1560C:
	...
	r30.s64 = -2093613056;
	// lwz r11,396(r30)
	r11.u64 = PPC_LOAD_U32(r30.u32 + int32_t(396) );
	// cmplw cr6,r11,r3
...
loc_82A15650:
	...
	sub_8221EE38(ctx, base);
	// lwz r11,392(r17)
	r11.u64 = PPC_LOAD_U32(r17.u32 + int32_t(392) );
	// cmplw cr6,r11,r3
	cr6.compare<uint32_t>(r11.u32, ctx.r3.u32, xer);
	// bne cr6,0x82a15678
...
loc_82A158AC:
	...
	// lwz r11,-5856(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + int32_t(-5856) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// mulli r11,r11,9377
...
PPC_FUNC_IMPL(__imp__sub_82A15A50) {
	...
	// lwz r10,264(r31)
	ctx.r10.u64 = PPC_LOAD_U32(r31.u32 + int32_t(264) );
	// cmpw cr6,r9,r10
	cr6.compare<int32_t>(ctx.r9.s32, ctx.r10.s32, xer);
	// li r10,1
	ctx.r10.s64 = 1;
...
loc_82A15AAC:
	...
	// lwz r10,23896(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + int32_t(23896) );
	// cmpw cr6,r10,r9
...
loc_82A15ACC:
	...
	ctx.r7.s64 = 4;
	// lwz r11,23896(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + int32_t(23896) );
	// addi r4,r1,112
	ctx.r4.s64 = ctx.r1.s64 + 112;
	// stw r11,236(r31)
...
PPC_FUNC_IMPL(__imp__sub_82A15F00) {
	...
	ctx.r9.s64 = 0;
	// lwz r8,232(r31)
	ctx.r8.u64 = PPC_LOAD_U32(r31.u32 + int32_t(232) );
	// mr r3,r31
	ctx.r3.u64 = r31.u64;
	// stb r9,269(r31)
...
PPC_FUNC_IMPL(__imp__sub_82A15F90) {
	...
	// lwz r28,260(r30)
	r28.u64 = PPC_LOAD_U32(r30.u32 + int32_t(260) );
	// lwz r26,264(r30)
	r26.u64 = PPC_LOAD_U32(r30.u32 + int32_t(264) );
	// bl 0x82b6a6c0
...
loc_82A16038:
	...
	// lwz r9,232(r30)
	ctx.r9.u64 = PPC_LOAD_U32(r30.u32 + int32_t(232) );
	// mr r3,r30
	ctx.r3.u64 = r30.u64;
	// lwz r8,32(r9)
...
PPC_FUNC_IMPL(__imp__sub_82A16870) {
	...
	if (cr6.lt) return;
	// lwz r11,260(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + int32_t(260) );
	// cmpw cr6,r4,r11
...
loc_82A168DC:
	...
	// lwz r8,252(r3)
	ctx.r8.u64 = PPC_LOAD_U32(ctx.r3.u32 + int32_t(252) );
	// mullw r7,r10,r9
...
PPC_FUNC_IMPL(__imp__sub_82A16A58) {
	...
	r31.u64 = ctx.r5.u64;
	// lwz r10,264(r26)
	ctx.r10.u64 = PPC_LOAD_U32(r26.u32 + int32_t(264) );
	// cmplwi cr6,r7,0
	...
	// lwz r16,108(r1)
	r16.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(108) );
	// lwz r20,104(r1)
	r20.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(104) );
	// lwz r18,96(r1)
	r18.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(96) );
loc_82A16AC0:
	// mr r10,r29
	ctx.r10.u64 = r29.u64;
loc_82A16AC4:
...
loc_82A16B50:
	...
	r11.s64 = r11.s8;
	// lwz r10,256(r26)
	ctx.r10.u64 = PPC_LOAD_U32(r26.u32 + int32_t(256) );
	// cmpwi cr6,r11,0
	cr6.compare<int32_t>(r11.s32, 0, xer);
	// ble cr6,0x82a16b94
...
loc_82A17A60:
	...
	ctx.r6.s64 = ctx.r1.s64 + 88;
	// lwz r7,72(r24)
	ctx.r7.u64 = PPC_LOAD_U32(r24.u32 + int32_t(72) );
	// mr r5,r29
	ctx.r5.u64 = r29.u64;
	// mr r4,r24
	ctx.r4.u64 = r24.u64;
...
loc_82A1801C:
	...
	ctx.r4.u64 = r31.u64;
	// lwz r5,16(r24)
	ctx.r5.u64 = PPC_LOAD_U32(r24.u32 + int32_t(16) );
	// addi r3,r1,84
	ctx.r3.s64 = ctx.r1.s64 + 84;
	// bl 0x821e3950
	sub_821E3950(ctx, base);
	...
	ctx.r5.s64 = 0;
	// lwz r6,16(r24)
	ctx.r6.u64 = PPC_LOAD_U32(r24.u32 + int32_t(16) );
	// mr r4,r31
	ctx.r4.u64 = r31.u64;
	// addi r3,r1,88
	ctx.r3.s64 = ctx.r1.s64 + 88;
...
loc_82A180C4:
	...
	r11.s64 = r24.s64 + 76;
	// lwz r9,76(r24)
	ctx.r9.u64 = PPC_LOAD_U32(r24.u32 + int32_t(76) );
	// addi r8,r10,-1
...
loc_82A18C68:
	...
	sub_82A185C8(ctx, base);
	// lwz r10,64(r19)
	ctx.r10.u64 = PPC_LOAD_U32(r19.u32 + int32_t(64) );
	// addi r11,r19,60
	r11.s64 = r19.s64 + 60;
	// mr r5,r3
	ctx.r5.u64 = ctx.r3.u64;
...
loc_82A18C9C:
	...
	sub_82214F08(ctx, base);
	// lwz r11,52(r19)
	r11.u64 = PPC_LOAD_U32(r19.u32 + int32_t(52) );
	// addi r31,r19,40
	r31.s64 = r19.s64 + 40;
	// clrlwi r10,r11,30
...
PPC_FUNC_IMPL(__imp__sub_82A192A0) {
	...
	ctx.r3.u64 = ctx.r4.u64;
	// lwz r21,292(r1)
	r21.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(292) );
	// addi r11,r21,-4
	r11.s64 = r21.s64 + -4;
	// std r5,128(r1)
	...
	// lwz r22,284(r1)
	r22.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(284) );
	// subf r10,r22,r21
...
loc_82A19374:
	// lwz r27,124(r1)
	r27.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(124) );
	// cmplw cr6,r29,r21
...
loc_82A193C8:
	...
	// lwz r24,108(r1)
	r24.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(108) );
loc_82A193EC:
	// cmplw cr6,r29,r21
	cr6.compare<uint32_t>(r29.u32, r21.u32, xer);
	// bge cr6,0x82a194a0
...
loc_82A1A444:
	...
	r11.s64 = -2092367872;
	// lwz r10,27692(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + int32_t(27692) );
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beq cr6,0x82a1a460
...
loc_82A1A6E4:
	...
	r11.s64 = -2092367872;
	// lwz r10,27696(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + int32_t(27696) );
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beq cr6,0x82a1a700
...
loc_82A1B1FC:
	// lwz r11,27700(r30)
	r11.u64 = PPC_LOAD_U32(r30.u32 + int32_t(27700) );
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82a1b20c
...
PPC_FUNC_IMPL(__imp__sub_82A1CDD8) {
	...
	// lwz r4,28(r5)
	ctx.r4.u64 = PPC_LOAD_U32(ctx.r5.u32 + int32_t(28) );
	// mtctr r4
	ctr.u64 = ctx.r4.u64;
	// bctrl 
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
...
PPC_FUNC_IMPL(__imp__sub_82A1EB00) {
	...
	PPC_STORE_U32(ctx.r3.u32 + 8, ctx.r8.u32);
	// lwz r7,100(r9)
	ctx.r7.u64 = PPC_LOAD_U32(ctx.r9.u32 + int32_t(100) );
	// subf r6,r7,r3
...
PPC_FUNC_IMPL(__imp__sub_82A1ECA0) {
	...
	PPC_STORE_U8(r11.u32 + 5, ctx.r8.u8);
	// lwz r7,40(r9)
	ctx.r7.u64 = PPC_LOAD_U32(ctx.r9.u32 + int32_t(40) );
	// stw r7,28(r11)
...
PPC_FUNC_IMPL(__imp__sub_82A1EEC0) {
	...
	PPC_STORE_U32(ctx.r1.u32 + 112, r11.u32);
	// lwz r9,11952(r8)
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r8.u32 + int32_t(11952) );
	// stw r5,100(r1)
	PPC_STORE_U32(ctx.r1.u32 + 100, ctx.r5.u32);
	// li r5,12
	ctx.r5.s64 = 12;
...
loc_82A1F298:
	// lwz r6,132(r1)
	ctx.r6.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(132) );
	// cmplwi cr6,r6,0
	cr6.compare<uint32_t>(ctx.r6.u32, 0, xer);
	// bne cr6,0x82a1f2b0
...
PPC_FUNC_IMPL(__imp__sub_82A1F4D8) {
	...
	ctx.r8.s64 = 0;
	// lwz r11,8788(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + int32_t(8788) );
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82a1f560
...
loc_82A1FDB4:
	...
	r29.s64 = r31.s64 + 12;
	// lwz r23,8(r30)
	r23.u64 = PPC_LOAD_U32(r30.u32 + int32_t(8) );
	// mr r5,r28
	ctx.r5.u64 = r28.u64;
	// mr r4,r29
	ctx.r4.u64 = r29.u64;
...
PPC_FUNC_IMPL(__imp__sub_82A1FED0) {
	...
	ctx.r6.s64 = ctx.r1.s64 + 84;
	// lwz r10,-2564(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-2564) );
	// addi r5,r1,80
	ctx.r5.s64 = ctx.r1.s64 + 80;
	// addi r4,r1,88
	ctx.r4.s64 = ctx.r1.s64 + 88;
	...
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(88) );
	// lwz r7,-2556(r8)
	ctx.r7.u64 = PPC_LOAD_U32(ctx.r8.u32 + int32_t(-2556) );
	// mtctr r7
	ctr.u64 = ctx.r7.u64;
	// bctrl 
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
