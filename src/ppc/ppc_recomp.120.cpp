...
PPC_FUNC_IMPL(__imp__sub_82C59B88) {
	...
	r31.u64 = ctx.r3.u64;
	// lwz r10,20500(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + 20500);
	// cmplwi cr6,r10,0
...
loc_82C59BC0:
	...
	r11.s64 = -2094202880;
	// lwz r10,26172(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + 26172);
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beq cr6,0x82c59be8
	if (cr6.eq) goto loc_82C59BE8;
...
PPC_FUNC_IMPL(__imp__sub_82C59C00) {
	...
	r31.u64 = ctx.r3.u64;
	// lwz r10,20492(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + 20492);
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beq cr6,0x82c59c34
...
PPC_FUNC_IMPL(__imp__sub_82C59C78) {
	...
	r11.s64 = -2093809664;
	// lwz r10,20496(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + 20496);
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beq cr6,0x82c59c94
...
PPC_FUNC_IMPL(__imp__sub_82C59C98) {
	...
	r11.s64 = -2093809664;
	// lwz r10,20488(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + 20488);
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beq cr6,0x82c59cb4
...
PPC_FUNC_IMPL(__imp__sub_82C5AA20) {
	...
	// lwz r22,-21892(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -21892);
	// lwz r22,-21852(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -21852);
	// lwz r22,-21780(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -21780);
	// lwz r22,-21760(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -21760);
	// lwz r22,-21724(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -21724);
	// lwz r22,-21688(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -21688);
	// lwz r22,-21644(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -21644);
loc_82C5AA7C:
	// lwz r11,0(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + 0);
	// mr r6,r28
...
loc_82C5B4F0:
	...
	ctx.r5.u64 = r26.u64;
	// lwz r3,220(r28)
	ctx.r3.u64 = PPC_LOAD_U32(r28.u32 + 220);
	// mr r4,r27
	ctx.r4.u64 = r27.u64;
	// bl 0x82c60458
	sub_82C60458(ctx, base);
	...
	ctx.r6.u64 = r26.u64;
	// lwz r3,196(r28)
	ctx.r3.u64 = PPC_LOAD_U32(r28.u32 + 196);
	// mr r5,r31
	ctx.r5.u64 = r31.u64;
	// mr r4,r27
	ctx.r4.u64 = r27.u64;
...
loc_82C5B9E0:
	...
	// lwz r11,-22728(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + -22728);
	// addi r10,r9,-20048
...
loc_82C5C318:
	...
	r11.s64 = -2113011712;
	// lwz r11,11668(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 11668);
	// stw r11,80(r1)
...
loc_82C5CD40:
	...
	// lwz r22,-12952(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -12952);
	// lwz r22,-12908(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -12908);
	// lwz r22,-12876(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -12876);
	// lwz r22,-12840(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -12840);
loc_82C5CD68:
	// mr r3,r31
	ctx.r3.u64 = r31.u64;
	// bl 0x82c5cb18
...
PPC_FUNC_IMPL(__imp__sub_82C5ECE0) {
	...
	// lwz r22,-4820(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -4820);
	// lwz r22,-4700(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -4700);
	// lwz r22,-4608(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -4608);
	// lwz r22,-4488(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -4488);
	// lwz r22,-4488(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -4488);
loc_82C5ED2C:
	// li r9,0
...
loc_82C5EFE4:
	...
	// lwz r22,-3948(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -3948);
	// lwz r22,-4052(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -4052);
	// lwz r22,-3976(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -3976);
	// lwz r22,-3948(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -3948);
	// lwz r22,-3964(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -3964);
loc_82C5F02C:
	// lwz r11,64(r6)
	r11.u64 = PPC_LOAD_U32(ctx.r6.u32 + 64);
	// addi r10,r11,1
