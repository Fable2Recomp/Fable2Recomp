...
loc_82C578F4:
	...
	PPC_STORE_U32(ctx.r3.u32 + 36, temp.u32);
	// fmadds f0,f4,f11,f2
	f0.f64 = double(float(ctx.f4.f64 * ctx.f11.f64 + ctx.f2.f64));
	// stfs f1,24(r3)
	temp.f32 = float(ctx.f1.f64);
	PPC_STORE_U32(ctx.r3.u32 + 24, temp.u32);
	// fmadds f13,f3,f10,f0
	ctx.f13.f64 = double(float(ctx.f3.f64 * ctx.f10.f64 + f0.f64));
	...
	PPC_STORE_U32(ctx.r3.u32 + 24, temp.u32);
	// fmadds f12,f4,f9,f0
	ctx.f12.f64 = double(float(ctx.f4.f64 * ctx.f9.f64 + f0.f64));
	// stfs f7,36(r3)
	temp.f32 = float(ctx.f7.f64);
	PPC_STORE_U32(ctx.r3.u32 + 36, temp.u32);
	...
	// fmadds f13,f8,f7,f0
	ctx.f13.f64 = double(float(ctx.f8.f64 * ctx.f7.f64 + f0.f64));
	// lfs f7,12(r4)
	temp.u32 = PPC_LOAD_U32(ctx.r4.u32 + 12);
	ctx.f7.f64 = double(temp.f32);
...
PPC_FUNC_IMPL(__imp__sub_82C58890) {
	...
	// lwz r22,-30472(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -30472);
	// lwz r22,-30412(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -30412);
	// lwz r22,-30352(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -30352);
	// lwz r22,-30300(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -30300);
	// lwz r22,-30248(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -30248);
	// lwz r22,-30156(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -30156);
	// lwz r22,-30064(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -30064);
	// lwz r22,-29972(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -29972);
	// lwz r22,-29940(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -29940);
	// lwz r22,-29864(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -29864);
	// lwz r22,-29832(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -29832);
	// lwz r22,-29800(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -29800);
	// lwz r22,-29716(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + -29716);
loc_82C588F8:
	// lis r10,-32256
	ctx.r10.s64 = -2113929216;
	// lfs f0,3084(r10)
...
loc_82C58D20:
	// lwz r7,252(r11)
	ctx.r7.u64 = PPC_LOAD_U32(r11.u32 + 252);
	// lfs f0,0(r9)
	ctx.fpscr.disableFlushMode();
...
loc_82C58EA4:
	...
	ctx.f8.f64 = double(temp.f32);
	// fmadds f0,f11,f8,f9
	f0.f64 = double(float(ctx.f11.f64 * ctx.f8.f64 + ctx.f9.f64));
	// stfs f0,0(r11)
	temp.f32 = float(f0.f64);
...
loc_82C598EC:
	...
	r27.u64 = __builtin_rotateleft64(ctx.r9.u32 | (ctx.r9.u64 << 32), 3) & 0x8;
	// lis r10,-32255
	ctx.r10.s64 = -2113863680;
	// addi r28,r11,22000
...
loc_82C5C9FC:
	...
	ctx.f1.f64 = double(float(f0.f64 * ctx.f12.f64 + f31.f64));
loc_82C5CA04:
	// addi r1,r1,112
	ctx.r1.s64 = ctx.r1.s64 + 112;
	// lwz r12,-8(r1)
...
PPC_FUNC_IMPL(__imp__sub_82C5E698) {
	...
	ctx.f11.f64 = double(float(-(ctx.f3.f64 * f0.f64 - ctx.f2.f64)));
	// fsubs f10,f2,f3
	...
	// fmadds f10,f2,f8,f0
	ctx.f10.f64 = double(float(ctx.f2.f64 * ctx.f8.f64 + f0.f64));
	// fadds f9,f13,f12
...
PPC_FUNC_IMPL(__imp__sub_82C5E730) {
	...
	f0.f64 = double(float(-(ctx.f2.f64 * ctx.f12.f64 - ctx.f8.f64)));
