...
PPC_FUNC_IMPL(__imp__sub_82C48B28) {
	...
	ctx.f12.f64 = double(temp.f32);
	// fsubs f3,f0,f12
	ctx.f3.f64 = static_cast<float>(ctx.f0.f64 - ctx.f12.f64);
	// fsubs f2,f13,f11
...
PPC_FUNC_IMPL(__imp__sub_82C48D58) {
	...
	// fsubs f29,f13,f11
	ctx.f29.f64 = static_cast<float>(ctx.f13.f64 - ctx.f11.f64);
	// stfs f30,80(r1)
...
loc_82C49800:
	...
	// fmadds f12,f5,f7,f0
	ctx.f12.f64 = double(std::fma(float(ctx.f5.f64), float(ctx.f7.f64), float(ctx.f0.f64)));
loc_82C4983C:
	...
	// fmadds f13,f4,f6,f0
	ctx.f13.f64 = double(std::fma(float(ctx.f4.f64), float(ctx.f6.f64), float(ctx.f0.f64)));
loc_82C49894:
...
loc_82C498C0:
	...
	// fmadds f0,f3,f5,f0
	ctx.f0.f64 = double(std::fma(float(ctx.f3.f64), float(ctx.f5.f64), float(ctx.f0.f64)));
	// fmuls f0,f0,f13
	ctx.f0.f64 = double(float(ctx.f0.f64 * ctx.f13.f64));
	// fmuls f1,f0,f12
	ctx.f1.f64 = double(float(ctx.f0.f64 * ctx.f12.f64));
...
PPC_FUNC_IMPL(__imp__sub_82C4C7C0) {
	...
	simd::store_f32(ctx.v61.f32, simd::blend_f32(simd::load_f32(ctx.v61.f32), simd::permute_f32(simd::load_f32(ctx.v58.f32), 57), 4));
	// lvlx128 v59,r0,r9
	...
	simd::store_f32(ctx.v60.f32, simd::blend_f32(simd::load_f32(ctx.v60.f32), simd::permute_f32(simd::load_f32(ctx.v57.f32), 57), 4));
	// lvlx128 v56,r9,r7
	...
	simd::store_f32(ctx.v59.f32, simd::blend_f32(simd::load_f32(ctx.v59.f32), simd::permute_f32(simd::load_f32(ctx.v56.f32), 57), 4));
	// lvlx128 v55,r11,r8
	...
	// vor128 v3,v61,v61
	simd::store_i8(ctx.v3.u8, simd::load_i8(ctx.v61.u8));
	// stfs f0,100(r1)
	temp.f32 = float(ctx.f0.f64);
	PPC_STORE_U32(ctx.r1.u32 + 100, temp.u32);
	// vor128 v2,v60,v60
	simd::store_i8(ctx.v2.u8, simd::load_i8(ctx.v60.u8));
	// lvlx128 v62,r0,r5
	temp.u32 = ctx.r0.u32 + ctx.r5.u32;
	simd::store_shuffled(ctx.v62.u8, base + (temp.u32 & ~0xF), &VectorMaskL[(temp.u32 & 0xF) * 16]);
	// vor128 v1,v59,v59
	simd::store_i8(ctx.v1.u8, simd::load_i8(ctx.v59.u8));
	// vrlimi128 v55,v62,4,3
	simd::store_f32(ctx.v55.f32, simd::blend_f32(simd::load_f32(ctx.v55.f32), simd::permute_f32(simd::load_f32(ctx.v62.f32), 57), 4));
	// vrlimi128 v54,v52,4,3
	simd::store_f32(ctx.v54.f32, simd::blend_f32(simd::load_f32(ctx.v54.f32), simd::permute_f32(simd::load_f32(ctx.v52.f32), 57), 4));
	// lwz r10,28(r11)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r11.u32 + 28);
	// vrlimi128 v53,v63,4,3
	simd::store_f32(ctx.v53.f32, simd::blend_f32(simd::load_f32(ctx.v53.f32), simd::permute_f32(simd::load_f32(ctx.v63.f32), 57), 4));
	// vrlimi128 v3,v55,3,2
	simd::store_f32(ctx.v3.f32, simd::blend_f32(simd::load_f32(ctx.v3.f32), simd::permute_f32(simd::load_f32(ctx.v55.f32), 78), 3));
	// vrlimi128 v2,v54,3,2
	simd::store_f32(ctx.v2.f32, simd::blend_f32(simd::load_f32(ctx.v2.f32), simd::permute_f32(simd::load_f32(ctx.v54.f32), 78), 3));
...
PPC_FUNC_IMPL(__imp__sub_82C4C898) {
	...
	simd::store_f32(ctx.v1.f32, simd::blend_f32(simd::load_f32(ctx.v1.f32), simd::permute_f32(simd::load_f32(ctx.v61.f32), 78), 3));
	// mtctr r5
...
PPC_FUNC_IMPL(__imp__sub_82C4CA38) {
	...
	// vor128 v125,v3,v3
	simd::store_i8(ctx.v125.u8, simd::load_i8(ctx.v3.u8));
	// fmr f31,f1
...
loc_82C4E808:
	...
	// lvx128 v1,r10,r9
	ctx.v1 = simd::load_and_shuffle(base + ((ctx.r10.u32 + ctx.r9.u32) & ~0xF), VectorMaskL);
	// lwz r8,52(r11)
...
loc_82C4E834:
	...
	// lvx128 v63,r10,r11
	ctx.v63 = simd::load_and_shuffle(base + ((ctx.r10.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// vmsum3fp128 v62,v63,v63
	ctx.fpscr.enableFlushMode();
	simd::store_f32_aligned(ctx.v62.f32, simd::dp_f32(simd::load_f32_aligned(ctx.v63.f32), simd::load_f32_aligned(ctx.v63.f32), 0xEF));
	// stvx128 v62,r0,r9
	ea = (ctx.r9.u32) & ~0xF;
...
loc_82C4EDC0:
	...
	// lvx128 v1,r31,r10
	ctx.v1 = simd::load_and_shuffle(base + ((ctx.r31.u32 + ctx.r10.u32) & ~0xF), VectorMaskL);
