...
loc_82BEAF5C:
	...
	// lwz r10,12556(r31)
	ctx.r10.u64 = PPC_LOAD_U32(r31.u32 + 12556);
	// stw r10,292(r30)
	PPC_STORE_U32(r30.u32 + 292, ctx.r10.u32);
	// lwz r9,12552(r31)
	ctx.r9.u64 = PPC_LOAD_U32(r31.u32 + 12552);
	// stw r9,296(r30)
...
loc_82BEB02C:
	...
	// lwz r11,12596(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + 12596);
	// stw r11,384(r30)
	...
	// lwz r9,12588(r31)
	ctx.r9.u64 = PPC_LOAD_U32(r31.u32 + 12588);
	// stw r9,392(r30)
...
loc_82BEB0D0:
	...
	r23.s64 = -2093809664;
	// lwz r11,18368(r23)
	r11.u64 = PPC_LOAD_U32(r23.u32 + 18368);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82beb61c
...
loc_82BEB2DC:
	...
	// lwz r3,18368(r23)
	ctx.r3.u64 = PPC_LOAD_U32(r23.u32 + 18368);
	// bl 0x82beac40
...
loc_82BEB368:
	...
	// lwz r21,24(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 24);
	// lwz r6,20(r31)
	...
	// lwz r11,1520(r1)
	r11.u64 = PPC_LOAD_U32(ctx.r1.u32 + 1520);
	// lis r10,-32256
	ctx.r10.s64 = -2113929216;
	// mr r6,r25
	ctx.r6.u64 = r25.u64;
...
loc_82BEB4E8:
	...
	// lwz r11,1920(r1)
	r11.u64 = PPC_LOAD_U32(ctx.r1.u32 + 1920);
	// lis r10,-32256
	ctx.r10.s64 = -2113929216;
	// mr r6,r26
	ctx.r6.u64 = r26.u64;
...
PPC_FUNC_IMPL(__imp__sub_82BEB708) {
	...
	ctx.r4.u64 = ctx.r3.u64;
	// lwz r11,18368(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 18368);
	// addis r3,r11,1
	ctx.r3.s64 = r11.s64 + 65536;
	// addi r3,r3,9868
...
loc_82BEF590:
	...
	// lwz r6,12(r21)
	ctx.r6.u64 = PPC_LOAD_U32(r21.u32 + 12);
	// cmplw cr6,r7,r6
...
loc_82BF0590:
	...
	// lwz r6,24260(r29)
	ctx.r6.u64 = PPC_LOAD_U32(r29.u32 + 24260);
	// addi r31,r31,56
	r31.s64 = r31.s64 + 56;
	// mr r11,r6
	r11.u64 = ctx.r6.u64;
...
loc_82BF1654:
	...
	// lwz r6,24436(r11)
	ctx.r6.u64 = PPC_LOAD_U32(r11.u32 + 24436);
	// mr r11,r6
	r11.u64 = ctx.r6.u64;
loc_82BF1664:
	// lbz r10,0(r11)
...
loc_82BF2054:
	...
	r11.s64 = -2094202880;
	// lwz r26,24440(r11)
	r26.u64 = PPC_LOAD_U32(r11.u32 + 24440);
loc_82BF205C:
	// lis r11,-31955
	r11.s64 = -2094202880;
	// addi r31,r11,24444
...
loc_82BF2194:
	...
	r11.s64 = -2093809664;
	// lwz r11,18484(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 18484);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82bf21cc
	...
	ctx.r3.u64 = r31.u64;
	// lwz r10,18500(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + 18500);
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beq cr6,0x82bf21c8
...
PPC_FUNC_IMPL(__imp__sub_82BF21E0) {
	...
	r31.s64 = 0;
	// lwz r8,18484(r11)
	ctx.r8.u64 = PPC_LOAD_U32(r11.u32 + 18484);
	// cmplwi cr6,r8,0
	cr6.compare<uint32_t>(ctx.r8.u32, 0, xer);
	// beq cr6,0x82bf2230
	...
	// lwz r11,18492(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 18492);
	// lwz r9,18488(r9)
...
loc_82BF2230:
	...
	r11.s64 = -2093809664;
	// lwz r10,18496(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + 18496);
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beq cr6,0x82bf2250
...
loc_82BF3DCC:
	...
	// lwz r21,15900(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 15900);
	// lwz r21,15908(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 15908);
	// lwz r21,15948(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 15948);
	// lwz r21,15956(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 15956);
	// lwz r21,15992(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 15992);
	// lwz r21,16032(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 16032);
	// lwz r21,16040(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 16040);
	// lwz r21,15948(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 15948);
	// lwz r21,16048(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 16048);
loc_82BF3E1C:
	// addi r3,r30,-148
...
loc_82BF46D4:
	...
	// lwz r21,18740(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 18740);
	// lwz r21,18792(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 18792);
	// lwz r21,18844(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 18844);
	// lwz r21,18896(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 18896);
	// lwz r21,19000(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 19000);
	// lwz r21,19016(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 19016);
	// lwz r21,19064(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 19064);
	// lwz r21,19032(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 19032);
	// lwz r21,19048(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 19048);
	// lwz r21,18460(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 18460);
loc_82BF481C:
	// lwz r3,0(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + 0);
	// li r4,-2
...
loc_82BF5760:
	...
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + -8);
	// lwz r24,20(r10)
	r24.u64 = PPC_LOAD_U32(ctx.r10.u32 + 20);
	// bl 0x82bc55b8
	sub_82BC55B8(ctx, base);
	// stw r24,96(r1)
...
PPC_FUNC_IMPL(__imp__sub_82BF59A0) {
	...
	// lwz r21,23488(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 23488);
	// lwz r21,23588(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 23588);
	// lwz r21,23688(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 23688);
	// lwz r21,23788(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 23788);
	// lwz r21,23952(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 23952);
	// lwz r21,24108(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 24108);
	// lwz r21,24236(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 24236);
	// lwz r21,24140(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 24140);
	// lwz r21,24172(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 24172);
	// lwz r21,24204(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 24204);
	// lwz r21,24300(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 24300);
	// lwz r21,24300(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 24300);
	// lwz r21,24300(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 24300);
	...
	r21.u64 = PPC_LOAD_U32(r31.u32 + 24300);
	// lwz r21,24268(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 24268);
loc_82BF5BC0:
	// li r4,1
	ctx.r4.s64 = 1;
	// lwz r3,0(r31)
...
PPC_FUNC_IMPL(__imp__sub_82BF6040) {
	...
	r31.u64 = ctx.r3.u64;
	// lwz r5,24500(r11)
	ctx.r5.u64 = PPC_LOAD_U32(r11.u32 + 24500);
	// bl 0x82228488
...
PPC_FUNC_IMPL(__imp__sub_82BF65D8) {
	...
	ctx.r4.s64 = ctx.r1.s64 + 96;
	// lwz r11,18856(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 18856);
	// lwz r3,0(r11)
...
PPC_FUNC_IMPL(__imp__sub_82BF6B88) {
	...
	// lwz r21,28576(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 28576);
	// lwz r21,28472(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 28472);
	// lwz r21,27632(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 27632);
	// lwz r21,27760(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 27760);
	// lwz r21,27872(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 27872);
	// lwz r21,27996(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 27996);
	// lwz r21,28068(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 28068);
	// lwz r21,28140(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 28140);
	// lwz r21,28396(r31)
	r21.u64 = PPC_LOAD_U32(r31.u32 + 28396);
loc_82BF6BF0:
	// lwz r11,0(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + 0);
	// lis r10,-32255
...
PPC_FUNC_IMPL(__imp__sub_82BF7090) {
	...
	r30.u64 = ctx.r3.u64;
	// lwz r11,18856(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + 18856);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82bf7140
...
PPC_FUNC_IMPL(__imp__sub_82BF7DF0) {
	...
	r23.s64 = -2093809664;
	// lwz r31,18888(r29)
	r31.u64 = PPC_LOAD_U32(r29.u32 + 18888);
	// ori r28,r11,40389
...
loc_82BF7EF4:
	...
	sub_821F3C28(ctx, base);
	// lwz r11,18884(r23)
	r11.u64 = PPC_LOAD_U32(r23.u32 + 18884);
	// cmplw cr6,r3,r11
	cr6.compare<uint32_t>(ctx.r3.u32, r11.u32, xer);
	// bne cr6,0x82bf80a4
...
loc_82BF80A4:
	// lwz r11,18880(r22)
	r11.u64 = PPC_LOAD_U32(r22.u32 + 18880);
	// cmplw cr6,r3,r11
	cr6.compare<uint32_t>(ctx.r3.u32, r11.u32, xer);
	// bne cr6,0x82bf80e4
...
loc_82BF80E4:
	// lwz r11,18872(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 18872);
	// cmplw cr6,r3,r11
	cr6.compare<uint32_t>(ctx.r3.u32, r11.u32, xer);
	// bne cr6,0x82bf81ac
...
loc_82BF81AC:
	// lwz r11,18876(r25)
	r11.u64 = PPC_LOAD_U32(r25.u32 + 18876);
	// cmplw cr6,r3,r11
	cr6.compare<uint32_t>(ctx.r3.u32, r11.u32, xer);
	// bne cr6,0x82bf82d4
...
loc_82BF82D4:
	// lwz r11,18868(r27)
	r11.u64 = PPC_LOAD_U32(r27.u32 + 18868);
	// cmplw cr6,r3,r11
	cr6.compare<uint32_t>(ctx.r3.u32, r11.u32, xer);
	// bne cr6,0x82bf845c
	if (!cr6.eq) goto loc_82BF845C;
