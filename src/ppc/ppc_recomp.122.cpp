...
PPC_FUNC_IMPL(__imp__sub_82C6D350) {
	...
	r11.u64 = PPC_LOAD_U32(r30.u32 + int32_t(8) );
	// lwz r31,80(r31)
	r31.u64 = PPC_LOAD_U32(r31.u32 + int32_t(80) );
	// cmplw cr6,r31,r11
	cr6.compare<uint32_t>(r31.u32, r11.u32, xer);
	// ble cr6,0x82c6d380
...
PPC_FUNC_IMPL(__imp__sub_82C6D760) {
	...
	// lwz r3,104(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(104) );
	// bl 0x82c6d5c8
	sub_82C6D5C8(ctx, base);
	// mr r4,r3
...
loc_82C6EB8C:
	...
	ctx.r4.s64 = 0;
	// lwz r5,20(r28)
	ctx.r5.u64 = PPC_LOAD_U32(r28.u32 + int32_t(20) );
	// mr r3,r28
	ctx.r3.u64 = r28.u64;
	// bl 0x8217cbe8
	sub_8217CBE8(ctx, base);
...
PPC_FUNC_IMPL(__imp__sub_82C6EF70) {
	...
	PPC_STORE_U32(r27.u32 + 0, ctx.r10.u32);
	// lwz r30,80(r27)
	r30.u64 = PPC_LOAD_U32(r27.u32 + int32_t(80) );
	// lwz r11,84(r27)
...
PPC_FUNC_IMPL(__imp__sub_82C6FCB8) {
	...
	if (cr6.eq) goto loc_82C6FF38;
	// lwz r4,36(r24)
	ctx.r4.u64 = PPC_LOAD_U32(r24.u32 + int32_t(36) );
	// addi r22,r24,36
	r22.s64 = r24.s64 + 36;
	// addi r3,r1,120
	...
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
	// lwz r5,56(r24)
	ctx.r5.u64 = PPC_LOAD_U32(r24.u32 + int32_t(56) );
	// lwz r26,48(r24)
	r26.u64 = PPC_LOAD_U32(r24.u32 + int32_t(48) );
	// mr r31,r3
	r31.u64 = ctx.r3.u64;
	// lwz r28,60(r24)
	r28.u64 = PPC_LOAD_U32(r24.u32 + int32_t(60) );
	// li r29,0
	r29.s64 = 0;
	// cmplwi cr6,r5,0
	...
	// lwz r11,22496(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(22496) );
	// clrlwi r9,r11,31
...
loc_82C6FDA8:
	...
	// lwz r27,52(r24)
	r27.u64 = PPC_LOAD_U32(r24.u32 + int32_t(52) );
	// lwz r29,56(r24)
	r29.u64 = PPC_LOAD_U32(r24.u32 + int32_t(56) );
	// bl 0x82b49bf0
...
loc_82C6FDC8:
	...
	ctx.r6.u64 = r31.u64;
	// lwz r7,22492(r25)
	ctx.r7.u64 = PPC_LOAD_U32(r25.u32 + int32_t(22492) );
	// mr r5,r30
	ctx.r5.u64 = r30.u64;
	// addi r4,r1,192
...
loc_82C6FE60:
	// lwz r6,52(r24)
	ctx.r6.u64 = PPC_LOAD_U32(r24.u32 + int32_t(52) );
	// cmplw cr6,r31,r6
...
loc_82C70BF8:
	...
	ctx.r4.u64 = r28.u64;
	// lwz r5,56(r6)
	ctx.r5.u64 = PPC_LOAD_U32(ctx.r6.u32 + int32_t(56) );
	// mtctr r5
	ctr.u64 = ctx.r5.u64;
	// bctrl 
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
...
PPC_FUNC_IMPL(__imp__sub_82C71F00) {
	...
	sub_82200688(ctx, base);
	// lwz r11,68(r24)
	r11.u64 = PPC_LOAD_U32(r24.u32 + int32_t(68) );
	// li r29,0
	r29.s64 = 0;
	// addi r27,r24,64
	r27.s64 = r24.s64 + 64;
...
loc_82C72998:
	...
	// lwz r3,284(r30)
	ctx.r3.u64 = PPC_LOAD_U32(r30.u32 + int32_t(284) );
	// bl 0x82c72640
...
loc_82C729B4:
	...
	ctx.r4.s64 = ctx.r1.s64 + 112;
	// lwz r3,292(r30)
	ctx.r3.u64 = PPC_LOAD_U32(r30.u32 + int32_t(292) );
	// mr r31,r28
	r31.u64 = r28.u64;
	// bl 0x82cfaad0
...
PPC_FUNC_IMPL(__imp__sub_82C72A60) {
	...
	r31.s64 = -2093809664;
	// lwz r11,22504(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + int32_t(22504) );
	// cmpwi cr6,r11,0
	cr6.compare<int32_t>(r11.s32, 0, xer);
	// bne cr6,0x82c72b08
...
PPC_FUNC_IMPL(__imp__sub_82C72B38) {
	...
	ctx.r10.s64 = -2093809664;
	// lwz r11,22504(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(22504) );
	// cmpwi cr6,r11,0
	cr6.compare<int32_t>(r11.s32, 0, xer);
	// addi r11,r11,-1
	r11.s64 = r11.s64 + -1;
	...
	r31.s64 = -2093809664;
	// lwz r3,22500(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(22500) );
	// bl 0x82c7d2f8
...
PPC_FUNC_IMPL(__imp__sub_82C72C20) {
	...
	r11.s64 = -2093809664;
	// lwz r3,22500(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(22500) );
	// blr 
	return;
}
...
loc_82C73424:
	...
	PPC_STORE_U32(ctx.r10.u32 + 0, ctx.r8.u32);
	// lwz r7,36(r27)
	ctx.r7.u64 = PPC_LOAD_U32(r27.u32 + int32_t(36) );
	// lwz r11,0(r7)
	r11.u64 = PPC_LOAD_U32(ctx.r7.u32 + int32_t(0) );
	// add r6,r30,r11
	ctx.r6.u64 = r30.u64 + r11.u64;
...
loc_82C73658:
	...
	// lwz r10,15240(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + int32_t(15240) );
	// bne cr6,0x82c736a0
	if (!cr6.eq) goto loc_82C736A0;
	// lwz r11,16(r4)
	r11.u64 = PPC_LOAD_U32(ctx.r4.u32 + int32_t(16) );
	// lwz r8,60(r4)
	ctx.r8.u64 = PPC_LOAD_U32(ctx.r4.u32 + int32_t(60) );
	// lwz r6,0(r11)
	ctx.r6.u64 = PPC_LOAD_U32(r11.u32 + int32_t(0) );
	// subf r11,r6,r8
	r11.s64 = ctx.r8.s64 - ctx.r6.s64;
...
loc_82C736D8:
	...
	PPC_STORE_U32(ctx.r8.u32 + 0, ctx.r7.u32);
	// lwz r6,32(r4)
	ctx.r6.u64 = PPC_LOAD_U32(ctx.r4.u32 + int32_t(32) );
	// lwz r11,0(r6)
	...
	// lwz r8,32(r4)
	ctx.r8.u64 = PPC_LOAD_U32(ctx.r4.u32 + int32_t(32) );
	// stw r5,0(r3)
...
loc_82C737A0:
	...
	cr6.compare<int32_t>(ctx.r6.s32, 2, xer);
	// lwz r9,15240(r11)
	ctx.r9.u64 = PPC_LOAD_U32(r11.u32 + int32_t(15240) );
	// bne cr6,0x82c737e4
...
loc_82C73810:
	...
	// lwz r4,36(r4)
	ctx.r4.u64 = PPC_LOAD_U32(ctx.r4.u32 + int32_t(36) );
	// lwz r11,0(r4)
	r11.u64 = PPC_LOAD_U32(ctx.r4.u32 + int32_t(0) );
	// add r11,r10,r11
	r11.u64 = ctx.r10.u64 + r11.u64;
...
loc_82C73890:
	...
	r11.s64 = -2113863680;
	// lwz r5,15240(r11)
	ctx.r5.u64 = PPC_LOAD_U32(r11.u32 + int32_t(15240) );
loc_82C73898:
	// li r11,0
	r11.s64 = 0;
	// stw r5,0(r3)
...
PPC_FUNC_IMPL(__imp__sub_82C738B0) {
	...
	// lwz r7,36(r4)
	ctx.r7.u64 = PPC_LOAD_U32(ctx.r4.u32 + int32_t(36) );
	// std r5,32(r1)
...
loc_82C738E4:
	...
	r11.s64 = -2113863680;
	// lwz r6,15240(r11)
	ctx.r6.u64 = PPC_LOAD_U32(r11.u32 + int32_t(15240) );
	// cmpw cr6,r10,r6
...
loc_82C73C18:
	...
	// lwz r7,52(r31)
	ctx.r7.u64 = PPC_LOAD_U32(r31.u32 + int32_t(52) );
	// stw r9,0(r7)
...
PPC_FUNC_IMPL(__imp__sub_82C74680) {
	...
	r31.s64 = -2093809664;
	// lwz r4,28484(r31)
	ctx.r4.u64 = PPC_LOAD_U32(r31.u32 + int32_t(28484) );
	// cmplwi cr6,r4,0
	cr6.compare<uint32_t>(ctx.r4.u32, 0, xer);
	// lwz r28,22536(r30)
	r28.u64 = PPC_LOAD_U32(r30.u32 + int32_t(22536) );
	// stw r28,80(r1)
	...
	sub_82CD1FE0(ctx, base);
	// lwz r11,28484(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + int32_t(28484) );
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82c746e4
...
PPC_FUNC_IMPL(__imp__sub_82C753A8) {
	...
	r31.u64 = ctx.r3.u64;
	// lwz r30,20(r4)
	r30.u64 = PPC_LOAD_U32(ctx.r4.u32 + int32_t(20) );
	// li r11,0
	r11.s64 = 0;
	// li r10,7
	ctx.r10.s64 = 7;
...
PPC_FUNC_IMPL(__imp__sub_82C757E8) {
	...
	r31.s64 = -2093809664;
	// lwz r4,22548(r31)
	ctx.r4.u64 = PPC_LOAD_U32(r31.u32 + int32_t(22548) );
	// cmplwi cr6,r4,0
	cr6.compare<uint32_t>(ctx.r4.u32, 0, xer);
	// lwz r28,22540(r30)
	r28.u64 = PPC_LOAD_U32(r30.u32 + int32_t(22540) );
	// stw r28,80(r1)
	PPC_STORE_U32(ctx.r1.u32 + 80, r28.u32);
	// bne cr6,0x82c75858
	...
	sub_82CD1FE0(ctx, base);
	// lwz r11,22548(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + int32_t(22548) );
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82c7584c
...
PPC_FUNC_IMPL(__imp__sub_82C758E0) {
	...
	r31.s64 = -2093809664;
	// lwz r4,22552(r31)
	ctx.r4.u64 = PPC_LOAD_U32(r31.u32 + int32_t(22552) );
	// cmplwi cr6,r4,0
	cr6.compare<uint32_t>(ctx.r4.u32, 0, xer);
	// lwz r28,22544(r30)
	r28.u64 = PPC_LOAD_U32(r30.u32 + int32_t(22544) );
	// stw r28,80(r1)
	PPC_STORE_U32(ctx.r1.u32 + 80, r28.u32);
	// bne cr6,0x82c75950
	...
	sub_82CD1FE0(ctx, base);
	// lwz r11,22552(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + int32_t(22552) );
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82c75944
...
loc_82C765DC:
	...
	// lwz r26,348(r1)
	r26.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(348) );
	// stw r20,116(r1)
...
loc_82C77D0C:
	...
	ctx.r3.u64 = r26.u64;
	// lwz r10,340(r1)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(340) );
	// lwz r9,344(r1)
...
loc_82C77FE8:
	...
	// lwz r9,232(r1)
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(232) );
	// stw r11,0(r26)
	PPC_STORE_U32(r26.u32 + 0, r11.u32);
	// stw r10,4(r26)
	PPC_STORE_U32(r26.u32 + 4, ctx.r10.u32);
...
PPC_FUNC_IMPL(__imp__sub_82C78A08) {
	...
	// lwz r3,288(r27)
	ctx.r3.u64 = PPC_LOAD_U32(r27.u32 + int32_t(288) );
	// bl 0x82cfab20
...
loc_82C78A90:
	...
	ctx.r3.s64 = ctx.r1.s64 + 224;
	// lwz r28,124(r1)
	r28.u64 = PPC_LOAD_U32(ctx.r1.u32 + int32_t(124) );
	// bl 0x82c77878
...
loc_82C78B4C:
	...
	ctx.r4.s64 = ctx.r1.s64 + 176;
	// lwz r3,284(r27)
	ctx.r3.u64 = PPC_LOAD_U32(r27.u32 + int32_t(284) );
	// ld r6,216(r1)
...
PPC_FUNC_IMPL(__imp__sub_82C78E58) {
	...
	// lwz r7,16(r4)
	ctx.r7.u64 = PPC_LOAD_U32(ctx.r4.u32 + int32_t(16) );
	// stw r10,0(r3)
	PPC_STORE_U32(ctx.r3.u32 + 0, ctx.r10.u32);
	// stw r9,4(r3)
