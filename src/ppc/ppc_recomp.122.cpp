...
PPC_FUNC_IMPL(__imp__sub_82C6C7B0) {
	...
	r23.u64 = ctx.r7.u64;
	// rotlwi r26,r6,0
	r26.u64 = __builtin_rotateleft32(ctx.r6.u32, 0);
	// mr r20,r3
	r20.u64 = ctx.r3.u64;
	// add r3,r26,r23
...
loc_82C6C8C4:
	...
	r31.u64 = __builtin_rotateleft64(r29.u32 | (r29.u64 << 32), 15) & 0xFFFF8000;
	// lwz r11,0(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 0);
	// lwz r10,24(r11)
...
loc_82C75BE0:
	...
	r16.u64 = __builtin_rotateleft64(ctx.r10.u32 | (ctx.r10.u64 << 32), 0) & 0xE;
	// rlwinm r16,r16,0,30,28
	r16.u64 = __builtin_rotateleft64(r16.u32 | (r16.u64 << 32), 0) & 0xFFFFFFFFFFFFFFFB;
loc_82C75BF0:
	// mr r4,r23
	ctx.r4.u64 = r23.u64;
	// mr r3,r29
