...
loc_82F0657C:
	...
	r11.u64 = PPC_LOAD_U32(r11.u32 + 180);
	// lwz r29,320(r11)
	r29.u64 = PPC_LOAD_U32(r11.u32 + 320);
	// cmpwi cr6,r29,0
	...
	r27.u64 = __builtin_rotateleft64(ctx.r10.u32 | (ctx.r10.u64 << 32), 30) & 0x1;
	// lwz r9,36(r11)
	ctx.r9.u64 = PPC_LOAD_U32(r11.u32 + 36);
	// lwz r10,40(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + 40);
...
loc_82F07BE8:
	...
	ctx.r3.s64 = 148;
	// lwz r28,48(r26)
	r28.u64 = PPC_LOAD_U32(r26.u32 + 48);
	// bl 0x82ef6ef8
	sub_82EF6EF8(ctx, base);
	// cmplwi r3,0
	cr0.compare<uint32_t>(ctx.r3.u32, 0, xer);
...
loc_82F07D08:
	...
	f0.f64 = double(float(f0.f64));
	// fctidz f11,f31
	ctx.f11.s64 = (f31.f64 > double(LLONG_MAX)) ? LLONG_MAX : _mm_cvttsd_si64(_mm_load_sd(&f31.f64));
	// stfiwx f11,r10,r9
	...
	// lwz r11,180(r20)
	r11.u64 = PPC_LOAD_U32(r20.u32 + 180);
	// cmplwi cr6,r29,0
	cr6.compare<uint32_t>(r29.u32, 0, xer);
	// lbz r10,330(r11)
...
loc_82F08E80:
	...
	r11.u64 = (__builtin_rotateleft32(r25.u32, 0) & 0xFFFFFFFFFFFF0001) | (r11.u64 & 0xFFFE);
	// lwz r9,176(r29)
...
PPC_FUNC_IMPL(__imp__sub_82F0A760) {
	...
	r11.u64 = __builtin_rotateleft64(ctx.r3.u32 | (ctx.r3.u64 << 32), 30) & 0x1;
	cr0.compare<int32_t>(r11.s32, 0, xer);
	// beq 0x82f0a8a8
...
loc_82F0C474:
	...
	r30.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 25) & 0x1FFFFFF;
	// b 0x82f0bcd8
	goto loc_82F0BCD8;
loc_82F0C494:
	// lwz r11,120(r28)
...
loc_82F0C5E0:
	...
	r30.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 26) & 0x1;
	// b 0x82f0bcd8
	goto loc_82F0BCD8;
loc_82F0C600:
	// lwz r11,120(r28)
...
loc_82F0C824:
	...
	r29.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 23) & 0x1;
	// b 0x82f0c80c
	goto loc_82F0C80C;
loc_82F0C840:
	// lwz r11,120(r28)
...
PPC_FUNC_IMPL(__imp__sub_82F0DBE0) {
	...
	// lvx128 v63,r29,r11
	_mm_store_si128((__m128i*)v63.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((r29.u32 + r11.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// addi r7,r1,144
	ctx.r7.s64 = ctx.r1.s64 + 144;
	// vspltw128 v61,v63,0
	_mm_store_si128((__m128i*)v61.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)v63.u32), 0xFF));
	// lvx128 v60,r0,r10
	_mm_store_si128((__m128i*)v60.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r10.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// vmulfp128 v10,v62,v60
	ctx.fpscr.enableFlushModeUnconditional();
	_mm_store_ps(ctx.v10.f32, _mm_mul_ps(_mm_load_ps(v62.f32), _mm_load_ps(v60.f32)));
	// vspltw128 v9,v63,1
	...
	_mm_store_ps(ctx.v7.f32, _mm_mul_ps(_mm_load_ps(v61.f32), _mm_load_ps(v60.f32)));
	// addi r10,r1,336
...
loc_82F0DFCC:
	...
	r28.u64 = __builtin_rotateleft64(ctx.r10.u32 | (ctx.r10.u64 << 32), 26) & 0x1;
	// sth r9,224(r31)
	PPC_STORE_U16(r31.u32 + 224, ctx.r9.u16);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
...
loc_82F1062C:
	...
	r11.u64 = PPC_LOAD_U32(ctx.r1.u32 + 152);
	// fctidz f12,f28
	ctx.f12.s64 = (f28.f64 > double(LLONG_MAX)) ? LLONG_MAX : _mm_cvttsd_si64(_mm_load_sd(&f28.f64));
	// stfiwx f12,r11,r9
	...
	r11.u64 = PPC_LOAD_U32(ctx.r1.u32 + 152);
	// fctidz f11,f29
	ctx.f11.s64 = (f29.f64 > double(LLONG_MAX)) ? LLONG_MAX : _mm_cvttsd_si64(_mm_load_sd(&f29.f64));
	// cmplwi cr6,r26,0
	cr6.compare<uint32_t>(r26.u32, 0, xer);
	// stfiwx f11,r11,r8
...
loc_82F107C0:
	...
	sub_82F0AF70(ctx, base);
	// lwz r29,180(r27)
	r29.u64 = PPC_LOAD_U32(r27.u32 + 180);
	// lwz r3,32(r29)
...
loc_82F12CC0:
	...
	ctx.r3.u64 = r30.u64;
	// lwz r11,7(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 7);
	// addi r31,r31,8
	r31.s64 = r31.s64 + 8;
	// stw r10,132(r1)
...
loc_82F12ED8:
	...
	ctx.r10.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 31) & 0x7FFF;
	// rlwinm r9,r11,30,18,31
	ctx.r9.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 30) & 0x3FFF;
	// rlwinm r8,r11,29,19,31
	ctx.r8.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 29) & 0x1FFF;
	// rlwinm r7,r11,28,20,31
	ctx.r7.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 28) & 0xFFF;
	// rlwinm r6,r11,27,21,31
	ctx.r6.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 27) & 0x7FF;
	// rlwinm r5,r11,26,22,31
	ctx.r5.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 26) & 0x3FF;
	// rlwinm r31,r11,25,23,31
	r31.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 25) & 0x1FF;
	// rlwinm r26,r11,24,24,31
	r26.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 24) & 0xFF;
	// clrlwi r25,r10,31
