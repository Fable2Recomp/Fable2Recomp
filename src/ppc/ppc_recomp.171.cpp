...
PPC_FUNC_IMPL(__imp__sub_82F663C8) {
	...
	// fsqrt f1,f0
	ctx.f1.f64 = simd::sqrt_f64(ctx.f0.f64);
	// blr 
	return;
}
...
PPC_FUNC_IMPL(__imp__sub_82F66510) {
	...
	ctx.r11.s64 = 16;
	// lvx128 v63,r0,r31
	ctx.v63 = simd::load_and_shuffle(base + ((ctx.r31.u32) & ~0xF), VectorMaskL);
	// addi r10,r1,80
	ctx.r10.s64 = ctx.r1.s64 + 80;
	// addi r9,r1,96
	...
	// lvx128 v62,r31,r11
	ctx.v62 = simd::load_and_shuffle(base + ((ctx.r31.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// stvx128 v63,r0,r10
	ea = (ctx.r10.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v63,
		VectorMaskL);
