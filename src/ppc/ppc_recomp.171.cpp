...
PPC_FUNC_IMPL(__imp__sub_82F65E60) {
	...
	r11.s64 = 16;
	// lvx128 v63,r0,r4
	_mm_store_si128((__m128i*)v63.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r4.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// stvx128 v63,r0,r3
...
PPC_FUNC_IMPL(__imp__sub_82F65E78) {
	...
	_mm_store_ps(v62.f32, _mm_blend_ps(_mm_load_ps(v62.f32), _mm_permute_ps(_mm_load_ps(v60.f32), 57), 4));
	// stfs f5,60(r1)
	...
	_mm_store_ps(v60.f32, _mm_blend_ps(_mm_load_ps(v60.f32), _mm_permute_ps(_mm_load_ps(v63.f32), 57), 4));
	// vrlimi128 v61,v60,3,2
	_mm_store_ps(v61.f32, _mm_blend_ps(_mm_load_ps(v61.f32), _mm_permute_ps(_mm_load_ps(v60.f32), 78), 3));
	// vrlimi128 v62,v59,3,2
	_mm_store_ps(v62.f32, _mm_blend_ps(_mm_load_ps(v62.f32), _mm_permute_ps(_mm_load_ps(v59.f32), 78), 3));
	// stvx128 v61,r0,r3
...
PPC_FUNC_IMPL(__imp__sub_82F65F08) {
	...
	// lvx128 v60,r0,r11
	_mm_store_si128((__m128i*)v60.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((r11.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// vmulfp128 v63,v63,v62
	ctx.fpscr.enableFlushModeUnconditional();
	_mm_store_ps(v63.f32, _mm_mul_ps(_mm_load_ps(v63.f32), _mm_load_ps(v62.f32)));
	// vmulfp128 v62,v60,v61
	_mm_store_ps(v62.f32, _mm_mul_ps(_mm_load_ps(v60.f32), _mm_load_ps(v61.f32)));
	// stvx128 v63,r0,r3
	_mm_store_si128((__m128i*)(base + ((ctx.r3.u32) & ~0xF)), _mm_shuffle_epi8(_mm_load_si128((__m128i*)v63.u8), _mm_load_si128((__m128i*)VectorMaskL)));
	// stvx128 v62,r0,r11
...
PPC_FUNC_IMPL(__imp__sub_82F66008) {
	...
	_mm_store_ps(ctx.v10.f32, _mm_mul_ps(_mm_load_ps(v62.f32), _mm_load_ps(v61.f32)));
	// vspltw128 v62,v63,0
	_mm_store_si128((__m128i*)v62.u32, _mm_shuffle_epi32(_mm_load_si128((__m128i*)v63.u32), 0xFF));
	// lvx128 v0,r4,r11
	...
	_mm_store_ps(ctx.v7.f32, _mm_mul_ps(_mm_load_ps(v62.f32), _mm_load_ps(v61.f32)));
...
PPC_FUNC_IMPL(__imp__sub_82F66118) {
	...
	_mm_store_si128((__m128i*)ctx.v0.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r4.u32 + r11.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// lvx128 v63,r5,r11
	_mm_store_si128((__m128i*)v63.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r5.u32 + r11.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// vsubfp128 v13,v63,v0
	_mm_store_ps(ctx.v13.f32, _mm_sub_ps(_mm_load_ps(v63.f32), _mm_load_ps(ctx.v0.f32)));
...
PPC_FUNC_IMPL(__imp__sub_82F66408) {
	...
	// lvx128 v62,r0,r4
	_mm_store_si128((__m128i*)v62.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r4.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// stvx128 v62,r0,r3
	_mm_store_si128((__m128i*)(base + ((ctx.r3.u32) & ~0xF)), _mm_shuffle_epi8(_mm_load_si128((__m128i*)v62.u8), _mm_load_si128((__m128i*)VectorMaskL)));
	// stvx128 v63,r0,r4
...
PPC_FUNC_IMPL(__imp__sub_82F66510) {
	...
	ctx.r4.s64 = ctx.r1.s64 + 80;
	// lvx128 v62,r31,r11
	_mm_store_si128((__m128i*)v62.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((r31.u32 + r11.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// stvx128 v63,r0,r10
	_mm_store_si128((__m128i*)(base + ((ctx.r10.u32) & ~0xF)), _mm_shuffle_epi8(_mm_load_si128((__m128i*)v63.u8), _mm_load_si128((__m128i*)VectorMaskL)));
	// stvx128 v62,r0,r9
...
PPC_FUNC_IMPL(__imp__sub_82F66618) {
	...
	ctx.f5.f64 = double(float(ctx.f12.f64 * ctx.f4.f64 + f28.f64));
	// fmadds f8,f12,f3,f29
	ctx.f8.f64 = double(float(ctx.f12.f64 * ctx.f3.f64 + f29.f64));
	// fmadds f4,f7,f4,f11
...
loc_82F6EBF8:
	...
	r11.u64 = __builtin_rotateleft64(ctx.r8.u32 | (ctx.r8.u64 << 32), 23) & 0x7F;
	// clrlwi. r11,r11,31
	r11.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(r11.s32, 0, xer);
	// beq 0x82f6ec0c
