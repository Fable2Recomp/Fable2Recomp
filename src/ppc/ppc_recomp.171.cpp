...
loc_82F66D2C:
	...
	ctx.r8.u64 = PPC_LOAD_U32(r11.u32 + int32_t(4) );
	// lwz r31,16(r8)
	r31.u64 = PPC_LOAD_U32(ctx.r8.u32 + int32_t(16) );
	// and r31,r31,r7
...
loc_82F67A08:
	...
	r30.u64 = r29.u64;
	// lwz r11,3048(r29)
	r11.u64 = PPC_LOAD_U32(r29.u32 + int32_t(3048) );
	// stw r11,8(r31)
	PPC_STORE_U32(r31.u32 + 8, r11.u32);
loc_82F67A1C:
	// lwz r11,0(r30)
...
loc_82F67AB8:
	...
	r11.u64 = PPC_LOAD_U32(r31.u32 + int32_t(16) );
	// lwz r10,2016(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + int32_t(2016) );
	// lwz r3,2020(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(2020) );
	// stw r10,16(r31)
	PPC_STORE_U32(r31.u32 + 16, ctx.r10.u32);
	// bl 0x82ef6f38
	sub_82EF6F38(ctx, base);
...
PPC_FUNC_IMPL(__imp__sub_82F684B0) {
	...
	ctx.r1.u32 = ea;
	// lwz r10,156(r4)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r4.u32 + int32_t(156) );
	// mr r31,r3
	r31.u64 = ctx.r3.u64;
	// lwz r9,136(r4)
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r4.u32 + int32_t(136) );
	// addi r11,r4,136
	r11.s64 = ctx.r4.s64 + 136;
	// lwz r8,140(r4)
	ctx.r8.u64 = PPC_LOAD_U32(ctx.r4.u32 + int32_t(140) );
	// addi r10,r10,-1
	ctx.r10.s64 = ctx.r10.s64 + -1;
	// subf r8,r8,r9
...
loc_82F690D4:
	...
	r24.u64 = r29.u64;
	// lwz r26,56(r29)
	r26.u64 = PPC_LOAD_U32(r29.u32 + int32_t(56) );
	// cmpwi cr6,r26,0
...
loc_82F69488:
	// lwz r26,116(r25)
	r26.u64 = PPC_LOAD_U32(r25.u32 + int32_t(116) );
	// mr r3,r26
	ctx.r3.u64 = r26.u64;
	// bl 0x82f63440
...
loc_82F6969C:
	...
	r16.u64 = r20.u64;
	// lwz r25,8(r21)
	r25.u64 = PPC_LOAD_U32(r21.u32 + int32_t(8) );
	// lwz r15,184(r27)
	r15.u64 = PPC_LOAD_U32(r27.u32 + int32_t(184) );
	// cmplwi cr6,r11,2
...
loc_82F69808:
	...
	// lwz r25,40(r25)
	r25.u64 = PPC_LOAD_U32(r25.u32 + int32_t(40) );
loc_82F69828:
	// lbz r11,32(r22)
	r11.u64 = PPC_LOAD_U8(r22.u32 + 32);
	// cmplwi cr6,r11,2
...
loc_82F698D4:
	...
	ctx.r3.u64 = r28.u64;
	// lwz r4,28(r21)
	ctx.r4.u64 = PPC_LOAD_U32(r21.u32 + int32_t(28) );
	// bl 0x82f9c430
	sub_82F9C430(ctx, base);
	// lwz r11,28(r21)
	r11.u64 = PPC_LOAD_U32(r21.u32 + int32_t(28) );
	// mr r31,r20
	r31.u64 = r20.u64;
	// cmpwi cr6,r11,0
	cr6.compare<int32_t>(r11.s32, 0, xer);
...
loc_82F69A24:
	...
	r11.u64 = PPC_LOAD_U32(r21.u32 + int32_t(28) );
	// lwz r28,40(r22)
	r28.u64 = PPC_LOAD_U32(r22.u32 + int32_t(40) );
	// cmpw cr6,r11,r28
...
loc_82F69AD0:
	...
	// lwz r10,28(r21)
	ctx.r10.u64 = PPC_LOAD_U32(r21.u32 + int32_t(28) );
	// lwz r11,40(r22)
	r11.u64 = PPC_LOAD_U32(r22.u32 + int32_t(40) );
	// mr r26,r10
	r26.u64 = ctx.r10.u64;
...
loc_82F69DC8:
	...
	ctx.r4.u64 = r25.u64;
	// lwz r30,120(r27)
	r30.u64 = PPC_LOAD_U32(r27.u32 + int32_t(120) );
	// addi r3,r1,256
...
loc_82F69F24:
	...
	// lwz r3,116(r27)
	ctx.r3.u64 = PPC_LOAD_U32(r27.u32 + int32_t(116) );
	// lwz r11,0(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + int32_t(0) );
	// lwz r11,68(r11)
...
loc_82F69FC4:
	...
	ctx.r3.u64 = r27.u64;
	// lwz r31,596(r11)
	r31.u64 = PPC_LOAD_U32(r11.u32 + int32_t(596) );
	// bl 0x82f16160
	sub_82F16160(ctx, base);
	// mr r4,r31
	ctx.r4.u64 = r31.u64;
...
loc_82F6A02C:
	...
	ctx.r4.u64 = r27.u64;
	// lwz r7,4(r21)
	ctx.r7.u64 = PPC_LOAD_U32(r21.u32 + int32_t(4) );
	// lwz r6,24(r22)
	ctx.r6.u64 = PPC_LOAD_U32(r22.u32 + int32_t(24) );
	// lwz r5,20(r22)
	ctx.r5.u64 = PPC_LOAD_U32(r22.u32 + int32_t(20) );
	// lwz r3,4(r22)
...
loc_82F6A110:
	...
	ctx.r3.s64 = r27.s64 + 104;
	// lwz r10,108(r27)
	ctx.r10.u64 = PPC_LOAD_U32(r27.u32 + int32_t(108) );
	// subf r4,r11,r10
...
loc_82F6B138:
	...
	ctx.r3.u64 = r27.u64;
	// lwz r4,168(r11)
	ctx.r4.u64 = PPC_LOAD_U32(r11.u32 + int32_t(168) );
	// b 0x82f6b1ac
	goto loc_82F6B1AC;
loc_82F6B150:
	// cmplwi cr6,r11,2
...
loc_82F6B180:
	...
	// lwz r4,284(r11)
	ctx.r4.u64 = PPC_LOAD_U32(r11.u32 + int32_t(284) );
	// b 0x82f6b1ac
	goto loc_82F6B1AC;
loc_82F6B1A8:
	// lwz r4,148(r11)
...
loc_82F6B2B4:
	...
	r11.u64 = PPC_LOAD_U32(r29.u32 + int32_t(0) );
	// lwz r4,288(r11)
	ctx.r4.u64 = PPC_LOAD_U32(r11.u32 + int32_t(288) );
	// b 0x82f6b368
	goto loc_82F6B368;
loc_82F6B2C0:
	// lbz r11,0(r31)
...
loc_82F6B360:
	...
	r11.u64 = PPC_LOAD_U32(r29.u32 + int32_t(0) );
	// lwz r4,292(r11)
	ctx.r4.u64 = PPC_LOAD_U32(r11.u32 + int32_t(292) );
loc_82F6B368:
	// mr r3,r27
	ctx.r3.u64 = r27.u64;
	// bl 0x82f0b778
...
PPC_FUNC_IMPL(__imp__sub_82F6B400) {
	...
	// lwz r11,120(r5)
	r11.u64 = PPC_LOAD_U32(ctx.r5.u32 + int32_t(120) );
	// lwz r10,16(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + int32_t(16) );
loc_82F6B438:
	// stw r10,0(r31)
...
PPC_FUNC_IMPL(__imp__sub_82F6E878) {
	...
	// lwz r11,32(r6)
	r11.u64 = PPC_LOAD_U32(ctx.r6.u32 + int32_t(32) );
	// lwz r10,32(r5)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r5.u32 + int32_t(32) );
	// cmpw cr6,r11,r10
	cr6.compare<int32_t>(r11.s32, ctx.r10.s32, xer);
	// bne cr6,0x82f6e920
	if (!cr6.eq) goto loc_82F6E920;
...
PPC_FUNC_IMPL(__imp__sub_82F6EA28) {
	...
	// lwz r4,1272(r31)
	ctx.r4.u64 = PPC_LOAD_U32(r31.u32 + int32_t(1272) );
	// bl 0x82f957e0
...
loc_82F6F570:
	// lwz r11,320(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + int32_t(320) );
	// lfs f0,92(r31)
	ctx.fpscr.disableFlushMode();
