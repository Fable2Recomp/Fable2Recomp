...
loc_82CD41E8:
	...
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r11.u32 + 64);
	// lvx128 v63,r10,r3
	ctx.v63 = simd::load_and_shuffle(base + ((ctx.r10.u32 + ctx.r3.u32) & ~0xF), VectorMaskL);
	// lvx128 v62,r10,r6
	ctx.v62 = simd::load_and_shuffle(base + ((ctx.r10.u32 + ctx.r6.u32) & ~0xF), VectorMaskL);
	// lvx128 v61,r0,r10
	ctx.v61 = simd::load_and_shuffle(base + ((ctx.r10.u32) & ~0xF), VectorMaskL);
	// stvx128 v61,r0,r11
	ea = (ctx.r11.u32) & ~0xF;
...
loc_82CD432C:
	...
	// lvx128 v63,r11,r6
	ctx.v63 = simd::load_and_shuffle(base + ((ctx.r11.u32 + ctx.r6.u32) & ~0xF), VectorMaskL);
	// lvx128 v62,r11,r7
	ctx.v62 = simd::load_and_shuffle(base + ((ctx.r11.u32 + ctx.r7.u32) & ~0xF), VectorMaskL);
	// lvx128 v61,r0,r11
	ctx.v61 = simd::load_and_shuffle(base + ((ctx.r11.u32) & ~0xF), VectorMaskL);
	// stvx128 v61,r0,r5
	ea = (ctx.r5.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v61,
		VectorMaskL);
...
loc_82CD4ED0:
	...
	// vor128 v60,v63,v62
	simd::store_i8(ctx.v60.u8, simd::or_i8(simd::load_i8(ctx.v63.u8), simd::load_i8(ctx.v62.u8)));
	// lvrx128 v59,r8,r10
	...
	// vor128 v58,v61,v59
	simd::store_i8(ctx.v58.u8, simd::or_i8(simd::load_i8(ctx.v61.u8), simd::load_i8(ctx.v59.u8)));
	// stvlx128 v60,r0,r11
	ea = 
ctx.r11.u32;
	uint8_t tmp_bytes[16];
	simd::store_u8(tmp_bytes, ctx.v60);
	uint32_t tmp_off = ea & 0xF;
	for (size_t i = 0; i < (16 - tmp_off); i++)
		PPC_STORE_U8(ea + i, tmp_bytes[15 - i]);
	// stvrx128 v60,r11,r8
	ea = 
ctx.r11.u32 + ctx.r8.u32;
	uint8_t tmp_bytes[16];
	simd::store_u8(tmp_bytes, ctx.v60);
	uint32_t tmp_off = ea & 0xF;
	for (size_t i = 0; i < tmp_off; i++)
		PPC_STORE_U8(ea - i - 1, tmp_bytes[i]);
	// addi r11,r11,16
...
ctx.r9.u32;
	uint8_t tmp_bytes[16];
	simd::store_u8(tmp_bytes, ctx.v58);
	uint32_t tmp_off = ea & 0xF;
	for (size_t i = 0; i < (16 - tmp_off); i++)
		PPC_STORE_U8(ea + i, tmp_bytes[15 - i]);
	// stvrx128 v58,r9,r8
...
loc_82CD7328:
	...
	// vspltw128 v63,v63,0
	simd::store_i32(ctx.v63.u32, simd::permute_i32(simd::load_i32(ctx.v63.u32), 0xFF));
	// subf r26,r9,r30
	...
	// lvx128 v62,r0,r5
	ctx.v62 = simd::load_and_shuffle(base + ((ctx.r5.u32) & ~0xF), VectorMaskL);
	// subf r25,r9,r8
	...
	simd::store_f32_aligned(ctx.v0.f32, simd::sub_f32(simd::load_f32_aligned(ctx.v62.f32), simd::load_f32_aligned(ctx.v63.f32)));
	// addi r11,r9,16
...
loc_82CD76D8:
	// lvx128 v61,r27,r10
	ctx.v61 = simd::load_and_shuffle(base + ((ctx.r27.u32 + ctx.r10.u32) & ~0xF), VectorMaskL);
	// addic. r4,r4,-1
	ctx.xer.ca = ctx.r4.u32 > 0;
	ctx.r4.s64 = ctx.r4.s64 + -1;
	ctx.cr0.compare<int32_t>(ctx.r4.s32, 0, ctx.xer);
	// lvx128 v60,r3,r11
	ctx.v60 = simd::load_and_shuffle(base + ((ctx.r3.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// vmulfp128 v13,v63,v61
	ctx.fpscr.enableFlushMode();
	simd::store_f32_aligned(ctx.v13.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v63.f32), simd::load_f32_aligned(ctx.v61.f32)));
	// lvx128 v59,r0,r10
	ctx.v59 = simd::load_and_shuffle(base + ((ctx.r10.u32) & ~0xF), VectorMaskL);
	// vmulfp128 v12,v63,v60
	simd::store_f32_aligned(ctx.v12.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v63.f32), simd::load_f32_aligned(ctx.v60.f32)));
	// lvx128 v58,r26,r11
	ctx.v58 = simd::load_and_shuffle(base + ((ctx.r26.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// vmulfp128 v11,v63,v59
	simd::store_f32_aligned(ctx.v11.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v63.f32), simd::load_f32_aligned(ctx.v59.f32)));
	// vmulfp128 v10,v63,v58
	simd::store_f32_aligned(ctx.v10.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v63.f32), simd::load_f32_aligned(ctx.v58.f32)));
	// lvx128 v9,r0,r11
	ctx.v9 = simd::load_and_shuffle(base + ((ctx.r11.u32) & ~0xF), VectorMaskL);
	// lvx128 v8,r11,r31
	ctx.v8 = simd::load_and_shuffle(base + ((ctx.r11.u32 + ctx.r31.u32) & ~0xF), VectorMaskL);
	// lvx128 v7,r22,r10
	ctx.v7 = simd::load_and_shuffle(base + ((ctx.r22.u32 + ctx.r10.u32) & ~0xF), VectorMaskL);
	// lvx128 v6,r25,r11
	ctx.v6 = simd::load_and_shuffle(base + ((ctx.r25.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// lvx128 v57,r29,r10
	ctx.v57 = simd::load_and_shuffle(base + ((ctx.r29.u32 + ctx.r10.u32) & ~0xF), VectorMaskL);
	// lvx128 v56,r24,r11
	ctx.v56 = simd::load_and_shuffle(base + ((ctx.r24.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// vmulfp128 v55,v62,v57
	simd::store_f32_aligned(ctx.v55.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v62.f32), simd::load_f32_aligned(ctx.v57.f32)));
	// lvx128 v54,r30,r10
	ctx.v54 = simd::load_and_shuffle(base + ((ctx.r30.u32 + ctx.r10.u32) & ~0xF), VectorMaskL);
	// vmulfp128 v53,v62,v56
	simd::store_f32_aligned(ctx.v53.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v62.f32), simd::load_f32_aligned(ctx.v56.f32)));
	// lvx128 v52,r23,r11
	ctx.v52 = simd::load_and_shuffle(base + ((ctx.r23.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// vmulfp128 v51,v62,v54
	simd::store_f32_aligned(ctx.v51.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v62.f32), simd::load_f32_aligned(ctx.v54.f32)));
	// vmulfp128 v50,v62,v52
	simd::store_f32_aligned(ctx.v50.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v62.f32), simd::load_f32_aligned(ctx.v52.f32)));
	// addi r10,r10,32
	ctx.r10.s64 = ctx.r10.s64 + 32;
...
loc_82CD8E60:
	// lvx128 v63,r0,r6
	ctx.v63 = simd::load_and_shuffle(base + ((ctx.r6.u32) & ~0xF), VectorMaskL);
	...
	simd::store_f32_aligned(ctx.v12.f32, simd::add_f32(simd::load_f32_aligned(ctx.v0.f32), simd::load_f32_aligned(ctx.v63.f32)));
	// cmplwi cr6,r11,0
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// vaddfp128 v61,v62,v63
	simd::store_f32_aligned(ctx.v61.f32, simd::add_f32(simd::load_f32_aligned(ctx.v62.f32), simd::load_f32_aligned(ctx.v63.f32)));
	// vaddfp128 v63,v62,v62
	simd::store_f32_aligned(ctx.v63.f32, simd::add_f32(simd::load_f32_aligned(ctx.v62.f32), simd::load_f32_aligned(ctx.v62.f32)));
	// vaddfp128 v11,v0,v62
	simd::store_f32_aligned(ctx.v11.f32, simd::add_f32(simd::load_f32_aligned(ctx.v0.f32), simd::load_f32_aligned(ctx.v62.f32)));
	// vaddfp128 v13,v0,v61
	simd::store_f32_aligned(ctx.v13.f32, simd::add_f32(simd::load_f32_aligned(ctx.v0.f32), simd::load_f32_aligned(ctx.v61.f32)));
	// beq cr6,0x82cd8f1c
...
loc_82CD8EB0:
	...
	// lvx128 v9,r11,r31
	ctx.v9 = simd::load_and_shuffle(base + ((ctx.r11.u32 + ctx.r31.u32) & ~0xF), VectorMaskL);
	// add r6,r5,r11
	ctx.r6.u64 = ctx.r5.u64 + ctx.r11.u64;
	// lvx128 v8,r0,r11
	ctx.v8 = simd::load_and_shuffle(base + ((ctx.r11.u32) & ~0xF), VectorMaskL);
	// lvx128 v7,r11,r3
	ctx.v7 = simd::load_and_shuffle(base + ((ctx.r11.u32 + ctx.r3.u32) & ~0xF), VectorMaskL);
	...
	// lvx128 v5,r11,r4
	ctx.v5 = simd::load_and_shuffle(base + ((ctx.r11.u32 + ctx.r4.u32) & ~0xF), VectorMaskL);
	// addic. r9,r9,-1
	ctx.xer.ca = ctx.r9.u32 > 0;
	ctx.r9.s64 = ctx.r9.s64 + -1;
	ctx.cr0.compare<int32_t>(ctx.r9.s32, 0, ctx.xer);
	// lvx128 v4,r0,r8
	ctx.v4 = simd::load_and_shuffle(base + ((ctx.r8.u32) & ~0xF), VectorMaskL);
	...
	// lvx128 v1,r0,r6
	ctx.v1 = simd::load_and_shuffle(base + ((ctx.r6.u32) & ~0xF), VectorMaskL);
	// vmaddfp v31,v5,v12,v3
	simd::store_f32_aligned(ctx.v31.f32, simd::add_f32(simd::mul_f32(simd::load_f32_aligned(ctx.v5.f32), simd::load_f32_aligned(ctx.v12.f32)), simd::load_f32_aligned(ctx.v3.f32)));
	// vmaddfp v30,v8,v11,v1
	simd::store_f32_aligned(ctx.v30.f32, simd::add_f32(simd::mul_f32(simd::load_f32_aligned(ctx.v8.f32), simd::load_f32_aligned(ctx.v11.f32)), simd::load_f32_aligned(ctx.v1.f32)));
	// addi r11,r11,64
...
loc_82CD9124:
	...
	ctx.r10.s64 = ctx.r10.s64 + 16;
	// lvx128 v60,r0,r8
	ctx.v60 = simd::load_and_shuffle(base + ((ctx.r8.u32) & ~0xF), VectorMaskL);
	// vmulfp128 v59,v60,v0
	ctx.fpscr.enableFlushMode();
	simd::store_f32_aligned(ctx.v59.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v60.f32), simd::load_f32_aligned(ctx.v0.f32)));
	// vaddfp128 v0,v0,v63
	simd::store_f32_aligned(ctx.v0.f32, simd::add_f32(simd::load_f32_aligned(ctx.v0.f32), simd::load_f32_aligned(ctx.v63.f32)));
	// stvx128 v59,r0,r9
	ea = (ctx.r9.u32) & ~0xF;
...
loc_82CD91C0:
	...
	// vspltw128 v12,v58,0
	simd::store_i32(ctx.v12.u32, simd::permute_i32(simd::load_i32(ctx.v58.u32), 0xFF));
	// lvlx128 v56,r0,r9
	temp.u32 = ctx.r0.u32 + ctx.r9.u32;
	simd::store_shuffled(ctx.v56.u8, base + (temp.u32 & ~0xF), &VectorMaskL[(temp.u32 & 0xF) * 16]);
	// vspltw128 v55,v57,0
	simd::store_i32(ctx.v55.u32, simd::permute_i32(simd::load_i32(ctx.v57.u32), 0xFF));
	// vspltw128 v13,v56,0
	simd::store_i32(ctx.v13.u32, simd::permute_i32(simd::load_i32(ctx.v56.u32), 0xFF));
	// addi r5,r1,144
	ctx.r5.s64 = ctx.r1.s64 + 144;
