...
PPC_FUNC_IMPL(__imp__sub_82E7F890) {
	...
	// lwz r11,5012(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(5012) );
	// clrlwi. r9,r11,31
...
loc_82E80304:
	...
	// lwz r10,-720(r4)
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r4.u32 + int32_t(-720) );
	// lwz r10,16(r10)
...
PPC_FUNC_IMPL(__imp__sub_82E80678) {
	...
	ctx.r9.s64 = 0;
	// lwz r10,-720(r28)
	ctx.r10.u64 = PPC_LOAD_U32(r28.u32 + int32_t(-720) );
	// lwz r11,16(r10)
...
PPC_FUNC_IMPL(__imp__sub_82E80A70) {
	...
	PPC_STORE_U32(r31.u32 + 0, r11.u32);
	// lwz r11,-720(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + int32_t(-720) );
	// cmplwi r11,0
	cr0.compare<uint32_t>(r11.u32, 0, xer);
	// beq 0x82e80aac
...
loc_82E80AB4:
	...
	// lwz r3,-720(r3)
	ctx.r3.u64 = PPC_LOAD_U32(ctx.r3.u32 + int32_t(-720) );
	// bl 0x82e7baf0
...
PPC_FUNC_IMPL(__imp__sub_82E80FA8) {
	...
	ctx.r10.s64 = -2093744128;
	// lwz r11,6044(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(6044) );
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// lis r9,-31948
...
PPC_FUNC_IMPL(__imp__sub_82E814F8) {
	...
	// lwz r4,1024(r11)
	ctx.r4.u64 = PPC_LOAD_U32(r11.u32 + int32_t(1024) );
	// bl 0x82e81020
...
loc_82E81830:
	...
	// lwz r9,-720(r30)
	ctx.r9.u64 = PPC_LOAD_U32(r30.u32 + int32_t(-720) );
	// lwz r9,16(r9)
...
PPC_FUNC_IMPL(__imp__sub_82E82568) {
	...
	// lwz r31,1024(r10)
	r31.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(1024) );
	// bl 0x82e7d750
	sub_82E7D750(ctx, base);
	// cmplwi r3,0
	cr0.compare<uint32_t>(ctx.r3.u32, 0, xer);
...
PPC_FUNC_IMPL(__imp__sub_82E82F48) {
	...
	ctx.r10.s64 = -2093744128;
	// lwz r11,7908(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(7908) );
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// lis r9,-31948
...
loc_82E835F0:
	// lwz r11,100(r25)
	r11.u64 = PPC_LOAD_U32(r25.u32 + int32_t(100) );
	// mr r6,r24
	ctx.r6.u64 = r24.u64;
	// li r5,1024
	ctx.r5.s64 = 1024;
...
PPC_FUNC_IMPL(__imp__sub_82E83788) {
	...
	ctx.r1.u32 = ea;
	// lwz r30,8(r4)
	r30.u64 = PPC_LOAD_U32(ctx.r4.u32 + int32_t(8) );
	// cmplwi r30,0
	cr0.compare<uint32_t>(r30.u32, 0, xer);
	// beq 0x82e83804
...
PPC_FUNC_IMPL(__imp__sub_82E85E08) {
	...
	ctx.r10.s64 = -2093744128;
	// lwz r11,10324(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(10324) );
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// lis r9,-31948
...
loc_82E8619C:
	...
	// lwz r8,132(r8)
	ctx.r8.u64 = PPC_LOAD_U32(ctx.r8.u32 + int32_t(132) );
	// cmplw cr6,r8,r4
...
PPC_FUNC_IMPL(__imp__sub_82E86CC0) {
	...
	PPC_STORE_U32(r31.u32 + 0, r11.u32);
	// lwz r11,-9868(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(-9868) );
	// mtctr r11
	ctr.u64 = r11.u64;
	// bctrl 
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
...
PPC_FUNC_IMPL(__imp__sub_82E87420) {
	...
	ctx.r10.s64 = -2093744128;
	// lwz r11,11356(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(11356) );
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// lis r9,-31948
...
loc_82E875B4:
	...
	r11.s64 = -2093744128;
	// lwz r31,-720(r11)
	r31.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-720) );
	// bl 0x82ca5860
	sub_82CA5860(ctx, base);
	// lfs f0,12(r31)
	ctx.fpscr.disableFlushMode();
...
loc_82E876DC:
	// lwz r11,268(r28)
	r11.u64 = PPC_LOAD_U32(r28.u32 + int32_t(268) );
	// addi r11,r11,35
	r11.s64 = r11.s64 + 35;
	// rlwinm r11,r11,2,0,29
	r11.u64 = rotl64(r11.u32 | (r11.u64 << 32), 2) & 0xFFFFFFFC;
...
loc_82E885CC:
	...
	ctx.r10.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(0) );
	// lwz r9,-720(r31)
	ctx.r9.u64 = PPC_LOAD_U32(r31.u32 + int32_t(-720) );
	// rlwinm r10,r10,2,0,29
	ctx.r10.u64 = rotl64(ctx.r10.u32 | (ctx.r10.u64 << 32), 2) & 0xFFFFFFFC;
	// cmplwi r9,0
	cr0.compare<uint32_t>(ctx.r9.u32, 0, xer);
...
PPC_FUNC_IMPL(__imp__sub_82E88740) {
	...
	r27.u64 = ctx.r6.u64;
	// lwz r11,19668(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(19668) );
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// lis r9,-31948
...
PPC_FUNC_IMPL(__imp__sub_82E88C00) {
	...
	ctx.r10.u64 = ctx.r3.u64;
	// lwz r11,328(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(328) );
	// cmplwi cr6,r11,20
...
PPC_FUNC_IMPL(__imp__sub_82E88C50) {
	...
	r11.u64 = ctx.r3.u64;
	// lwz r10,332(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + int32_t(332) );
	// cmplwi cr6,r10,20
...
PPC_FUNC_IMPL(__imp__sub_82E89180) {
	...
	// lwz r9,332(r30)
	ctx.r9.u64 = PPC_LOAD_U32(r30.u32 + int32_t(332) );
	// mulli r11,r11,20
	r11.s64 = r11.s64 * 20;
	// add r11,r11,r10
	r11.u64 = r11.u64 + ctx.r10.u64;
...
loc_82E89268:
	// lwz r11,332(r30)
	r11.u64 = PPC_LOAD_U32(r30.u32 + int32_t(332) );
	// addi r29,r29,1
	r29.s64 = r29.s64 + 1;
	// addi r28,r28,4
	r28.s64 = r28.s64 + 4;
...
PPC_FUNC_IMPL(__imp__sub_82E897E8) {
	...
	ctx.r9.s64 = 0;
	// lwz r8,328(r30)
	ctx.r8.u64 = PPC_LOAD_U32(r30.u32 + int32_t(328) );
	// rlwinm r10,r10,2,0,29
	ctx.r10.u64 = rotl64(ctx.r10.u32 | (ctx.r10.u64 << 32), 2) & 0xFFFFFFFC;
	// cmplwi cr6,r8,0
...
loc_82E8989C:
	...
	ctx.r10.u64 = rotl64(ctx.r10.u32 | (ctx.r10.u64 << 32), 2) & 0xFFFFFFFC;
	// lwz r27,60(r11)
	r27.u64 = PPC_LOAD_U32(r11.u32 + int32_t(60) );
	// lwz r26,56(r11)
	r26.u64 = PPC_LOAD_U32(r11.u32 + int32_t(56) );
	// lwz r5,24(r11)
...
loc_82E89920:
	...
	// lwz r26,60(r11)
	r26.u64 = PPC_LOAD_U32(r11.u32 + int32_t(60) );
	// lwz r25,56(r11)
	r25.u64 = PPC_LOAD_U32(r11.u32 + int32_t(56) );
	// lwz r27,24(r11)
...
loc_82E89A78:
	// lwz r11,332(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + int32_t(332) );
	// li r31,0
	r31.s64 = 0;
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
...
PPC_FUNC_IMPL(__imp__sub_82E89BD0) {
	...
	ctx.r10.s64 = -2093744128;
	// lwz r11,20700(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(20700) );
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// lis r9,-31948
...
loc_82E89F8C:
	...
	// lwz r29,132(r11)
	r29.u64 = PPC_LOAD_U32(r11.u32 + int32_t(132) );
	// mr r4,r29
	ctx.r4.u64 = r29.u64;
	// mtctr r10
	ctr.u64 = ctx.r10.u64;
...
loc_82E89FFC:
	// lwz r30,112(r27)
	r30.u64 = PPC_LOAD_U32(r27.u32 + int32_t(112) );
	// mr r3,r31
	ctx.r3.u64 = r31.u64;
	// lwz r11,0(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + int32_t(0) );
...
PPC_FUNC_IMPL(__imp__sub_82E8A0E8) {
	...
	// lwz r11,80(r9)
	r11.u64 = PPC_LOAD_U32(ctx.r9.u32 + int32_t(80) );
	// cmplwi r11,0
	cr0.compare<uint32_t>(r11.u32, 0, xer);
	// beq 0x82e8a164
...
loc_82E8A610:
	// lwz r9,116(r11)
	ctx.r9.u64 = PPC_LOAD_U32(r11.u32 + int32_t(116) );
	// li r8,0
	ctx.r8.s64 = 0;
	// li r10,0
	ctx.r10.s64 = 0;
...
loc_82E8A804:
	...
	if (!cr6.eq) goto loc_82E8A880;
	// lwz r31,60(r11)
	r31.u64 = PPC_LOAD_U32(r11.u32 + int32_t(60) );
	// rotlwi r11,r30,0
...
PPC_FUNC_IMPL(__imp__sub_82E8A898) {
	...
	r30.u64 = r20.u64;
	// lwz r11,-9264(r29)
	r11.u64 = PPC_LOAD_U32(r29.u32 + int32_t(-9264) );
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82e8aa00
	if (cr6.eq) goto loc_82E8AA00;
...
loc_82E8B26C:
	// lwz r11,56(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + int32_t(56) );
	// addi r9,r9,1
	ctx.r9.s64 = ctx.r9.s64 + 1;
	// add r8,r11,r10
...
PPC_FUNC_IMPL(__imp__sub_82E8B748) {
	...
	// lwz r9,-9264(r9)
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r9.u32 + int32_t(-9264) );
	// cmplwi cr6,r9,0
	cr6.compare<uint32_t>(ctx.r9.u32, 0, xer);
	// beq cr6,0x82e8b7e4
...
loc_82E8C6D8:
	...
	// lwz r5,56(r10)
	ctx.r5.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(56) );
	// lwz r7,24(r10)
