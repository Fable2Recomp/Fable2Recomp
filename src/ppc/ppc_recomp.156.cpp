...
PPC_FUNC_IMPL(__imp__sub_82E83370) {
	...
	f29.f64 = double(float(ctx.f12.f64 * ctx.f12.f64 + ctx.f11.f64));
	// blt cr6,0x82e833d4
...
loc_82E833D4:
	...
	f30.f64 = double(float(ctx.f10.f64 * f0.f64 + ctx.f13.f64));
	// bl 0x82e7f4a0
...
PPC_FUNC_IMPL(__imp__sub_82E88C88) {
	...
	// fsubs f31,f7,f6
	f31.f64 = double(float(ctx.f7.f64 - ctx.f6.f64));
	// lfs f1,3080(r11)
	temp.u32 = PPC_LOAD_U32(r11.u32 + 3080);
	ctx.f1.f64 = double(temp.f32);
	// lfs f3,8(r8)
...
loc_82E88CF8:
	...
	f0.f64 = double(float(ctx.f13.f64 * f0.f64));
	// fmadds f1,f0,f12,f1
	ctx.f1.f64 = double(float(f0.f64 * ctx.f12.f64 + ctx.f1.f64));
loc_82E88D58:
	// lfd f31,-8(r1)
	ctx.fpscr.disableFlushMode();
