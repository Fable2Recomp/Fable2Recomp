...
PPC_FUNC_IMPL(__imp__sub_8232E490) {
	...
	// vperm v5,v6,v7,v0
	simde_mm_store_si128((simde__m128i*)ctx.v5.u8, simde_mm_perm_epi8_(simde_mm_load_si128((simde__m128i*)ctx.v6.u8), simde_mm_load_si128((simde__m128i*)ctx.v7.u8), simde_mm_load_si128((simde__m128i*)ctx.v0.u8)));
	// fmuls f13,f9,f0
	...
	// fsqrts f11,f3
	ctx.f11.f64 = double(simde_math_sqrtf(float(ctx.f3.f64)));
	// bgt cr6,0x8232e6dc
