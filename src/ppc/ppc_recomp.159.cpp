...
PPC_FUNC_IMPL(__imp__sub_82EB4FB8) {
	...
	// lwz r11,-14876(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + -14876);
	// clrlwi. r9,r11,31
...
PPC_FUNC_IMPL(__imp__sub_82EB5030) {
	...
	ctx.r10.s64 = -2093678592;
	// lwz r11,-13844(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + -13844);
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// lis r9,-31947
...
loc_82EB6058:
	// lwz r11,440(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 440);
	// mr r4,r27
	ctx.r4.u64 = r27.u64;
	// lwzx r11,r11,r31
...
loc_82EB6160:
	...
	// lwz r11,468(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 468);
	// li r30,0
	r30.s64 = 0;
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
...
loc_82EB618C:
	// lwz r11,460(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 460);
	// mr r4,r27
	ctx.r4.u64 = r27.u64;
	// lwzx r11,r31,r11
	r11.u64 = PPC_LOAD_U32(r31.u32 + r11.u32);
...
loc_82EB61D0:
	// lwz r11,472(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 472);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82eb5854
	if (!cr6.eq) goto loc_82EB5854;
...
loc_82EB62C0:
	// lwz r11,540(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 540);
	// mr r4,r27
	ctx.r4.u64 = r27.u64;
	// lwzx r11,r11,r31
	r11.u64 = PPC_LOAD_U32(r11.u32 + r31.u32);
...
loc_82EB63C8:
	...
	// lwz r11,488(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 488);
	// li r30,0
	r30.s64 = 0;
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
...
loc_82EB63F4:
	// lwz r11,480(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 480);
	// mr r4,r27
	ctx.r4.u64 = r27.u64;
	// lwzx r11,r31,r11
	r11.u64 = PPC_LOAD_U32(r31.u32 + r11.u32);
...
loc_82EB6438:
	// lwz r11,492(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 492);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82eb5854
	if (!cr6.eq) goto loc_82EB5854;
...
loc_82EB6528:
	// lwz r11,500(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 500);
	// mr r4,r27
	ctx.r4.u64 = r27.u64;
	// lwzx r11,r11,r31
	r11.u64 = PPC_LOAD_U32(r11.u32 + r31.u32);
...
loc_82EB656C:
	// lwz r11,512(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 512);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82eb5854
	if (!cr6.eq) goto loc_82EB5854;
...
loc_82EB6898:
	...
	// lwz r11,588(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 588);
	// li r30,0
	r30.s64 = 0;
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
...
loc_82EB68C4:
	// lwz r11,580(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 580);
	// mr r4,r27
	ctx.r4.u64 = r27.u64;
	// lwzx r11,r31,r11
	r11.u64 = PPC_LOAD_U32(r31.u32 + r11.u32);
...
loc_82EB69CC:
	...
	// lwz r11,608(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 608);
	// li r30,0
	r30.s64 = 0;
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
...
loc_82EB6B00:
	...
	// lwz r11,628(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 628);
	// li r30,0
	r30.s64 = 0;
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
...
loc_82EB6B2C:
	// lwz r11,620(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 620);
	// mr r4,r27
	ctx.r4.u64 = r27.u64;
	// lwzx r11,r31,r11
	r11.u64 = PPC_LOAD_U32(r31.u32 + r11.u32);
...
loc_82EB6B70:
	// lwz r11,632(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + 632);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82eb5854
	if (!cr6.eq) goto loc_82EB5854;
...
PPC_FUNC_IMPL(__imp__sub_82EB7F40) {
	...
	// lwz r3,612(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + 612);
	// lwz r11,4(r11)
...
loc_82EB93C8:
	...
	ctx.r8.u64 = r25.u64;
	// lwz r29,592(r11)
	r29.u64 = PPC_LOAD_U32(r11.u32 + 592);
	// li r10,16
	ctx.r10.s64 = 16;
	// lwz r30,20(r7)
	r30.u64 = PPC_LOAD_U32(ctx.r7.u32 + 20);
	// stfs f30,84(r1)
	ctx.fpscr.disableFlushMode();
	temp.f32 = float(f30.f64);
	PPC_STORE_U32(ctx.r1.u32 + 84, temp.u32);
...
PPC_FUNC_IMPL(__imp__sub_82EBA4A0) {
	...
	ctx.r4.u64 = ctx.r5.u64;
	// lwz r11,-11616(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + -11616);
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// lis r9,-31947
...
PPC_FUNC_IMPL(__imp__sub_82EBA758) {
	...
	// lwz r20,72(r11)
	r20.u64 = PPC_LOAD_U32(r11.u32 + 72);
	// cmplwi r20,0
...
PPC_FUNC_IMPL(__imp__sub_82EBB5E0) {
	...
	ctx.r5.u64 = r27.u64;
	// lwz r31,592(r11)
	r31.u64 = PPC_LOAD_U32(r11.u32 + 592);
	// mr r7,r30
	ctx.r7.u64 = r30.u64;
	// lwz r11,4(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 4);
...
PPC_FUNC_IMPL(__imp__sub_82EBB6F8) {
	...
	// lwz r3,552(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + 552);
	// lwz r11,4(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 4);
	// lwz r10,0(r3)
...
loc_82EBBF2C:
	...
	r11.u64 = PPC_LOAD_U32(r30.u32 + 4);
	// lwz r3,572(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + 572);
	// lwz r11,0(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 0);
	// lwz r11,16(r11)
...
PPC_FUNC_IMPL(__imp__sub_82EBC668) {
	...
	r11.u64 = PPC_LOAD_U32(r25.u32 + 4);
	// lwz r23,72(r11)
	r23.u64 = PPC_LOAD_U32(r11.u32 + 72);
	// cmplwi r23,0
...
loc_82EBDA74:
	...
	// lwz r5,928(r31)
	ctx.r5.u64 = PPC_LOAD_U32(r31.u32 + 928);
	// lwz r11,68(r10)
...
loc_82EBDAFC:
	...
	ctx.r10.u64 = PPC_LOAD_U32(r31.u32 + 84);
	// lwz r11,444(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 444);
	// lwz r10,440(r10)
...
loc_82EBDBA8:
	...
	ctx.r10.u64 = PPC_LOAD_U32(r31.u32 + 84);
	// lwz r11,440(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 440);
	// lwz r10,444(r10)
...
PPC_FUNC_IMPL(__imp__sub_82EBDD00) {
	...
	// lwz r11,924(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 924);
	// lwz r9,444(r3)
...
PPC_FUNC_IMPL(__imp__sub_82EBDD90) {
	...
	ctx.r4.s64 = 1;
	// lwz r10,-8024(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + -8024);
	// lwz r3,28(r30)
...
loc_82EBDF18:
	...
	sub_82260978(ctx, base);
	// lwz r4,1044(r31)
	ctx.r4.u64 = PPC_LOAD_U32(r31.u32 + 1044);
	// mr r30,r3
	r30.u64 = ctx.r3.u64;
	// cmpwi cr6,r4,-1
...
loc_82EBE2C4:
	...
	ctx.r5.u64 = r30.u64;
	// lwz r9,928(r31)
	ctx.r9.u64 = PPC_LOAD_U32(r31.u32 + 928);
	// lwz r10,0(r11)
...
loc_82EBE450:
	...
	ctx.r4.s64 = 0;
	// lwz r30,912(r31)
	r30.u64 = PPC_LOAD_U32(r31.u32 + 912);
	// mr r3,r31
	ctx.r3.u64 = r31.u64;
	// lwz r11,112(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 112);
...
loc_82EBE538:
	...
	// lwz r27,924(r31)
	r27.u64 = PPC_LOAD_U32(r31.u32 + 924);
	// lwz r23,928(r31)
	r23.u64 = PPC_LOAD_U32(r31.u32 + 928);
	// lwz r4,84(r31)
...
loc_82EBEA4C:
	...
	ctx.r10.s64 = -1;
	// lwz r9,444(r11)
	ctx.r9.u64 = PPC_LOAD_U32(r11.u32 + 444);
	// stw r10,928(r31)
...
PPC_FUNC_IMPL(__imp__sub_82EC0488) {
	...
	// lwz r29,172(r29)
	r29.u64 = PPC_LOAD_U32(r29.u32 + 172);
	// bl 0x82625f08
	sub_82625F08(ctx, base);
	// cmplwi r3,0
	cr0.compare<uint32_t>(ctx.r3.u32, 0, xer);
...
loc_82EC0E3C:
	...
	r24.s64 = 0;
	// lwz r23,164(r11)
	r23.u64 = PPC_LOAD_U32(r11.u32 + 164);
loc_82EC0E48:
	// li r25,0
	r25.s64 = 0;
loc_82EC0E4C:
...
loc_82EC12B4:
	...
	// lwz r6,100(r22)
	ctx.r6.u64 = PPC_LOAD_U32(r22.u32 + 100);
	// cmplw cr6,r11,r6
...
loc_82EC12E8:
	...
	r11.u64 = PPC_LOAD_U32(r31.u32 + 8);
	// lwz r9,100(r22)
	ctx.r9.u64 = PPC_LOAD_U32(r22.u32 + 100);
	// lwz r8,108(r22)
	ctx.r8.u64 = PPC_LOAD_U32(r22.u32 + 108);
	// lwz r11,8(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 8);
	// lwz r9,8(r9)
...
loc_82EC18D8:
	...
	ctx.r4.u64 = r31.u64;
	// lwz r3,216(r25)
	ctx.r3.u64 = PPC_LOAD_U32(r25.u32 + 216);
	// li r31,1
	r31.s64 = 1;
	// li r8,0
	ctx.r8.s64 = 0;
...
PPC_FUNC_IMPL(__imp__sub_82EC1F20) {
	...
	// lwz r22,48(r31)
	r22.u64 = PPC_LOAD_U32(r31.u32 + 48);
	// lis r24,-31948
	r24.s64 = -2093744128;
loc_82EC1F88:
	// lwz r11,56(r31)
...
loc_82EC1F98:
	...
	// lwz r11,-720(r24)
	r11.u64 = PPC_LOAD_U32(r24.u32 + -720);
	// lwz r10,12(r31)
	ctx.r10.u64 = PPC_LOAD_U32(r31.u32 + 12);
	// lwz r11,16(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 16);
...
PPC_FUNC_IMPL(__imp__sub_82EC2260) {
	...
	ctx.r10.s64 = -2093744128;
	// lwz r11,-720(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + -720);
	// cmplwi r11,0
	cr0.compare<uint32_t>(r11.u32, 0, xer);
	// beq 0x82ec22b8
...
loc_82EC24E8:
	...
	r11.s64 = -2098462720;
	// lwz r3,-720(r28)
	ctx.r3.u64 = PPC_LOAD_U32(r28.u32 + -720);
	// mr r5,r30
	ctx.r5.u64 = r30.u64;
	// addi r4,r11,7952
