...
PPC_FUNC_IMPL(__imp__sub_832ABA20) {
	...
	r30.s64 = -2092302336;
	// lwz r31,-2744(r30)
	r31.u64 = PPC_LOAD_U32(r30.u32 + int32_t(-2744) );
	// cmplwi cr6,r31,0
...
PPC_FUNC_IMPL(__imp__sub_832ABD18) {
	...
	r31.s64 = -2092302336;
	// lwz r3,-2740(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(-2740) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832abd4c
...
PPC_FUNC_IMPL(__imp__sub_832ABDC0) {
	...
	r30.s64 = -2092302336;
	// lwz r31,-2368(r30)
	r31.u64 = PPC_LOAD_U32(r30.u32 + int32_t(-2368) );
	// cmplwi cr6,r31,0
	cr6.compare<uint32_t>(r31.u32, 0, xer);
	// beq cr6,0x832abe1c
...
PPC_FUNC_IMPL(__imp__sub_832ABEC8) {
	...
	r30.s64 = -2092302336;
	// lwz r31,-2360(r30)
	r31.u64 = PPC_LOAD_U32(r30.u32 + int32_t(-2360) );
	// cmplwi cr6,r31,0
	cr6.compare<uint32_t>(r31.u32, 0, xer);
	// beq cr6,0x832abf24
...
PPC_FUNC_IMPL(__imp__sub_832AC3E8) {
	...
	r31.s64 = -2092302336;
	// lwz r3,-2076(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(-2076) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832ac41c
...
PPC_FUNC_IMPL(__imp__sub_832AC438) {
	...
	r28.s64 = -2092302336;
	// lwz r29,-2072(r28)
	r29.u64 = PPC_LOAD_U32(r28.u32 + int32_t(-2072) );
	// cmplwi cr6,r29,0
...
PPC_FUNC_IMPL(__imp__sub_832AC488) {
	...
	r11.s64 = -2092302336;
	// lwz r3,-2068(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-2068) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832AC6E0) {
	...
	r11.s64 = -2092302336;
	// lwz r3,-1920(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-1920) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832AC7B0) {
	...
	r31.s64 = -2092302336;
	// lwz r3,2960(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(2960) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832ac7dc
...
PPC_FUNC_IMPL(__imp__sub_832AC7F0) {
	...
	r31.s64 = -2093875200;
	// lwz r3,-22072(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(-22072) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832ac81c
...
PPC_FUNC_IMPL(__imp__sub_832AC830) {
	...
	r11.s64 = -2092302336;
	// lwz r3,-1880(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-1880) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832AC848) {
	...
	r11.s64 = -2092302336;
	// lwz r3,-1860(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-1860) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832ACC20) {
	...
	r31.s64 = -2092302336;
	// lwz r3,3516(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(3516) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832acc80
...
PPC_FUNC_IMPL(__imp__sub_832ACC98) {
	...
	r31.s64 = -2092302336;
	// lwz r3,3520(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(3520) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832accf8
...
PPC_FUNC_IMPL(__imp__sub_832ACD10) {
	...
	r31.s64 = -2092302336;
	// lwz r3,3524(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(3524) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832acd70
...
PPC_FUNC_IMPL(__imp__sub_832ACD88) {
	...
	r31.s64 = -2092302336;
	// lwz r3,3528(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(3528) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832acde8
...
PPC_FUNC_IMPL(__imp__sub_832ACE00) {
	...
	r31.s64 = -2092302336;
	// lwz r3,3532(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(3532) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832ace60
...
PPC_FUNC_IMPL(__imp__sub_832ACE78) {
	...
	r31.s64 = -2092302336;
	// lwz r3,3536(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(3536) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832aced8
...
PPC_FUNC_IMPL(__imp__sub_832ACEF0) {
	...
	r31.s64 = -2092302336;
	// lwz r3,3540(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(3540) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832acf50
...
PPC_FUNC_IMPL(__imp__sub_832ACF68) {
	...
	r31.s64 = -2092302336;
	// lwz r3,3544(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(3544) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832acfc8
...
PPC_FUNC_IMPL(__imp__sub_832ACFE0) {
	...
	r31.s64 = -2092302336;
	// lwz r3,3548(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(3548) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832ad040
...
PPC_FUNC_IMPL(__imp__sub_832AD068) {
	...
	r31.s64 = -2092302336;
	// lwz r3,3552(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(3552) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832ad0c8
...
PPC_FUNC_IMPL(__imp__sub_832AD120) {
	...
	r11.s64 = -2092302336;
	// lwz r3,3600(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(3600) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832AD138) {
	...
	r11.s64 = -2092302336;
	// lwz r3,3620(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(3620) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832AD150) {
	...
	r11.s64 = -2092302336;
	// lwz r3,3640(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(3640) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832AD1F8) {
	...
	r11.s64 = -2092302336;
	// lwz r3,3768(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(3768) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832AD288) {
	...
	r11.s64 = -2092302336;
	// lwz r3,3836(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(3836) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832AD2C0) {
	...
	r11.s64 = -2092302336;
	// lwz r3,3944(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(3944) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832AD5A8) {
	...
	r31.s64 = -2092302336;
	// lwz r3,16680(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(16680) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832ad608
...
PPC_FUNC_IMPL(__imp__sub_832AD640) {
	...
	r11.s64 = -2092302336;
	// lwz r3,16692(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(16692) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832AD6E8) {
	...
	r11.s64 = -2092302336;
	// lwz r3,16756(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(16756) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832AD700) {
	...
	r11.s64 = -2092302336;
	// lwz r3,16776(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(16776) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832AD7F8) {
	...
	r31.s64 = -2092302336;
	// lwz r3,19088(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(19088) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832ad858
...
PPC_FUNC_IMPL(__imp__sub_832AD988) {
	...
	r11.s64 = -2092302336;
	// lwz r3,19312(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(19312) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832AD9A0) {
	...
	r11.s64 = -2092302336;
	// lwz r3,19332(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(19332) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832ADD18) {
	...
	r31.s64 = -2092302336;
	// lwz r3,19648(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(19648) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832add44
...
PPC_FUNC_IMPL(__imp__sub_832ADD58) {
	...
	r31.s64 = -2093875200;
	// lwz r3,-21616(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(-21616) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832add84
...
PPC_FUNC_IMPL(__imp__sub_832ADD98) {
	...
	r31.s64 = -2092302336;
	// lwz r3,19660(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(19660) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832addc4
...
PPC_FUNC_IMPL(__imp__sub_832ADDD8) {
	...
	r31.s64 = -2093875200;
	// lwz r3,-21604(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(-21604) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832ade04
...
PPC_FUNC_IMPL(__imp__sub_832ADE18) {
	...
	r31.s64 = -2092302336;
	// lwz r3,19672(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(19672) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832ade44
...
PPC_FUNC_IMPL(__imp__sub_832ADE58) {
	...
	r11.s64 = -2092302336;
	// lwz r3,19684(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(19684) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
