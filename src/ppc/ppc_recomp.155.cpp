...
loc_82E74C04:
	...
	f31.f64 = double(float(ctx.f12.f64 * ctx.f12.f64 + f0.f64));
	// fcmpu cr6,f31,f30
...
PPC_FUNC_IMPL(__imp__sub_82E74D58) {
	...
	// lwz r11,-8812(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + -8812);
	// clrlwi. r9,r11,31
...
loc_82E7606C:
	...
	// lwz r11,-9936(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + -9936);
loc_82E76090:
	// lbz r9,0(r11)
	ctx.r9.u64 = PPC_LOAD_U8(r11.u32 + 0);
	// addi r11,r11,1
...
PPC_FUNC_IMPL(__imp__sub_82E760B0) {
	...
	r11.s64 = -2094006272;
	// lwz r11,-9932(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + -9932);
loc_82E760D0:
	// lbz r8,0(r11)
...
loc_82E765E4:
	...
	f31.f64 = double(temp.f32);
	// lwz r11,-9956(r19)
	r11.u64 = PPC_LOAD_U32(r19.u32 + -9956);
	// stfs f31,116(r1)
	temp.f32 = float(f31.f64);
...
loc_82E76610:
	...
	// lwz r11,-9936(r17)
	r11.u64 = PPC_LOAD_U32(r17.u32 + -9936);
	// subf r9,r11,r10
	ctx.r9.s64 = ctx.r10.s64 - r11.s64;
loc_82E76634:
	// lbz r10,0(r11)
...
loc_82E769B8:
	...
	r11.u64 = r11.u64 | ctx.r10.u64;
	// lwz r10,-9956(r19)
	ctx.r10.u64 = PPC_LOAD_U32(r19.u32 + -9956);
	// mr r3,r9
...
loc_82E76B30:
	...
	// lwz r11,-9952(r25)
	r11.u64 = PPC_LOAD_U32(r25.u32 + -9952);
	// addi r10,r1,128
	ctx.r10.s64 = ctx.r1.s64 + 128;
	// subf r9,r11,r10
	ctx.r9.s64 = ctx.r10.s64 - r11.s64;
...
loc_82E76B7C:
	...
	// lwz r11,-9948(r24)
	r11.u64 = PPC_LOAD_U32(r24.u32 + -9948);
	// addi r10,r1,128
	ctx.r10.s64 = ctx.r1.s64 + 128;
	// subf r9,r11,r10
	ctx.r9.s64 = ctx.r10.s64 - r11.s64;
...
loc_82E76BA8:
	...
	// lwz r11,-9944(r23)
	r11.u64 = PPC_LOAD_U32(r23.u32 + -9944);
	// addi r10,r1,128
	ctx.r10.s64 = ctx.r1.s64 + 128;
	// subf r9,r11,r10
	ctx.r9.s64 = ctx.r10.s64 - r11.s64;
...
loc_82E76BD4:
	...
	// lwz r11,-9940(r22)
	r11.u64 = PPC_LOAD_U32(r22.u32 + -9940);
	// addi r10,r1,128
	ctx.r10.s64 = ctx.r1.s64 + 128;
	// subf r9,r11,r10
	ctx.r9.s64 = ctx.r10.s64 - r11.s64;
...
PPC_FUNC_IMPL(__imp__sub_82E77188) {
	...
	ctx.r10.s64 = -2093744128;
	// lwz r11,-5916(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + -5916);
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// lis r9,-31948
...
PPC_FUNC_IMPL(__imp__sub_82E77A58) {
	...
	ctx.r10.s64 = -2093744128;
	// lwz r11,-4884(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + -4884);
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// lis r9,-31948
...
PPC_FUNC_IMPL(__imp__sub_82E77AD0) {
	...
	ctx.r10.s64 = -2093744128;
	// lwz r11,-3852(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + -3852);
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// lis r9,-31948
...
PPC_FUNC_IMPL(__imp__sub_82E77C88) {
	...
	ctx.r10.s64 = -2093744128;
	// lwz r11,-2820(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + -2820);
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// lis r9,-31948
...
PPC_FUNC_IMPL(__imp__sub_82E788B8) {
	...
	ctx.r10.s64 = -2093744128;
	// lwz r11,-1788(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + -1788);
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// lis r9,-31948
...
PPC_FUNC_IMPL(__imp__sub_82E78930) {
	...
	ctx.r10.s64 = -2093744128;
	// lwz r11,-756(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + -756);
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// lis r9,-31948
...
PPC_FUNC_IMPL(__imp__sub_82E78F00) {
	...
	ctx.r4.u64 = r31.u64;
	// lwz r3,-740(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + -740);
	// lwz r11,0(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 0);
	// lwz r11,4(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 4);
...
PPC_FUNC_IMPL(__imp__sub_82E7B5F8) {
	...
	ctx.r3.u64 = r31.u64;
	// lwz r30,-720(r11)
	r30.u64 = PPC_LOAD_U32(r11.u32 + -720);
	// bl 0x82e83a00
	sub_82E83A00(ctx, base);
	// lwz r11,24(r30)
	r11.u64 = PPC_LOAD_U32(r30.u32 + 24);
...
PPC_FUNC_IMPL(__imp__sub_82E7B698) {
	...
	ctx.r3.u64 = r28.u64;
	// lwz r29,-720(r11)
	r29.u64 = PPC_LOAD_U32(r11.u32 + -720);
	// bl 0x82e83a00
	sub_82E83A00(ctx, base);
	// lwz r11,24(r29)
...
loc_82E7C14C:
	...
	r11.s64 = -2093744128;
	// lwz r11,-748(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + -748);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82e7c198
...
PPC_FUNC_IMPL(__imp__sub_82E7C3A0) {
	...
	ctx.r10.s64 = -2093744128;
	// lwz r11,588(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 588);
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// lis r9,-31948
...
PPC_FUNC_IMPL(__imp__sub_82E7C4B8) {
	...
	ctx.r10.s64 = -2093744128;
	// lwz r11,1620(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 1620);
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// lis r9,-31948
...
PPC_FUNC_IMPL(__imp__sub_82E7CA00) {
	...
	// lwz r11,-9692(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + -9692);
	// rlwinm. r9,r11,0,0,0
...
loc_82E7CEDC:
	...
	// lwz r3,-748(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + -748);
	// bl 0x82e79110
	sub_82E79110(ctx, base);
	// lwz r11,0(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + 0);
...
PPC_FUNC_IMPL(__imp__sub_82E7CF20) {
	...
	ctx.r10.s64 = -2093744128;
	// lwz r11,2652(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 2652);
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// lis r9,-31948
...
loc_82E7D2E4:
	...
	ctx.r4.u64 = r28.u64;
	// lwz r29,-720(r30)
	r29.u64 = PPC_LOAD_U32(r30.u32 + -720);
	// stw r31,-720(r30)
...
loc_82E7D34C:
	...
	r11.s64 = -2113667072;
	// lwz r4,-752(r27)
	ctx.r4.u64 = PPC_LOAD_U32(r27.u32 + -752);
	// addi r6,r1,88
...
loc_82E7D3B8:
	...
	r26.s64 = -2093744128;
	// lwz r11,-748(r26)
	r11.u64 = PPC_LOAD_U32(r26.u32 + -748);
	// lwz r10,20(r11)
...
loc_82E7D654:
	...
	r11.s64 = -2113077248;
	// lwz r4,-748(r26)
	ctx.r4.u64 = PPC_LOAD_U32(r26.u32 + -748);
	// addi r6,r1,88
	ctx.r6.s64 = ctx.r1.s64 + 88;
	// stw r28,92(r1)
...
loc_82E7DCEC:
	...
	r30.u64 = __builtin_rotateleft64(r27.u32 | (r27.u64 << 32), 2) & 0xFFFFFFFC;
	// lwz r10,-9868(r26)
	ctx.r10.u64 = PPC_LOAD_U32(r26.u32 + -9868);
	// lwzx r3,r11,r30
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + r30.u32);
	// mtctr r10
	ctr.u64 = ctx.r10.u64;
...
loc_82E7DEC8:
	...
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + 24);
	// lwz r11,-9868(r27)
	r11.u64 = PPC_LOAD_U32(r27.u32 + -9868);
	// mtctr r11
	ctr.u64 = r11.u64;
	// bctrl 
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
