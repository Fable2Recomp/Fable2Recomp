...
loc_82D548E4:
	...
	simd::store_f32(ctx.v12.f32, simd::blend_f32(simd::load_f32(ctx.v12.f32), simd::permute_f32(simd::load_f32(ctx.v0.f32), 228), 4));
	// vrlimi128 v12,v11,2,0
	simd::store_f32(ctx.v12.f32, simd::blend_f32(simd::load_f32(ctx.v12.f32), simd::permute_f32(simd::load_f32(ctx.v11.f32), 228), 2));
	// vrlimi128 v12,v10,1,0
	simd::store_f32(ctx.v12.f32, simd::blend_f32(simd::load_f32(ctx.v12.f32), simd::permute_f32(simd::load_f32(ctx.v10.f32), 228), 1));
	// vrsqrtefp v0,v12
	ctx.v0.v128 = simd::rsqrt_f32(ctx.v12.v128);
	...
	// vspltw v11,v0,2
	simd::store_i32(ctx.v11.u32, simd::permute_i32(simd::load_i32(ctx.v0.u32), 0x55));
	// vspltw v0,v0,3
...
PPC_FUNC_IMPL(__imp__sub_82D549E8) {
	...
	// lvx128 v0,r30,r9
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r30.u32 + ctx.r9.u32) & ~0xF), VectorMaskL);
	// lfs f0,3080(r10)
	ctx.fpscr.disableFlushMode();
	temp.u32 = PPC_LOAD_U32(ctx.r10.u32 + 3080);
	ctx.f0.f64 = double(temp.f32);
...
PPC_FUNC_IMPL(__imp__sub_82D54B00) {
	...
	// lvx128 v12,r10,r11
	ctx.v12 = simd::load_and_shuffle(base + ((ctx.r10.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// addi r11,r1,-32
...
loc_82D54B68:
	...
	PPC_STORE_U32(ctx.r1.u32 + -32, temp.u32);
	// lvx128 v10,r4,r11
	ctx.v10 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// lvx128 v11,r5,r11
	ctx.v11 = simd::load_and_shuffle(base + ((ctx.r5.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// addi r11,r1,-32
	ctx.r11.s64 = ctx.r1.s64 + -32;
	// vsubfp v11,v10,v11
	ctx.fpscr.enableFlushModeUnconditional();
	...
	ctx.cr6.setFromMask(simd::load_f32_aligned(ctx.v12.f32), 0xF);
	// mfocrf r11,2
	ctx.r11.u64 = (ctx.cr6.lt << 7) | (ctx.cr6.gt << 6) | (ctx.cr6.eq << 5) | (ctx.cr6.so << 4);
	// rlwinm r11,r11,0,24,24
	ctx.r11.u64 = __builtin_rotateleft64(ctx.r11.u32 | (ctx.r11.u64 << 32), 0) & 0x80;
	...
	ctx.r9.s64 = ctx.r1.s64 + -32;
	// lvx128 v11,r4,r11
	ctx.v11 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// lvx128 v10,r5,r11
...
PPC_FUNC_IMPL(__imp__sub_82D54C38) {
	...
	simd::store_f32_aligned(ctx.v13.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v13.f32), simd::load_f32_aligned(ctx.v11.f32)));
	// vspltw v6,v6,0
	simd::store_i32(ctx.v6.u32, simd::permute_i32(simd::load_i32(ctx.v6.u32), 0xFF));
	// vsubfp v8,v7,v8
	...
	simd::store_f32(ctx.v0.f32, simd::blend_f32(simd::load_f32(ctx.v0.f32), simd::permute_f32(simd::load_f32(ctx.v10.f32), 228), 1));
	// stvx128 v0,r3,r8
...
PPC_FUNC_IMPL(__imp__sub_82D55150) {
	...
	simd::store_shuffled_i8(base + ea, ctx.v0,
		VectorMaskL);
	// lvx128 v13,r5,r9
	ctx.v13 = simd::load_and_shuffle(base + ((ctx.r5.u32 + ctx.r9.u32) & ~0xF), VectorMaskL);
	// lvx128 v0,r0,r4
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r4.u32) & ~0xF), VectorMaskL);
	// vmulfp128 v0,v13,v0
	simd::store_f32_aligned(ctx.v0.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v13.f32), simd::load_f32_aligned(ctx.v0.f32)));
	...
	simd::store_shuffled_i8(base + ea, ctx.v0,
		VectorMaskL);
	// lvx128 v13,r5,r10
	ctx.v13 = simd::load_and_shuffle(base + ((ctx.r5.u32 + ctx.r10.u32) & ~0xF), VectorMaskL);
	// lvx128 v0,r0,r4
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r4.u32) & ~0xF), VectorMaskL);
	// vmulfp128 v0,v13,v0
	simd::store_f32_aligned(ctx.v0.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v13.f32), simd::load_f32_aligned(ctx.v0.f32)));
	...
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r4.u32) & ~0xF), VectorMaskL);
	// lvx128 v13,r5,r11
	ctx.v13 = simd::load_and_shuffle(base + ((ctx.r5.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// vmulfp128 v0,v13,v0
	simd::store_f32_aligned(ctx.v0.f32, simd::mul_f32(simd::load_f32_aligned(ctx.v13.f32), simd::load_f32_aligned(ctx.v0.f32)));
	// stvx128 v0,r3,r11
...
PPC_FUNC_IMPL(__imp__sub_82D55590) {
	...
	ctx.v13 = simd::load_and_shuffle(base + ((ctx.r10.u32) & ~0xF), VectorMaskL);
	// lvx128 v0,r4,r7
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r7.u32) & ~0xF), VectorMaskL);
	// vaddfp v0,v13,v0
	simd::store_f32_aligned(ctx.v0.f32, simd::add_f32(simd::load_f32_aligned(ctx.v13.f32), simd::load_f32_aligned(ctx.v0.f32)));
	// stvx128 v0,r0,r10
	ea = (ctx.r10.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v0,
		VectorMaskL);
	// lvx128 v0,r4,r6
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r6.u32) & ~0xF), VectorMaskL);
	// lvx128 v13,r0,r9
	ctx.v13 = simd::load_and_shuffle(base + ((ctx.r9.u32) & ~0xF), VectorMaskL);
	// vaddfp v0,v13,v0
	simd::store_f32_aligned(ctx.v0.f32, simd::add_f32(simd::load_f32_aligned(ctx.v13.f32), simd::load_f32_aligned(ctx.v0.f32)));
...
PPC_FUNC_IMPL(__imp__sub_82D55A30) {
	...
	simd::store_shuffled_i8(base + ea, ctx.v0,
		VectorMaskL);
	// lvx128 v0,r4,r9
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r9.u32) & ~0xF), VectorMaskL);
	// stvx128 v0,r3,r9
	ea = (ctx.r3.u32 + ctx.r9.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v0,
		VectorMaskL);
...
PPC_FUNC_IMPL(__imp__sub_82D55A80) {
	...
	// lvx128 v13,r4,r9
	ctx.v13 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r9.u32) & ~0xF), VectorMaskL);
	// subf r7,r11,r5
...
PPC_FUNC_IMPL(__imp__sub_82D55B78) {
	...
	ctx.r11.s64 = -2113929216;
	// lvx128 v0,r5,r10
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r5.u32 + ctx.r10.u32) & ~0xF), VectorMaskL);
	// addi r3,r1,80
	ctx.r3.s64 = ctx.r1.s64 + 80;
	// lvx128 v13,r5,r9
	ctx.v13 = simd::load_and_shuffle(base + ((ctx.r5.u32 + ctx.r9.u32) & ~0xF), VectorMaskL);
...
PPC_FUNC_IMPL(__imp__sub_82D59098) {
	...
	simd::store_i32(ctx.v6.u32, simd::permute_i32(simd::load_i32(ctx.v11.u32), 0x78));
	...
	simd::store_i32(ctx.v5.u32, simd::permute_i32(simd::load_i32(ctx.v10.u32), 0x9C));
	// vmulfp128 v7,v6,v7
	ctx.fpscr.enableFlushModeUnconditional();
	...
	simd::store_i32(ctx.v6.u32, simd::permute_i32(simd::load_i32(ctx.v9.u32), 0x78));
	// vpermwi128 v9,v9,99
	simd::store_i32(ctx.v9.u32, simd::permute_i32(simd::load_i32(ctx.v9.u32), 0x9C));
	...
	simd::store_i32(ctx.v10.u32, simd::permute_i32(simd::load_i32(ctx.v10.u32), 0x78));
...
PPC_FUNC_IMPL(__imp__sub_82D59358) {
	...
	// lvx128 v11,r4,r7
	ctx.v11 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r7.u32) & ~0xF), VectorMaskL);
loc_82D59378:
	// lvx128 v0,r0,r11
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r11.u32) & ~0xF), VectorMaskL);
	// addi r10,r10,-1
...
PPC_FUNC_IMPL(__imp__sub_82D59410) {
	...
	ctx.r10.s64 = ctx.r1.s64 + -16;
	// lvx128 v11,r4,r9
	ctx.v11 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r9.u32) & ~0xF), VectorMaskL);
	// addi r9,r3,32
...
loc_82D5B584:
	...
	// lvx128 v13,r31,r7
	ctx.v13 = simd::load_and_shuffle(base + ((ctx.r31.u32 + ctx.r7.u32) & ~0xF), VectorMaskL);
