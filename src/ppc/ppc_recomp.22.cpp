...
PPC_FUNC_IMPL(__imp__sub_823A77B8) {
	...
	// lwz r11,26980(r9)
	r11.u64 = PPC_LOAD_U32(ctx.r9.u32 + 26980);
	// lwz r10,26912(r10)
...
loc_823AA100:
	...
	r11.u64 = __builtin_rotateleft64(ctx.r4.u32 | (ctx.r4.u64 << 32), 19) & 0x1;
	// mr r30,r26
	r30.u64 = r26.u64;
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
...
loc_823AB534:
	...
	// lwz r8,26912(r29)
	ctx.r8.u64 = PPC_LOAD_U32(r29.u32 + 26912);
	// addi r7,r10,-28104
...
PPC_FUNC_IMPL(__imp__sub_823AC520) {
	...
	r11.s64 = -2092367872;
	// lwz r29,26788(r11)
	r29.u64 = PPC_LOAD_U32(r11.u32 + 26788);
	// lwz r10,32(r29)
...
PPC_FUNC_IMPL(__imp__sub_823AC688) {
	...
	r30.s64 = -2092367872;
	// lwz r11,26976(r30)
	r11.u64 = PPC_LOAD_U32(r30.u32 + 26976);
	// cmplw cr6,r11,r10
	cr6.compare<uint32_t>(r11.u32, ctx.r10.u32, xer);
	// blt cr6,0x823ac6d8
...
PPC_FUNC_IMPL(__imp__sub_823AD1F0) {
	...
	// lwz r31,3408(r4)
	r31.u64 = PPC_LOAD_U32(ctx.r4.u32 + 3408);
	// mr r4,r31
	ctx.r4.u64 = r31.u64;
	// lbz r30,64(r31)
...
loc_823ADA1C:
	...
	_mm_store_ps(ctx.v2.f32, _mm_mul_ps(_mm_load_ps(v127.f32), _mm_load_ps(ctx.v12.f32)));
	// lvx128 v0,r0,r5
...
PPC_FUNC_IMPL(__imp__sub_823B09B0) {
	...
	r11.s64 = -2092367872;
	// lwz r11,30600(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 30600);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x823b09e8
