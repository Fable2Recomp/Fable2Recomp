...
PPC_FUNC_IMPL(__imp__sub_82C02878) {
	...
	// lwz r11,19060(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 19060);
	// clrlwi r9,r11,31
...
PPC_FUNC_IMPL(__imp__sub_82C03FB8) {
	...
	// lwz r11,19096(r6)
	r11.u64 = PPC_LOAD_U32(ctx.r6.u32 + 19096);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82c04070
...
PPC_FUNC_IMPL(__imp__sub_82C04138) {
	...
	r26.u64 = ctx.r7.u64;
	// lwz r11,19096(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 19096);
	// mr r25,r8
	r25.u64 = ctx.r8.u64;
	// mr r24,r9
	r24.u64 = ctx.r9.u64;
...
loc_82C07E9C:
	...
	ctx.r3.u64 = r31.u64;
	// lwz r4,19188(r30)
	ctx.r4.u64 = PPC_LOAD_U32(r30.u32 + 19188);
	// bl 0x82c48360
	sub_82C48360(ctx, base);
	// lwz r11,19188(r30)
	r11.u64 = PPC_LOAD_U32(r30.u32 + 19188);
	// add r11,r3,r11
