...
PPC_FUNC_IMPL(__imp__sub_823A5928) {
	...
	ctx.r11.s64 = -2092367872;
	// stb r3,26985(r11)
	PPC_STORE_U8(ctx.r11.u32 + 26985, ctx.r3.u8);
	// blr 
	return;
}
...
PPC_FUNC_IMPL(__imp__sub_823A5938) {
	...
	ctx.r11.s64 = -2092367872;
	// stb r3,26984(r11)
	PPC_STORE_U8(ctx.r11.u32 + 26984, ctx.r3.u8);
	// blr 
	return;
}
...
PPC_FUNC_IMPL(__imp__sub_823A5948) {
	...
	ctx.r11.s64 = -2092367872;
	// stb r3,26986(r11)
	PPC_STORE_U8(ctx.r11.u32 + 26986, ctx.r3.u8);
	// blr 
	return;
}
...
PPC_FUNC_IMPL(__imp__sub_823A5958) {
	...
	ctx.r11.s64 = -2092367872;
	// stb r3,26987(r11)
	PPC_STORE_U8(ctx.r11.u32 + 26987, ctx.r3.u8);
	// blr 
	return;
}
...
PPC_FUNC_IMPL(__imp__sub_823A5968) {
	...
	PPC_STORE_U32(ctx.r11.u32 + -27668, temp.u32);
	// blr 
	return;
}
...
PPC_FUNC_IMPL(__imp__sub_823A5978) {
	...
	ctx.r11.s64 = -2092367872;
	// stb r3,27048(r11)
	PPC_STORE_U8(ctx.r11.u32 + 27048, ctx.r3.u8);
	// blr 
	return;
}
...
PPC_FUNC_IMPL(__imp__sub_823A5A28) {
	...
	// lwz r17,23132(r26)
	ctx.r17.u64 = PPC_LOAD_U32(ctx.r26.u32 + 23132);
	// lwz r17,23204(r26)
	ctx.r17.u64 = PPC_LOAD_U32(ctx.r26.u32 + 23204);
	// lwz r17,23276(r26)
	ctx.r17.u64 = PPC_LOAD_U32(ctx.r26.u32 + 23276);
	// lwz r17,23292(r26)
	ctx.r17.u64 = PPC_LOAD_U32(ctx.r26.u32 + 23292);
loc_823A5A5C:
	// lis r11,-32246
	ctx.r11.s64 = -2113273856;
	// lis r8,-31927
	...
	// stb r11,27056(r8)
	PPC_STORE_U8(ctx.r8.u32 + 27056, ctx.r11.u8);
	// lis r3,-31950
...
PPC_FUNC_IMPL(__imp__sub_823A6830) {
	...
	simd::store_f32(ctx.v2.f32, simd::blend_f32(simd::load_f32(ctx.v2.f32), simd::permute_f32(simd::load_f32(ctx.v13.f32), 78), 3));
	// lwz r3,88(r10)
...
loc_823A68F0:
	...
	simd::store_f32(ctx.v2.f32, simd::blend_f32(simd::load_f32(ctx.v2.f32), simd::permute_f32(simd::load_f32(ctx.v12.f32), 57), 4));
	// lwz r9,4(r10)
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r10.u32 + 4);
	// vrlimi128 v2,v13,3,2
	simd::store_f32(ctx.v2.f32, simd::blend_f32(simd::load_f32(ctx.v2.f32), simd::permute_f32(simd::load_f32(ctx.v13.f32), 78), 3));
...
loc_823A69EC:
	...
	ctx.r3.s64 = ctx.r1.s64 + 84;
	// lvx128 v127,r0,r7
	ctx.v127 = simd::load_and_shuffle(base + ((ctx.r7.u32) & ~0xF), VectorMaskL);
	// bl 0x8222cf18
	ctx.lr = 0x823A6A4C;
	sub_8222CF18(ctx, base);
	// lis r4,-32246
	...
	simd::store_f32_aligned(ctx.v1.f32, simd::add_f32(simd::load_f32_aligned(ctx.v127.f32), simd::load_f32_aligned(ctx.v13.f32)));
	// bl 0x82391198
	ctx.lr = 0x823A6AA8;
