...
PPC_FUNC_IMPL(__imp__sub_82D810F8) {
	...
	// lvx128 v13,r11,r4
	ctx.v13 = simd::load_and_shuffle(base + ((ctx.r11.u32 + ctx.r4.u32) & ~0xF), VectorMaskL);
	// addi r11,r10,5
...
ctx.r7.u32) & ~0x3;
	...
	// lvx128 v13,r10,r4
	ctx.v13 = simd::load_and_shuffle(base + ((ctx.r10.u32 + ctx.r4.u32) & ~0xF), VectorMaskL);
...
PPC_FUNC_IMPL(__imp__sub_82D81238) {
	...
	// lvx128 v0,r31,r30
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r31.u32 + ctx.r30.u32) & ~0xF), VectorMaskL);
	// vsubfp v0,v13,v0
	ctx.fpscr.enableFlushMode();
	...
	// lvx128 v13,r9,r31
	ctx.v13 = simd::load_and_shuffle(base + ((ctx.r9.u32 + ctx.r31.u32) & ~0xF), VectorMaskL);
	// addi r9,r1,96
...
loc_82D814EC:
	...
	// lvx128 v12,r4,r25
	ctx.v12 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r25.u32) & ~0xF), VectorMaskL);
	// vspltw v0,v0,2
	simd::store_i32(ctx.v0.u32, simd::permute_i32(simd::load_i32(ctx.v0.u32), 0x55));
	// lvx128 v11,r4,r26
	ctx.v11 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r26.u32) & ~0xF), VectorMaskL);
	// addi r10,r1,224
...
loc_82D81540:
	...
	simd::store_i32(ctx.v9.u32, simd::permute_i32(simd::load_i32(ctx.v0.u32), 0xAA));
	// lvx128 v12,r10,r25
	ctx.v12 = simd::load_and_shuffle(base + ((ctx.r10.u32 + ctx.r25.u32) & ~0xF), VectorMaskL);
	// vspltw v0,v0,2
	simd::store_i32(ctx.v0.u32, simd::permute_i32(simd::load_i32(ctx.v0.u32), 0x55));
	// lvx128 v11,r10,r26
	ctx.v11 = simd::load_and_shuffle(base + ((ctx.r10.u32 + ctx.r26.u32) & ~0xF), VectorMaskL);
	// addi r9,r1,224
...
loc_82D81674:
	...
	// lvx128 v0,r4,r25
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r25.u32) & ~0xF), VectorMaskL);
	// stvx128 v0,r0,r11
	ea = (ctx.r11.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v0,
		VectorMaskL);
	...
	// lvx128 v0,r4,r26
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r26.u32) & ~0xF), VectorMaskL);
	// stvx128 v0,r0,r11
	ea = (ctx.r11.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v0,
		VectorMaskL);
...
PPC_FUNC_IMPL(__imp__sub_82D81AC0) {
	...
	ctx.r11.u64 = __builtin_rotateleft64(ctx.r11.u32 | (ctx.r11.u64 << 32), 4) & 0xFFFFFFF0;
	// lvx128 v12,r11,r31
	ctx.v12 = simd::load_and_shuffle(base + ((ctx.r11.u32 + ctx.r31.u32) & ~0xF), VectorMaskL);
	// addi r11,r1,80
...
PPC_FUNC_IMPL(__imp__sub_82D81B48) {
	...
	ctx.r11.u64 = __builtin_rotateleft64(ctx.r11.u32 | (ctx.r11.u64 << 32), 4) & 0xFFFFFFF0;
	// lvx128 v13,r10,r31
	ctx.v13 = simd::load_and_shuffle(base + ((ctx.r10.u32 + ctx.r31.u32) & ~0xF), VectorMaskL);
	// addi r10,r1,96
	ctx.r10.s64 = ctx.r1.s64 + 96;
	// stvx128 v13,r0,r10
	ea = (ctx.r10.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v13,
		VectorMaskL);
	// lvx128 v13,r11,r31
	ctx.v13 = simd::load_and_shuffle(base + ((ctx.r11.u32 + ctx.r31.u32) & ~0xF), VectorMaskL);
	// addi r11,r1,80
	ctx.r11.s64 = ctx.r1.s64 + 80;
	// stvx128 v13,r0,r11
	ea = (ctx.r11.u32) & ~0xF;
...
PPC_FUNC_IMPL(__imp__sub_82D81F68) {
	...
	ctx.r9.u64 = PPC_LOAD_U32(ctx.r9.u32 + 0);
	// lvx128 v13,r31,r6
	ctx.v13 = simd::load_and_shuffle(base + ((ctx.r31.u32 + ctx.r6.u32) & ~0xF), VectorMaskL);
	// lwz r11,0(r10)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 0);
	// addi r9,r9,2
	ctx.r9.s64 = ctx.r9.s64 + 2;
...
loc_82D82B60:
	...
	// bgt cr6,0x82d82cd4
	if (ctx.cr6.gt) goto loc_82D82CD4;
	// lis r12,-32040
	ctx.r12.s64 = -2099773440;
	// addi r12,r12,11140
...
loc_82D82CD4:
	...
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, ctx.r7.u32, ctx.xer);
	// blt cr6,0x82d82b60
	if (ctx.cr6.lt) goto loc_82D82B60;
loc_82D82CE0:
	// blr 
	return;
}
...
loc_82D830D8:
	...
	// lvx128 v0,r29,r8
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r29.u32 + ctx.r8.u32) & ~0xF), VectorMaskL);
	// stvx128 v0,r0,r11
	ea = (ctx.r11.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v0,
		VectorMaskL);
...
PPC_FUNC_IMPL(__imp__sub_82D847A8) {
	...
	simd::store_shuffled_i8(base + ea, ctx.v0,
		VectorMaskL);
	// lvx128 v0,r9,r28
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r9.u32 + ctx.r28.u32) & ~0xF), VectorMaskL);
	// stvx128 v0,r8,r28
	ea = (ctx.r8.u32 + ctx.r28.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v0,
		VectorMaskL);
	// lvx128 v0,r11,r29
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r11.u32 + ctx.r29.u32) & ~0xF), VectorMaskL);
	// stvx128 v0,r10,r29
	...
	// lvx128 v0,r3,r30
	ctx.v0 = simd::load_and_shuffle(base + ((ctx.r3.u32 + ctx.r30.u32) & ~0xF), VectorMaskL);
	// stvx128 v0,r4,r30
