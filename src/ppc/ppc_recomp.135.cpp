...
loc_82D4D958:
	...
	// lwz r31,-408(r1)
	r31.u64 = PPC_LOAD_U32(ctx.r1.u32 + -408);
	// add r31,r3,r31
...
loc_82D4E3FC:
	...
	r30.s64 = -2093809664;
	// lwz r3,29252(r30)
	ctx.r3.u64 = PPC_LOAD_U32(r30.u32 + 29252);
	// cmplwi cr6,r3,0
...
PPC_FUNC_IMPL(__imp__sub_82D50440) {
	...
	// lwz r11,28000(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 28000);
	// mullw r11,r11,r9
...
PPC_FUNC_IMPL(__imp__sub_82D528F8) {
	...
	// lwz r31,29996(r11)
	r31.u64 = PPC_LOAD_U32(r11.u32 + 29996);
	// addi r11,r1,92
...
PPC_FUNC_IMPL(__imp__sub_82D52A28) {
	...
	r11.s64 = -2093809664;
	// lwz r3,29796(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + 29796);
	// lwz r11,0(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 0);
	// lwz r11,12(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 12);
...
PPC_FUNC_IMPL(__imp__sub_82D52B60) {
	...
	r11.s64 = -2094071808;
	// lwz r10,29932(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + 29932);
	// cmplwi cr6,r10,0
	cr6.compare<uint32_t>(ctx.r10.u32, 0, xer);
	// beq cr6,0x82d52bbc
	if (cr6.eq) goto loc_82D52BBC;
...
loc_82D52BBC:
	...
	r31.s64 = -2093809664;
	// lwz r3,29252(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + 29252);
	// lwz r11,0(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + 0);
	// lwz r11,64(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 64);
...
PPC_FUNC_IMPL(__imp__sub_82D52C90) {
	...
	r30.u64 = ctx.r3.u64;
	// lwz r3,30000(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + 30000);
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x82d52cf0
...
loc_82D53098:
	...
	// lwz r22,12500(r21)
	r22.u64 = PPC_LOAD_U32(r21.u32 + 12500);
	// lwz r22,12512(r21)
	r22.u64 = PPC_LOAD_U32(r21.u32 + 12512);
	// lwz r22,12524(r21)
	r22.u64 = PPC_LOAD_U32(r21.u32 + 12524);
	// lwz r22,12536(r21)
	r22.u64 = PPC_LOAD_U32(r21.u32 + 12536);
loc_82D530D4:
	// lis r11,-32254
	r11.s64 = -2113798144;
	// addi r4,r11,17476
