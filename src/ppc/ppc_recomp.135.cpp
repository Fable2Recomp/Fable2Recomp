...
loc_82D4A60C:
	...
	// fmsubs f1,f3,f0,f2
	ctx.f1.f64 = double(std::fma(float(ctx.f3.f64), float(ctx.f0.f64), -float(ctx.f2.f64)));
	// fadds f10,f2,f6
...
loc_82D4A7BC:
	...
	// fmsubs f1,f6,f0,f9
	ctx.f1.f64 = double(std::fma(float(ctx.f6.f64), float(ctx.f0.f64), -float(ctx.f9.f64)));
	// fadds f6,f9,f3
	...
	// fctiwz f7,f31
	ctx.f7.u64 = uint64_t(int32_t(std::trunc(ctx.f31.f64)));
	// stfd f7,-432(r1)
	...
	// fmsubs f6,f5,f0,f4
	ctx.f6.f64 = double(std::fma(float(ctx.f5.f64), float(ctx.f0.f64), -float(ctx.f4.f64)));
	// stb r3,0(r10)
...
PPC_FUNC_IMPL(__imp__sub_82D4FE00) {
	...
	// lvx128 v12,r4,r11
	ctx.v12 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// lvx128 v11,r4,r10
	ctx.v11 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r10.u32) & ~0xF), VectorMaskL);
	// lvx128 v10,r4,r9
	ctx.v10 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r9.u32) & ~0xF), VectorMaskL);
...
PPC_FUNC_IMPL(__imp__sub_82D4FE48) {
	...
	// lvx128 v10,r4,r8
	ctx.v10 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r8.u32) & ~0xF), VectorMaskL);
	// lvx128 v13,r0,r11
...
PPC_FUNC_IMPL(__imp__sub_82D501F8) {
	...
	simd::store_i32(ctx.v10.u32, simd::permute_i32(simd::load_i32(ctx.v0.u32), 0xFF));
	// lvx128 v12,r31,r11
	ctx.v12 = simd::load_and_shuffle(base + ((ctx.r31.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// vspltw v9,v0,1
	simd::store_i32(ctx.v9.u32, simd::permute_i32(simd::load_i32(ctx.v0.u32), 0xAA));
	// vspltw v0,v0,2
	simd::store_i32(ctx.v0.u32, simd::permute_i32(simd::load_i32(ctx.v0.u32), 0x55));
...
loc_82D50310:
	...
	// lvx128 v9,r5,r11
	ctx.v9 = simd::load_and_shuffle(base + ((ctx.r5.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// vsubfp v0,v9,v0
...
PPC_FUNC_IMPL(__imp__sub_82D50650) {
	...
	ctx.f0.f64 = -double(std::fma(float(ctx.f10.f64), float(ctx.f11.f64), -float(ctx.f0.f64)));
	// b 0x82d506c4
	goto loc_82D506C4;
loc_82D50694:
	// fadds f0,f0,f12
	...
	ctx.f13.f64 = -double(std::fma(float(ctx.f10.f64), float(ctx.f11.f64), -float(ctx.f0.f64)));
	// lfs f0,26876(r11)
...
loc_82D50ACC:
	...
	ctx.fpscr.disableFlushMode();
	ctx.f0.f64 = -double(std::fma(float(ctx.f31.f64), float(ctx.f31.f64), -float(ctx.f30.f64)));
	// fmuls f31,f1,f29
...
PPC_FUNC_IMPL(__imp__sub_82D50CA0) {
	...
	simd::store_f32_aligned(ctx.v127.f32, simd::add_f32(simd::load_f32_aligned(ctx.v0.f32), simd::load_f32_aligned(ctx.v0.f32)));
	// vmsum3fp128 v0,v13,v127
	simd::store_f32_aligned(ctx.v0.f32, simd::dp_f32(simd::load_f32_aligned(ctx.v13.f32), simd::load_f32_aligned(ctx.v127.f32), 0xEF));
	// stvewx v0,r0,r11
	ea = (
ctx.r11.u32) & ~0x3;
	uint32_t tmp_off = ea & 0xF;
...
loc_82D50DF4:
	...
	simd::store_i32(ctx.v12.u32, simd::permute_i32(simd::load_i32(ctx.v127.u32), 0x78));
