...
PPC_WEAK_FUNC(sub_82EDD670) {
	__imp__sub_82EDD670(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EDDB00) {
	__imp__sub_82EDDB00(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EDDD68) {
	__imp__sub_82EDDD68(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EDDDC8) {
	__imp__sub_82EDDDC8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EDDF10) {
	__imp__sub_82EDDF10(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82EDE100) {
	...
	ctx.f13.f64 = double(temp.f32);
	// fsubs f25,f0,f13
	ctx.f25.f64 = static_cast<float>(ctx.f0.f64 - ctx.f13.f64);
	// lfs f0,144(r31)
	temp.u32 = PPC_LOAD_U32(ctx.r31.u32 + 144);
	ctx.f0.f64 = double(temp.f32);
	// lfs f13,108(r31)
	...
	// fsubs f24,f0,f13
	ctx.f24.f64 = static_cast<float>(ctx.f0.f64 - ctx.f13.f64);
	// lfs f21,224(r31)
	temp.u32 = PPC_LOAD_U32(ctx.r31.u32 + 224);
...
loc_82EDE15C:
	...
	ctx.f0.f64 = double(std::fma(float(ctx.f24.f64), float(ctx.f24.f64), float(ctx.f0.f64)));
	// fmadds f13,f12,f24,f13
	ctx.f13.f64 = double(std::fma(float(ctx.f12.f64), float(ctx.f24.f64), float(ctx.f13.f64)));
	// fsqrts f0,f0
	ctx.f0.f64 = double(simde_math_sqrtf(float(ctx.f0.f64)));
	// fdivs f0,f31,f0
...
loc_82EDE1F8:
	...
	ctx.f0.f64 = double(std::fma(float(ctx.f13.f64), float(ctx.f24.f64), -float(ctx.f0.f64)));
	// fcmpu cr6,f0,f28
...
loc_82EDE254:
	...
	ctx.f13.f64 = double(std::fma(float(ctx.f31.f64), float(ctx.f29.f64), -float(ctx.f13.f64)));
...
loc_82EDE27C:
	...
	ctx.f0.f64 = double(std::fma(float(ctx.f13.f64), float(ctx.f25.f64), -float(ctx.f0.f64)));
	// lfs f13,64(r31)
...
PPC_WEAK_FUNC(sub_82EDE100) {
	__imp__sub_82EDE100(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EDE3A0) {
	__imp__sub_82EDE3A0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EDE820) {
	__imp__sub_82EDE820(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EDEB98) {
	__imp__sub_82EDEB98(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EDEF98) {
	__imp__sub_82EDEF98(ctx, base);
}
...
loc_82EDF088:
	...
	ctx.f6.f64 = double(temp.f32);
	// fmadds f3,f2,f31,f3
	ctx.f3.f64 = double(std::fma(float(ctx.f2.f64), float(ctx.f31.f64), float(ctx.f3.f64)));
	// lfs f26,26348(r11)
	temp.u32 = PPC_LOAD_U32(ctx.r11.u32 + 26348);
	ctx.f26.f64 = double(temp.f32);
	// fmuls f12,f13,f12
	...
	ctx.f13.f64 = double(std::fma(float(ctx.f6.f64), float(ctx.f11.f64), float(ctx.f13.f64)));
	// bne cr6,0x82edf174
...
loc_82EDF174:
	...
	ctx.f28.f64 = -double(std::fma(float(ctx.f11.f64), float(ctx.f0.f64), -float(ctx.f28.f64)));
	// fsubs f0,f13,f12
	ctx.f0.f64 = static_cast<float>(ctx.f13.f64 - ctx.f12.f64);
	// fadds f31,f12,f13
	ctx.f31.f64 = double(float(ctx.f12.f64 + ctx.f13.f64));
...
loc_82EDF1D0:
	...
	ctx.f30.f64 = double(std::fma(float(ctx.f11.f64), float(ctx.f12.f64), float(ctx.f9.f64)));
	// fcmpu cr6,f0,f30
	ctx.cr6.compare(ctx.f0.f64, ctx.f30.f64);
	// bgt cr6,0x82edf328
...
PPC_WEAK_FUNC(sub_82EDF050) {
	__imp__sub_82EDF050(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82EDF368) {
	...
	ctx.f10.f64 = double(std::fma(float(ctx.f12.f64), float(ctx.f10.f64), -float(ctx.f30.f64)));
	// lfs f22,3088(r11)
	...
	ctx.f11.f64 = double(std::fma(float(ctx.f13.f64), float(ctx.f11.f64), -float(ctx.f31.f64)));
	// fmsubs f9,f0,f9,f29
	ctx.f9.f64 = double(std::fma(float(ctx.f0.f64), float(ctx.f9.f64), -float(ctx.f29.f64)));
	// fmr f27,f22
	...
	// fsubs f9,f7,f13
	ctx.f9.f64 = static_cast<float>(ctx.f7.f64 - ctx.f13.f64);
	// fsubs f10,f8,f0
	ctx.f10.f64 = static_cast<float>(ctx.f8.f64 - ctx.f0.f64);
	// fmuls f30,f0,f11
	ctx.f30.f64 = double(float(ctx.f0.f64 * ctx.f11.f64));
	// fmuls f0,f3,f31
	...
	// fsubs f10,f9,f13
	ctx.f10.f64 = static_cast<float>(ctx.f9.f64 - ctx.f13.f64);
	// stfs f10,204(r1)
	temp.f32 = float(ctx.f10.f64);
	...
	// fsubs f10,f5,f12
	ctx.f10.f64 = static_cast<float>(ctx.f5.f64 - ctx.f12.f64);
	// stfs f10,208(r1)
	temp.f32 = float(ctx.f10.f64);
	...
	PPC_STORE_U32(ctx.r1.u32 + 184, temp.u32);
	// fsubs f0,f6,f12
	ctx.f0.f64 = static_cast<float>(ctx.f6.f64 - ctx.f12.f64);
	// stfs f0,220(r1)
	temp.f32 = float(ctx.f0.f64);
	PPC_STORE_U32(ctx.r1.u32 + 220, temp.u32);
loc_82EDF4C8:
	...
	ctx.f0.f64 = double(temp.f32);
	// fsubs f12,f12,f25
	ctx.f12.f64 = static_cast<float>(ctx.f12.f64 - ctx.f25.f64);
	// lfs f10,0(r28)
	temp.u32 = PPC_LOAD_U32(ctx.r28.u32 + 0);
	ctx.f10.f64 = double(temp.f32);
	// fmuls f0,f0,f13
...
loc_82EDF54C:
	...
	ctx.f20.f64 = double(std::fma(float(ctx.f12.f64), float(ctx.f31.f64), float(ctx.f27.f64)));
	// lwz r11,-720(r11)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r11.u32 + -720);
	// lfs f13,3080(r10)
	temp.u32 = PPC_LOAD_U32(ctx.r10.u32 + 3080);
...
loc_82EDF590:
	...
	ctx.f0.f64 = double(float(ctx.f13.f64 * ctx.f0.f64));
	// fsubs f13,f20,f4
	ctx.f13.f64 = static_cast<float>(ctx.f20.f64 - ctx.f4.f64);
	// fadds f21,f0,f29
...
loc_82EDF700:
	...
	ctx.f13.f64 = -double(std::fma(float(ctx.f0.f64), float(ctx.f31.f64), -float(ctx.f27.f64)));
	// fneg f11,f12
...
loc_82EDF738:
	...
	ctx.f11.f64 = double(std::fma(float(ctx.f11.f64), float(ctx.f17.f64), -float(ctx.f9.f64)));
	// fcmpu cr6,f0,f11
	ctx.cr6.compare(ctx.f0.f64, ctx.f11.f64);
	// bge cr6,0x82edf788
...
loc_82EDF76C:
	...
	ctx.f11.f64 = double(std::fma(float(ctx.f11.f64), float(ctx.f16.f64), float(ctx.f9.f64)));
	// fcmpu cr6,f13,f11
	ctx.cr6.compare(ctx.f13.f64, ctx.f11.f64);
	// bgt cr6,0x82edf7b8
	if (ctx.cr6.gt) goto loc_82EDF7B8;
...
PPC_WEAK_FUNC(sub_82EDF368) {
	__imp__sub_82EDF368(ctx, base);
}
...
loc_82EDF8A8:
	...
	ctx.f13.f64 = double(std::fma(float(ctx.f9.f64), float(ctx.f30.f64), float(ctx.f13.f64)));
	// fcmpu cr6,f13,f10
	ctx.cr6.compare(ctx.f13.f64, ctx.f10.f64);
	// blt cr6,0x82edfd78
...
loc_82EDF940:
	...
	ctx.f12.f64 = double(std::fma(float(ctx.f13.f64), float(ctx.f10.f64), -float(ctx.f12.f64)));
	// fmsubs f13,f13,f9,f11
	ctx.f13.f64 = double(std::fma(float(ctx.f13.f64), float(ctx.f9.f64), -float(ctx.f11.f64)));
	// lfs f11,180(r31)
	temp.u32 = PPC_LOAD_U32(ctx.r31.u32 + 180);
	ctx.f11.f64 = double(temp.f32);
	// fmr f10,f11
	...
	ctx.f29.f64 = double(std::fma(float(ctx.f9.f64), float(ctx.f31.f64), float(ctx.f11.f64)));
	// fmadds f25,f8,f13,f12
	ctx.f25.f64 = double(std::fma(float(ctx.f8.f64), float(ctx.f13.f64), float(ctx.f12.f64)));
	// bne 0x82edfac8
...
loc_82EDF9CC:
	...
	ctx.f0.f64 = double(std::fma(float(ctx.f0.f64), float(ctx.f27.f64), float(ctx.f13.f64)));
	// lfs f13,156(r31)
	temp.u32 = PPC_LOAD_U32(ctx.r31.u32 + 156);
	ctx.f13.f64 = double(temp.f32);
	// fmuls f13,f13,f30
...
loc_82EDFB14:
	...
	ctx.f12.f64 = double(std::fma(float(ctx.f12.f64), float(ctx.f10.f64), -float(ctx.f7.f64)));
	// lfs f8,3040(r11)
	temp.u32 = PPC_LOAD_U32(ctx.r11.u32 + 3040);
	ctx.f8.f64 = double(temp.f32);
	// fmsubs f11,f0,f11,f9
	ctx.f11.f64 = double(std::fma(float(ctx.f0.f64), float(ctx.f11.f64), -float(ctx.f9.f64)));
	// lfs f9,180(r31)
	temp.u32 = PPC_LOAD_U32(ctx.r31.u32 + 180);
	ctx.f9.f64 = double(temp.f32);
	// fmr f7,f9
	...
	ctx.f10.f64 = double(std::fma(float(ctx.f13.f64), float(ctx.f31.f64), float(ctx.f6.f64)));
	// lfs f6,188(r31)
	temp.u32 = PPC_LOAD_U32(ctx.r31.u32 + 188);
	ctx.f6.f64 = double(temp.f32);
	// fmr f5,f6
	...
	// fmadds f9,f6,f11,f9
	ctx.f9.f64 = double(std::fma(float(ctx.f6.f64), float(ctx.f11.f64), float(ctx.f9.f64)));
	// lfs f6,156(r31)
	temp.u32 = PPC_LOAD_U32(ctx.r31.u32 + 156);
	ctx.f6.f64 = double(temp.f32);
	// fmuls f6,f12,f6
	...
	// fmadds f7,f5,f13,f7
	ctx.f7.f64 = double(std::fma(float(ctx.f5.f64), float(ctx.f13.f64), float(ctx.f7.f64)));
	// lfs f5,156(r31)
	temp.u32 = PPC_LOAD_U32(ctx.r31.u32 + 156);
	ctx.f5.f64 = double(temp.f32);
	// fmuls f0,f5,f0
	...
	// fmadds f0,f5,f13,f0
	ctx.f0.f64 = double(std::fma(float(ctx.f5.f64), float(ctx.f13.f64), float(ctx.f0.f64)));
	// fmuls f9,f9,f28
	ctx.f9.f64 = double(float(ctx.f9.f64 * ctx.f28.f64));
	// fabs f0,f0
	ctx.f0.u64 = ctx.f0.u64 & 0x7FFFFFFFFFFFFFFF;
	// fmadds f7,f7,f2,f9
	ctx.f7.f64 = double(std::fma(float(ctx.f7.f64), float(ctx.f2.f64), float(ctx.f9.f64)));
	// fmadds f9,f4,f11,f6
	ctx.f9.f64 = double(std::fma(float(ctx.f4.f64), float(ctx.f11.f64), float(ctx.f6.f64)));
	// fabs f13,f9
	ctx.f13.u64 = ctx.f9.u64 & 0x7FFFFFFFFFFFFFFF;
	// fmuls f13,f13,f28
	ctx.f13.f64 = double(float(ctx.f13.f64 * ctx.f28.f64));
	// fmadds f6,f0,f2,f13
	ctx.f6.f64 = double(std::fma(float(ctx.f0.f64), float(ctx.f2.f64), float(ctx.f13.f64)));
	// beq 0x82edfc08
...
loc_82EDFC08:
	...
	ctx.f9.f64 = double(std::fma(float(ctx.f9.f64), float(ctx.f27.f64), float(ctx.f13.f64)));
	// fneg f5,f9
	...
	ctx.f13.f64 = double(std::fma(float(ctx.f11.f64), float(ctx.f31.f64), float(ctx.f12.f64)));
	// fneg f12,f0
	ctx.f12.u64 = ctx.f0.u64 ^ 0x8000000000000000;
	// fcmpu cr6,f13,f12
	ctx.cr6.compare(ctx.f13.f64, ctx.f12.f64);
...
loc_82EDFC50:
	...
	ctx.f13.f64 = double(std::fma(float(ctx.f12.f64), float(ctx.f31.f64), float(ctx.f13.f64)));
	// fmuls f0,f0,f27
	ctx.f0.f64 = double(float(ctx.f0.f64 * ctx.f27.f64));
	// fabs f13,f13
	...
	ctx.f0.f64 = -double(std::fma(float(ctx.f0.f64), float(ctx.f27.f64), -float(ctx.f29.f64)));
	// fmuls f8,f0,f13
...
PPC_WEAK_FUNC(sub_82EDF838) {
	__imp__sub_82EDF838(ctx, base);
}
...
loc_82EDFDF8:
	...
	// fmsubs f0,f0,f13,f7
	ctx.f0.f64 = double(std::fma(float(ctx.f0.f64), float(ctx.f13.f64), -float(ctx.f7.f64)));
	// stfs f0,168(r31)
	temp.f32 = float(ctx.f0.f64);
	PPC_STORE_U32(ctx.r31.u32 + 168, temp.u32);
	// fmsubs f13,f10,f12,f6
	ctx.f13.f64 = double(std::fma(float(ctx.f10.f64), float(ctx.f12.f64), -float(ctx.f6.f64)));
	// stfs f13,172(r31)
	temp.f32 = float(ctx.f13.f64);
	PPC_STORE_U32(ctx.r31.u32 + 172, temp.u32);
	// fmsubs f12,f9,f11,f5
	ctx.f12.f64 = double(std::fma(float(ctx.f9.f64), float(ctx.f11.f64), -float(ctx.f5.f64)));
	// stfs f12,176(r31)
	temp.f32 = float(ctx.f12.f64);
	...
	ctx.f12.f64 = double(temp.f32);
	// fmadds f2,f0,f8,f13
	ctx.f2.f64 = double(std::fma(float(ctx.f0.f64), float(ctx.f8.f64), float(ctx.f13.f64)));
	// lis r11,-32256
	ctx.r11.s64 = -2113929216;
	// stfs f2,64(r31)
...
PPC_WEAK_FUNC(sub_82EDFD88) {
	__imp__sub_82EDFD88(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE0118) {
	__imp__sub_82EE0118(ctx, base);
}
...
loc_82EE0448:
	...
	ctx.f13.f64 = double(float(ctx.f13.f64 * ctx.f1.f64));
	// fmadds f1,f0,f3,f13
	ctx.f1.f64 = double(std::fma(float(ctx.f0.f64), float(ctx.f3.f64), float(ctx.f13.f64)));
	// blr 
	return;
}

PPC_WEAK_FUNC(sub_82EE03A0) {
	__imp__sub_82EE03A0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE0468) {
	__imp__sub_82EE0468(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE04C8) {
	__imp__sub_82EE04C8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE0618) {
	__imp__sub_82EE0618(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE0790) {
	__imp__sub_82EE0790(ctx, base);
}
...
PPC_FUNC_IMPL(__imp__sub_82EE08E8) {
	...
	ctx.f21.f64 = double(std::fma(float(ctx.f12.f64), float(ctx.f13.f64), float(ctx.f11.f64)));
	// lfs f18,16(r11)
	temp.u32 = PPC_LOAD_U32(ctx.r11.u32 + 16);
	ctx.f18.f64 = double(temp.f32);
	// fcmpu cr6,f0,f18
...
loc_82EE09A4:
	...
	ctx.fpscr.disableFlushMode();
	ctx.f0.f64 = double(std::fma(float(ctx.f18.f64), float(ctx.f15.f64), -float(ctx.f21.f64)));
loc_82EE09A8:
	// lis r11,-32256
	ctx.r11.s64 = -2113929216;
	// lfs f13,2680(r11)
...
loc_82EE09C0:
	...
	ctx.f9.f64 = double(temp.f32);
	// fsubs f14,f27,f21
	ctx.f14.f64 = static_cast<float>(ctx.f27.f64 - ctx.f21.f64);
	// stfs f7,92(r1)
	...
	ctx.f16.f64 = double(std::fma(float(ctx.f11.f64), float(ctx.f9.f64), float(ctx.f0.f64)));
	// mr. r11,r9
...
loc_82EE0B6C:
	...
	ctx.cr0.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// fmadds f8,f13,f0,f8
	ctx.f8.f64 = double(std::fma(float(ctx.f13.f64), float(ctx.f0.f64), float(ctx.f8.f64)));
	// bne 0x82ee0aa4
...
loc_82EE0D40:
	...
	ctx.f0.f64 = double(std::fma(float(ctx.f0.f64), float(ctx.f29.f64), float(ctx.f30.f64)));
	// b 0x82ee0d5c
	goto loc_82EE0D5C;
loc_82EE0D58:
	// fmr f0,f31
...
loc_82EE0D5C:
	...
	ctx.f31.f64 = double(std::fma(float(ctx.f13.f64), float(ctx.f28.f64), float(ctx.f1.f64)));
loc_82EE0D70:
	// fcmpu cr6,f31,f0
	ctx.fpscr.disableFlushMode();
	ctx.cr6.compare(ctx.f31.f64, ctx.f0.f64);
...
loc_82EE0D7C:
	...
	ctx.f13.f64 = double(std::fma(float(ctx.f18.f64), float(ctx.f15.f64), -float(ctx.f13.f64)));
	// fmuls f0,f0,f1
	ctx.f0.f64 = double(float(ctx.f0.f64 * ctx.f1.f64));
	// fmuls f13,f13,f0
	ctx.f13.f64 = double(float(ctx.f13.f64 * ctx.f0.f64));
...
loc_82EE0EC4:
	// fsubs f13,f3,f16
	ctx.fpscr.disableFlushMode();
	ctx.f13.f64 = static_cast<float>(ctx.f3.f64 - ctx.f16.f64);
	// lfs f10,268(r31)
	temp.u32 = PPC_LOAD_U32(ctx.r31.u32 + 268);
	ctx.f10.f64 = double(temp.f32);
	// lfs f12,260(r31)
	...
	// fsubs f13,f24,f10
	ctx.f13.f64 = static_cast<float>(ctx.f24.f64 - ctx.f10.f64);
	// b 0x82ee0eec
	goto loc_82EE0EEC;
loc_82EE0EE8:
	// fmr f13,f17
...
loc_82EE1014:
	...
	// fmadds f0,f6,f13,f0
	ctx.f0.f64 = double(std::fma(float(ctx.f6.f64), float(ctx.f13.f64), float(ctx.f0.f64)));
	// lfs f13,3192(r11)
...
PPC_WEAK_FUNC(sub_82EE08E8) {
	__imp__sub_82EE08E8(ctx, base);
}
...
loc_82EE1190:
	...
	ctx.f12.f64 = double(std::fma(float(ctx.f26.f64), float(ctx.f12.f64), float(ctx.f9.f64)));
	// fmadds f9,f0,f0,f10
	...
	ctx.f4.f64 = double(std::fma(float(ctx.f13.f64), float(ctx.f8.f64), float(ctx.f12.f64)));
	// fmuls f31,f29,f4
	...
	// fmadds f1,f13,f7,f9
	ctx.f1.f64 = double(std::fma(float(ctx.f13.f64), float(ctx.f7.f64), float(ctx.f9.f64)));
	// fabs f13,f1
	...
	ctx.f5.f64 = double(std::fma(float(ctx.f13.f64), float(ctx.f27.f64), float(ctx.f12.f64)));
	// lwz r11,-29332(r10)
...
loc_82EE1274:
	...
	ctx.cr6.compare(ctx.f4.f64, ctx.f13.f64);
	// fmadds f0,f0,f0,f11
	ctx.f0.f64 = double(std::fma(float(ctx.f0.f64), float(ctx.f0.f64), float(ctx.f11.f64)));
	// fadds f0,f0,f10
	ctx.f0.f64 = double(float(ctx.f0.f64 + ctx.f10.f64));
	// fsqrts f0,f0
	ctx.f0.f64 = double(simde_math_sqrtf(float(ctx.f0.f64)));
...
loc_82EE12E4:
	...
	// fsubs f3,f1,f5
	ctx.f3.f64 = static_cast<float>(ctx.f1.f64 - ctx.f5.f64);
	// b 0x82ee12f8
	goto loc_82EE12F8;
loc_82EE12F4:
	// fmr f3,f11
...
loc_82EE13A0:
	...
	ctx.f13.f64 = double(std::fma(float(ctx.f26.f64), float(ctx.f9.f64), float(ctx.f25.f64)));
	// lfs f0,16(r10)
	temp.u32 = PPC_LOAD_U32(ctx.r10.u32 + 16);
	ctx.f0.f64 = double(temp.f32);
	// fmuls f13,f13,f28
...
loc_82EE146C:
	// fmadds f0,f0,f6,f31
	ctx.fpscr.disableFlushMode();
	ctx.f0.f64 = double(std::fma(float(ctx.f0.f64), float(ctx.f6.f64), float(ctx.f31.f64)));
	// fcmpu cr6,f12,f0
	ctx.cr6.compare(ctx.f12.f64, ctx.f0.f64);
	// bge cr6,0x82ee1480
...
loc_82EE1504:
	...
	ctx.f0.f64 = double(temp.f32);
	// fmadds f0,f0,f27,f4
	ctx.f0.f64 = double(std::fma(float(ctx.f0.f64), float(ctx.f27.f64), float(ctx.f4.f64)));
	// lfs f13,20(r31)
	temp.u32 = PPC_LOAD_U32(ctx.r31.u32 + 20);
	ctx.f13.f64 = double(temp.f32);
	// lwz r11,0(r31)
...
PPC_WEAK_FUNC(sub_82EE10F0) {
	__imp__sub_82EE10F0(ctx, base);
}
...
loc_82EE1784:
	...
	ctx.f29.f64 = -double(std::fma(float(ctx.f0.f64), float(ctx.f24.f64), -float(ctx.f13.f64)));
	// lis r11,-32256
	ctx.r11.s64 = -2113929216;
	// lfs f31,16(r31)
	temp.u32 = PPC_LOAD_U32(ctx.r31.u32 + 16);
...
loc_82EE17D8:
	...
	ctx.f13.f64 = double(std::fma(float(ctx.f0.f64), float(ctx.f24.f64), float(ctx.f31.f64)));
	// lfs f12,12(r10)
	temp.u32 = PPC_LOAD_U32(ctx.r10.u32 + 12);
	ctx.f12.f64 = double(temp.f32);
	// fcmpu cr6,f13,f12
...
loc_82EE18A4:
	...
	ctx.f31.f64 = double(std::fma(float(ctx.f13.f64), float(ctx.f0.f64), float(ctx.f31.f64)));
	// fcmpu cr6,f31,f29
	ctx.cr6.compare(ctx.f31.f64, ctx.f29.f64);
	// blt cr6,0x82ee17d4
...
PPC_WEAK_FUNC(sub_82EE15B0) {
	__imp__sub_82EE15B0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE1A20) {
	__imp__sub_82EE1A20(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE1AE8) {
	__imp__sub_82EE1AE8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE1C48) {
	__imp__sub_82EE1C48(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE1C60) {
	__imp__sub_82EE1C60(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE1CA8) {
	__imp__sub_82EE1CA8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE1CF8) {
	__imp__sub_82EE1CF8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE1D08) {
	__imp__sub_82EE1D08(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE1DF0) {
	__imp__sub_82EE1DF0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE1E00) {
	__imp__sub_82EE1E00(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE1E60) {
	__imp__sub_82EE1E60(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE1E70) {
	__imp__sub_82EE1E70(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE1ED0) {
	__imp__sub_82EE1ED0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE1F30) {
	__imp__sub_82EE1F30(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE1F5C) {
	__imp__sub_82EE1F5C(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE1F60) {
	__imp__sub_82EE1F60(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE1F68) {
	__imp__sub_82EE1F68(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE1FC0) {
	__imp__sub_82EE1FC0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE1FD0) {
	__imp__sub_82EE1FD0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE2030) {
	__imp__sub_82EE2030(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE2040) {
	__imp__sub_82EE2040(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE20A0) {
	__imp__sub_82EE20A0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE20B0) {
	__imp__sub_82EE20B0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE2130) {
	__imp__sub_82EE2130(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE2200) {
	__imp__sub_82EE2200(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE2220) {
	__imp__sub_82EE2220(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE22F0) {
	__imp__sub_82EE22F0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE2830) {
	__imp__sub_82EE2830(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE2A48) {
	__imp__sub_82EE2A48(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE3208) {
	__imp__sub_82EE3208(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE3600) {
	__imp__sub_82EE3600(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE37B8) {
	__imp__sub_82EE37B8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE3920) {
	__imp__sub_82EE3920(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE3A88) {
	__imp__sub_82EE3A88(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE3BF0) {
	__imp__sub_82EE3BF0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE3C00) {
	__imp__sub_82EE3C00(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE3C70) {
	__imp__sub_82EE3C70(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE3CE0) {
	__imp__sub_82EE3CE0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE3D50) {
	__imp__sub_82EE3D50(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE3DD8) {
	__imp__sub_82EE3DD8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE3E60) {
	__imp__sub_82EE3E60(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE3EE8) {
	__imp__sub_82EE3EE8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE3F70) {
	__imp__sub_82EE3F70(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE42B8) {
	__imp__sub_82EE42B8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4590) {
	__imp__sub_82EE4590(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4630) {
	__imp__sub_82EE4630(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE46D0) {
	__imp__sub_82EE46D0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4770) {
	__imp__sub_82EE4770(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4808) {
	__imp__sub_82EE4808(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4928) {
	__imp__sub_82EE4928(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4978) {
	__imp__sub_82EE4978(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE49A8) {
	__imp__sub_82EE49A8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4AC8) {
	__imp__sub_82EE4AC8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4B00) {
	__imp__sub_82EE4B00(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4B20) {
	__imp__sub_82EE4B20(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4B50) {
	__imp__sub_82EE4B50(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4B90) {
	__imp__sub_82EE4B90(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4BD8) {
	__imp__sub_82EE4BD8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4C90) {
	__imp__sub_82EE4C90(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4CF0) {
	__imp__sub_82EE4CF0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4D28) {
	__imp__sub_82EE4D28(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4DB0) {
	__imp__sub_82EE4DB0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4E00) {
	__imp__sub_82EE4E00(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4E50) {
	__imp__sub_82EE4E50(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE4E88) {
	__imp__sub_82EE4E88(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5018) {
	__imp__sub_82EE5018(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE52F0) {
	__imp__sub_82EE52F0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5338) {
	__imp__sub_82EE5338(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5378) {
	__imp__sub_82EE5378(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE53D8) {
	__imp__sub_82EE53D8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5510) {
	__imp__sub_82EE5510(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE55B8) {
	__imp__sub_82EE55B8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5660) {
	__imp__sub_82EE5660(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5710) {
	__imp__sub_82EE5710(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE57B8) {
	__imp__sub_82EE57B8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5860) {
	__imp__sub_82EE5860(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5900) {
	__imp__sub_82EE5900(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE59A8) {
	__imp__sub_82EE59A8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5A60) {
	__imp__sub_82EE5A60(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5AA8) {
	__imp__sub_82EE5AA8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5AC8) {
	__imp__sub_82EE5AC8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5B10) {
	__imp__sub_82EE5B10(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5B28) {
	__imp__sub_82EE5B28(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5B68) {
	__imp__sub_82EE5B68(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5BA8) {
	__imp__sub_82EE5BA8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5BE8) {
	__imp__sub_82EE5BE8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5C30) {
	__imp__sub_82EE5C30(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5C58) {
	__imp__sub_82EE5C58(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5C78) {
	__imp__sub_82EE5C78(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5CC0) {
	__imp__sub_82EE5CC0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5CE8) {
	__imp__sub_82EE5CE8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5D08) {
	__imp__sub_82EE5D08(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5DA8) {
	__imp__sub_82EE5DA8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE5DE0) {
	__imp__sub_82EE5DE0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6038) {
	__imp__sub_82EE6038(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE60B8) {
	__imp__sub_82EE60B8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6530) {
	__imp__sub_82EE6530(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6830) {
	__imp__sub_82EE6830(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6840) {
	__imp__sub_82EE6840(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6980) {
	__imp__sub_82EE6980(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE69C0) {
	__imp__sub_82EE69C0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6A10) {
	__imp__sub_82EE6A10(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6A68) {
	__imp__sub_82EE6A68(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6AA0) {
	__imp__sub_82EE6AA0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6C58) {
	__imp__sub_82EE6C58(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6C88) {
	__imp__sub_82EE6C88(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6CC0) {
	__imp__sub_82EE6CC0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6D18) {
	__imp__sub_82EE6D18(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6E10) {
	__imp__sub_82EE6E10(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6E48) {
	__imp__sub_82EE6E48(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6EA0) {
	__imp__sub_82EE6EA0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6ED0) {
	__imp__sub_82EE6ED0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6F00) {
	__imp__sub_82EE6F00(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6F38) {
	__imp__sub_82EE6F38(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6F60) {
	__imp__sub_82EE6F60(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE6F90) {
	__imp__sub_82EE6F90(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7038) {
	__imp__sub_82EE7038(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7060) {
	__imp__sub_82EE7060(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7098) {
	__imp__sub_82EE7098(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE70C8) {
	__imp__sub_82EE70C8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7108) {
	__imp__sub_82EE7108(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7180) {
	__imp__sub_82EE7180(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE71E8) {
	__imp__sub_82EE71E8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7220) {
	__imp__sub_82EE7220(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7238) {
	__imp__sub_82EE7238(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7280) {
	__imp__sub_82EE7280(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7298) {
	__imp__sub_82EE7298(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE72A8) {
	__imp__sub_82EE72A8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE72F0) {
	__imp__sub_82EE72F0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7330) {
	__imp__sub_82EE7330(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7360) {
	__imp__sub_82EE7360(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7378) {
	__imp__sub_82EE7378(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7408) {
	__imp__sub_82EE7408(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7438) {
	__imp__sub_82EE7438(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7450) {
	__imp__sub_82EE7450(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE74E0) {
	__imp__sub_82EE74E0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7518) {
	__imp__sub_82EE7518(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE75A8) {
	__imp__sub_82EE75A8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE75D8) {
	__imp__sub_82EE75D8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7608) {
	__imp__sub_82EE7608(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7638) {
	__imp__sub_82EE7638(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7668) {
	__imp__sub_82EE7668(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7730) {
	__imp__sub_82EE7730(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7768) {
	__imp__sub_82EE7768(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7808) {
	__imp__sub_82EE7808(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7930) {
	__imp__sub_82EE7930(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7980) {
	__imp__sub_82EE7980(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE79F8) {
	__imp__sub_82EE79F8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7A30) {
	__imp__sub_82EE7A30(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7AB0) {
	__imp__sub_82EE7AB0(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7BF8) {
	__imp__sub_82EE7BF8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7DF8) {
	__imp__sub_82EE7DF8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7E48) {
	__imp__sub_82EE7E48(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7E70) {
	__imp__sub_82EE7E70(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE7FC8) {
	__imp__sub_82EE7FC8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE8008) {
	__imp__sub_82EE8008(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE8070) {
	__imp__sub_82EE8070(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE80B8) {
	__imp__sub_82EE80B8(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE8108) {
	__imp__sub_82EE8108(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE8190) {
	__imp__sub_82EE8190(ctx, base);
}
...
PPC_WEAK_FUNC(sub_82EE81F0) {
	__imp__sub_82EE81F0(ctx, base);
}
