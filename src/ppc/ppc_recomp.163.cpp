...
PPC_FUNC_IMPL(__imp__sub_82EF2D10) {
	...
	// lwz r11,-29220(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(-29220) );
	// clrlwi. r9,r11,31
...
PPC_FUNC_IMPL(__imp__sub_82EF4878) {
	...
	// lwz r4,52(r3)
	ctx.r4.u64 = PPC_LOAD_U32(ctx.r3.u32 + int32_t(52) );
	// mtctr r11
	ctr.u64 = r11.u64;
	// bctr 
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
...
PPC_FUNC_IMPL(__imp__sub_82EF5408) {
	...
	r29.u64 = ctx.r3.u64;
	// lwz r11,-29216(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + int32_t(-29216) );
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// bne cr6,0x82ef5448
...
loc_82EF5448:
	// lwz r31,-29216(r31)
	r31.u64 = PPC_LOAD_U32(r31.u32 + int32_t(-29216) );
	// stw r29,80(r1)
	PPC_STORE_U32(ctx.r1.u32 + 80, r29.u32);
	// addi r30,r31,4
	r30.s64 = r31.s64 + 4;
...
PPC_FUNC_IMPL(__imp__sub_82EF5488) {
	...
	// lwz r3,-29216(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(-29216) );
	// bl 0x82ef5390
...
loc_82EF553C:
	...
	ctx.r4.u64 = r31.u64;
	// lwz r3,-29216(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-29216) );
	// bl 0x82ef5318
...
PPC_FUNC_IMPL(__imp__sub_82EF6EA0) {
	...
	r11.s64 = -2093613056;
	// lwz r3,-29208(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-29208) );
	// blr 
	return;
}
...
PPC_FUNC_IMPL(__imp__sub_82EF6ED8) {
	...
	r11.s64 = -2094006272;
	// lwz r3,-7848(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-7848) );
	// blr 
	return;
}
...
PPC_FUNC_IMPL(__imp__sub_82EF6EE8) {
	...
	r11.s64 = -2094006272;
	// lwz r3,-7840(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-7840) );
	// blr 
	return;
}
...
PPC_FUNC_IMPL(__imp__sub_82EF9208) {
	...
	// lwz r3,732(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(732) );
	// lwz r11,0(r3)
	r11.u64 = PPC_LOAD_U32(ctx.r3.u32 + int32_t(0) );
	// lwz r11,56(r11)
...
PPC_FUNC_IMPL(__imp__sub_82EF92D0) {
	...
	// lwz r9,84(r29)
	ctx.r9.u64 = PPC_LOAD_U32(r29.u32 + int32_t(84) );
	// stb r10,69(r29)
...
loc_82EF930C:
	...
	sub_82F29440(ctx, base);
	// lwz r30,680(r29)
	r30.u64 = PPC_LOAD_U32(r29.u32 + int32_t(680) );
	// cmplwi cr6,r30,0
	cr6.compare<uint32_t>(r30.u32, 0, xer);
	// bne cr6,0x82ef9358
