...
loc_82FB585C:
	...
	// lwz r30,16(r14)
	r30.u64 = PPC_LOAD_U32(r14.u32 + 16);
...
loc_82FB594C:
	...
	ctx.f13.f64 = double(ctx.f13.s64);
	// lwz r3,24(r14)
	ctx.r3.u64 = PPC_LOAD_U32(r14.u32 + 24);
	// frsp f0,f0
...
loc_82FB74E0:
	...
	ctx.r3.u64 = r30.u64;
	// lwz r11,-3496(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + -3496);
	// lwz r11,4(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 4);
	// mtctr r11
	ctr.u64 = r11.u64;
...
PPC_FUNC_IMPL(__imp__sub_82FB9660) {
	...
	r29.u64 = ctx.r4.u64;
	// lwz r11,-27420(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + -27420);
	// clrlwi. r9,r11,31
...
PPC_FUNC_IMPL(__imp__sub_82FB96D8) {
	...
	r29.u64 = ctx.r4.u64;
	// lwz r11,-27412(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + -27412);
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// bne 0x82fb9724
...
loc_82FB9E74:
	...
	r11.u64 = PPC_LOAD_U32(r31.u32 + 40);
	// lwz r29,296(r11)
	r29.u64 = PPC_LOAD_U32(r11.u32 + 296);
	// addi r10,r29,1
...
loc_82FBC4A0:
	...
	ctx.r3.u64 = r30.u64;
	// lwz r28,436(r27)
	r28.u64 = PPC_LOAD_U32(r27.u32 + 436);
	// bl 0x82efc418
	sub_82EFC418(ctx, base);
	// mulli r11,r28,3
	r11.s64 = r28.s64 * 3;
...
loc_82FBD868:
	...
	// lwz r10,36(r17)
	ctx.r10.u64 = PPC_LOAD_U32(r17.u32 + 36);
...
loc_82FBDB5C:
	...
	// lwz r3,88(r25)
	ctx.r3.u64 = PPC_LOAD_U32(r25.u32 + 88);
	// addi r31,r25,88
	r31.s64 = r25.s64 + 88;
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
...
loc_82FBE514:
	...
	// lwz r11,1148(r1)
	r11.u64 = PPC_LOAD_U32(ctx.r1.u32 + 1148);
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82fbe8e4
...
loc_82FBE5A0:
	...
	// lwz r31,12(r18)
	r31.u64 = PPC_LOAD_U32(r18.u32 + 12);
	// stw r29,120(r1)
...
loc_82FBE694:
	...
	sub_82FC0C58(ctx, base);
	// lwz r5,36(r25)
	ctx.r5.u64 = PPC_LOAD_U32(r25.u32 + 36);
	// cmplwi cr6,r20,0
	cr6.compare<uint32_t>(r20.u32, 0, xer);
	// mr r4,r31
	ctx.r4.u64 = r31.u64;
...
loc_82FBE880:
	// lwz r11,1240(r1)
	r11.u64 = PPC_LOAD_U32(ctx.r1.u32 + 1240);
	// mr r31,r29
	r31.u64 = r29.u64;
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
...
PPC_FUNC_IMPL(__imp__sub_82FBEB38) {
	...
	PPC_STORE_U32(ctx.r1.u32 + 108, temp.u32);
	// lwz r26,20(r7)
	r26.u64 = PPC_LOAD_U32(ctx.r7.u32 + 20);
	// lvx128 v62,r0,r21
...
loc_82FBED38:
	...
	// lwz r6,4(r19)
	ctx.r6.u64 = PPC_LOAD_U32(r19.u32 + 4);
	// cmplwi cr6,r6,0
	cr6.compare<uint32_t>(ctx.r6.u32, 0, xer);
	// beq cr6,0x82fbed58
...
loc_82FBEE98:
	// lwz r27,108(r30)
	r27.u64 = PPC_LOAD_U32(r30.u32 + 108);
	// stw r31,80(r1)
	PPC_STORE_U32(ctx.r1.u32 + 80, r31.u32);
	// mr r3,r27
	ctx.r3.u64 = r27.u64;
...
PPC_FUNC_IMPL(__imp__sub_82FBFC78) {
	...
	// bl 0x82ca2bdc
	// lwz r26,28(r3)
	r26.u64 = PPC_LOAD_U32(ctx.r3.u32 + 28);
	// li r29,0
	r29.s64 = 0;
	// li r31,0
	r31.s64 = 0;
...
loc_82FC0830:
	...
	// lwz r11,-27404(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + -27404);
	// clrlwi. r9,r11,31
	ctx.r9.u64 = r11.u32 & 0x1;
	cr0.compare<int32_t>(ctx.r9.s32, 0, xer);
	// bne 0x82fc0868
...
PPC_FUNC_IMPL(__imp__sub_82FC0A88) {
	...
	r30.u64 = ctx.r4.u64;
	// lwz r11,-27380(r31)
	r11.u64 = PPC_LOAD_U32(r31.u32 + -27380);
	// clrlwi. r10,r11,31
