...
PPC_FUNC_IMPL(__imp__sub_832AE098) {
	...
	r11.s64 = -2092302336;
	// lwz r3,21196(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(21196) );
	// cmplwi cr6,r3,0
...
PPC_FUNC_IMPL(__imp__sub_832AE2C0) {
	...
	r30.s64 = -2092302336;
	// lwz r31,21312(r30)
	r31.u64 = PPC_LOAD_U32(r30.u32 + int32_t(21312) );
	// cmplwi cr6,r31,0
...
PPC_FUNC_IMPL(__imp__sub_832AE3F0) {
	...
	r11.s64 = -2092302336;
	// lwz r3,21416(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(21416) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832AE950) {
	...
	r31.s64 = -2092302336;
	// lwz r3,21784(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + int32_t(21784) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x832ae984
...
PPC_FUNC_IMPL(__imp__sub_832AEAE0) {
	...
	r11.s64 = -2091974656;
	// lwz r3,-11784(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(-11784) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832AEEF0) {
	...
	r11.s64 = -2092302336;
	// lwz r3,23192(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(23192) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832AEFA0) {
	...
	r11.s64 = -2092171264;
	// lwz r3,5792(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(5792) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
...
PPC_FUNC_IMPL(__imp__sub_832AF9F0) {
	...
	// lwz r11,28560(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + int32_t(28560) );
	// addi r11,r11,-64
	r11.s64 = r11.s64 + -64;
	// stw r11,28560(r10)
...
PPC_FUNC_IMPL(__imp__sub_832AFC38) {
	...
	r11.s64 = -2094202880;
	// lwz r3,24548(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + int32_t(24548) );
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beqlr cr6
	if (cr6.eq) return;
