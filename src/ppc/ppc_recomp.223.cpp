...
PPC_FUNC_IMPL(__imp__sub_83291390) {
	...
	ctx.r4.s64 = 0;
	// lwz r8,-10980(r11)
	ctx.r8.u64 = PPC_LOAD_U32(r11.u32 + -10980);
	// addi r3,r31,300
...
PPC_FUNC_IMPL(__imp__sub_832921A8) {
	...
	// lwz r11,28556(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 28556);
	// stw r11,200(r10)
...
PPC_FUNC_IMPL(__imp__sub_83292328) {
	...
	r11.s64 = -2094071808;
	// lwz r10,28952(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + 28952);
	// lis r11,-31953
	r11.s64 = -2094071808;
	// addi r11,r11,28984
...
PPC_FUNC_IMPL(__imp__sub_83292808) {
	...
	// lwz r11,30720(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 30720);
	// stw r11,56(r10)
...
PPC_FUNC_IMPL(__imp__sub_832930D8) {
	...
	// lwz r11,32376(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 32376);
	// stw r11,32(r10)
...
PPC_FUNC_IMPL(__imp__sub_832937F0) {
	...
	// lwz r11,32608(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + 32608);
	// stw r11,8(r10)
	PPC_STORE_U32(ctx.r10.u32 + 8, r11.u32);
	// blr 
	return;
...
PPC_FUNC_IMPL(__imp__sub_832938E8) {
	...
	// lwz r11,-32768(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + -32768);
	// stw r11,8(r10)
	PPC_STORE_U32(ctx.r10.u32 + 8, r11.u32);
	// blr 
	return;
...
PPC_FUNC_IMPL(__imp__sub_83293B30) {
	...
	// lwz r11,-32552(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + -32552);
	// stw r11,32(r10)
	PPC_STORE_U32(ctx.r10.u32 + 32, r11.u32);
	// blr 
	return;
...
PPC_FUNC_IMPL(__imp__sub_83295138) {
	...
	r11.s64 = -2094006272;
	// lwz r10,-29696(r11)
	ctx.r10.u64 = PPC_LOAD_U32(r11.u32 + -29696);
	// lis r11,-31952
	r11.s64 = -2094006272;
	// addi r11,r11,-29672
...
PPC_FUNC_IMPL(__imp__sub_83295E08) {
	...
	// lwz r11,-28728(r11)
	r11.u64 = PPC_LOAD_U32(r11.u32 + -28728);
	// stw r11,32(r10)
	PPC_STORE_U32(ctx.r10.u32 + 32, r11.u32);
	// blr 
	return;
