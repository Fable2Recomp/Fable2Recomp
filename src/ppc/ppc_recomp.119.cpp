...
loc_82C4E834:
	...
	// lvx128 v63,r10,r11
	_mm_store_si128((__m128i*)v63.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r10.u32 + r11.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// vmsum3fp128 v62,v63,v63
	ctx.fpscr.enableFlushMode();
	_mm_store_ps(v62.f32, _mm_dp_ps(_mm_load_ps(v63.f32), _mm_load_ps(v63.f32), 0xEF));
	// stvx128 v62,r0,r9
...
loc_82C4EDC0:
	...
	ctx.r7.u64 = __builtin_rotateleft64(r27.u32 | (r27.u64 << 32), 0) & 0x800;
	// cmplwi cr6,r7,0
	cr6.compare<uint32_t>(ctx.r7.u32, 0, xer);
	// beq cr6,0x82c4eee8
	if (cr6.eq) goto loc_82C4EEE8;
	...
	// lvx128 v1,r31,r10
	_mm_store_si128((__m128i*)ctx.v1.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((r31.u32 + ctx.r10.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
...
PPC_FUNC_IMPL(__imp__sub_82C4F240) {
	...
	cr6.compare<int32_t>(r11.s32, 1, xer);
	// lwz r21,0(r24)
	r21.u64 = PPC_LOAD_U32(r24.u32 + 0);
	// blt cr6,0x82c4f28c
...
loc_82C4F2A8:
	...
	r11.u64 = __builtin_rotateleft64(r21.u32 | (r21.u64 << 32), 0) & 0x800;
	// stw r25,232(r31)
...
loc_82C4F510:
	...
	// lwz r11,24856(r9)
	r11.u64 = PPC_LOAD_U32(ctx.r9.u32 + 24856);
	// stw r8,236(r31)
	...
	// lwz r22,-2660(r4)
	r22.u64 = PPC_LOAD_U32(ctx.r4.u32 + -2660);
	// lwz r22,-2660(r4)
	r22.u64 = PPC_LOAD_U32(ctx.r4.u32 + -2660);
	// lwz r22,-2544(r4)
	r22.u64 = PPC_LOAD_U32(ctx.r4.u32 + -2544);
	// lwz r22,-2652(r4)
	r22.u64 = PPC_LOAD_U32(ctx.r4.u32 + -2652);
	// lwz r22,-2640(r4)
	r22.u64 = PPC_LOAD_U32(ctx.r4.u32 + -2640);
	// lwz r22,-2628(r4)
	r22.u64 = PPC_LOAD_U32(ctx.r4.u32 + -2628);
	// lwz r22,-2616(r4)
	r22.u64 = PPC_LOAD_U32(ctx.r4.u32 + -2616);
	// lwz r22,-2604(r4)
	r22.u64 = PPC_LOAD_U32(ctx.r4.u32 + -2604);
	// lwz r22,-2592(r4)
	r22.u64 = PPC_LOAD_U32(ctx.r4.u32 + -2592);
	// lwz r22,-2580(r4)
	r22.u64 = PPC_LOAD_U32(ctx.r4.u32 + -2580);
	// lwz r22,-2568(r4)
	r22.u64 = PPC_LOAD_U32(ctx.r4.u32 + -2568);
	// lwz r22,-2556(r4)
	r22.u64 = PPC_LOAD_U32(ctx.r4.u32 + -2556);
	// lwz r22,-2592(r4)
	r22.u64 = PPC_LOAD_U32(ctx.r4.u32 + -2592);
	// lwz r22,-2580(r4)
	r22.u64 = PPC_LOAD_U32(ctx.r4.u32 + -2580);
...
loc_82C4F644:
	...
	r11.u64 = __builtin_rotateleft64(r21.u32 | (r21.u64 << 32), 0) & 0x4000;
	// cmplwi cr6,r11,0
	cr6.compare<uint32_t>(r11.u32, 0, xer);
	// beq cr6,0x82c4f65c
...
PPC_FUNC_IMPL(__imp__sub_82C4F750) {
	...
	// stvx128 v62,r31,r9
	_mm_store_si128((__m128i*)(base + ((r31.u32 + ctx.r9.u32) & ~0xF)), _mm_shuffle_epi8(_mm_load_si128((__m128i*)v62.u8), _mm_load_si128((__m128i*)VectorMaskL)));
	// stw r30,128(r31)
...
PPC_FUNC_IMPL(__imp__sub_82C508C0) {
	...
	f0.f64 = double(temp.f32);
	// fmadds f1,f12,f0,f0
	ctx.f1.f64 = double(float(ctx.f12.f64 * f0.f64 + f0.f64));
	// bl 0x82239e88
...
PPC_FUNC_IMPL(__imp__sub_82C515A8) {
	...
	ctx.r9.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 31) & 0x7;
	// cmplwi cr6,r9,0
	cr6.compare<uint32_t>(ctx.r9.u32, 0, xer);
	// beq cr6,0x82c515e4
...
loc_82C51844:
	...
	r31.u64 = __builtin_rotateleft64(r11.u32 | (r11.u64 << 32), 1) & 0xFFFE;
	// bl 0x830418a8
	sub_830418A8(ctx, base);
	// divwu r3,r3,r31
...
PPC_FUNC_IMPL(__imp__sub_82C51870) {
	...
	sub_830418A8(ctx, base);
	// lwz r5,72(r29)
	ctx.r5.u64 = PPC_LOAD_U32(r29.u32 + 72);
	// subf. r30,r5,r3
...
PPC_FUNC_IMPL(__imp__sub_82C51C08) {
	...
	r12.s64 = 48;
	// stvx128 v2,r1,r12
	_mm_store_si128((__m128i*)(base + ((ctx.r1.u32 + r12.u32) & ~0xF)), _mm_shuffle_epi8(_mm_load_si128((__m128i*)ctx.v2.u8), _mm_load_si128((__m128i*)VectorMaskL)));
	// addi r11,r1,32
	...
	r12.s64 = 64;
	// stvx128 v3,r1,r12
	_mm_store_si128((__m128i*)(base + ((ctx.r1.u32 + r12.u32) & ~0xF)), _mm_shuffle_epi8(_mm_load_si128((__m128i*)ctx.v3.u8), _mm_load_si128((__m128i*)VectorMaskL)));
	// lwz r7,-16(r1)
...
loc_82C52000:
	...
	// lwz r11,636(r4)
	r11.u64 = PPC_LOAD_U32(ctx.r4.u32 + 636);
	// cmplwi cr6,r11,1
...
PPC_FUNC_IMPL(__imp__sub_82C52648) {
	...
	r11.s64 = 32;
	// lvx128 v63,r4,r11
	_mm_store_si128((__m128i*)v63.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r4.u32 + r11.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// stvx128 v63,r0,r3
...
loc_82C5266C:
	...
	ctx.r7.s64 = ctx.r1.s64 + -16;
	// lvx128 v62,r4,r8
	_mm_store_si128((__m128i*)v62.u8, _mm_shuffle_epi8(_mm_load_si128((__m128i*)(base + ((ctx.r4.u32 + ctx.r8.u32) & ~0xF))), _mm_load_si128((__m128i*)VectorMaskL)));
	// vsubfp128 v13,v62,v0
	ctx.fpscr.enableFlushModeUnconditional();
	_mm_store_ps(ctx.v13.f32, _mm_sub_ps(_mm_load_ps(v62.f32), _mm_load_ps(ctx.v0.f32)));
	// frsp f10,f12
	ctx.fpscr.disableFlushModeUnconditional();
...
loc_82C529FC:
	...
	// lwz r11,20388(r10)
	r11.u64 = PPC_LOAD_U32(ctx.r10.u32 + 20388);
	// lwz r4,92(r11)
	ctx.r4.u64 = PPC_LOAD_U32(r11.u32 + 92);
	// bl 0x82c0caf8
	sub_82C0CAF8(ctx, base);
...
loc_82C52A44:
	// lwz r3,392(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + 392);
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x82c52a54
...
loc_82C52C1C:
	...
	ctx.f5.f64 = double(float(ctx.f6.f64 / ctx.f7.f64));
	// fmadds f0,f5,f12,f0
	f0.f64 = double(float(ctx.f5.f64 * ctx.f12.f64 + f0.f64));
loc_82C52C58:
	// lfs f13,668(r31)
	ctx.fpscr.disableFlushMode();
	temp.u32 = PPC_LOAD_U32(r31.u32 + 668);
	...
	// lwz r11,20388(r30)
	r11.u64 = PPC_LOAD_U32(r30.u32 + 20388);
	// lwz r9,44(r11)
...
loc_82C52C94:
	...
	// fmadds f0,f4,f6,f0
	f0.f64 = double(float(ctx.f4.f64 * ctx.f6.f64 + f0.f64));
loc_82C52CD0:
	// fmuls f0,f13,f0
	ctx.fpscr.disableFlushMode();
...
loc_82C52CD8:
	...
	// lwz r6,500(r31)
	ctx.r6.u64 = PPC_LOAD_U32(r31.u32 + 500);
	// stfs f31,12(r6)
	temp.f32 = float(f31.f64);
	...
	ctx.fpscr.enableFlushModeUnconditional();
	_mm_store_ps(v63.f32, _mm_dp_ps(_mm_load_ps(v63.f32), _mm_load_ps(v63.f32), 0xEF));
	// stvx128 v63,r0,r10
...
loc_82C52D80:
	// lwz r3,20388(r30)
	ctx.r3.u64 = PPC_LOAD_U32(r30.u32 + 20388);
	// lvx128 v1,r0,r11
...
loc_82C52E3C:
	...
	ctx.f12.f64 = double(float(ctx.f4.f64 * ctx.f11.f64 + f0.f64));
loc_82C52E94:
	// lis r10,-32256
	ctx.r10.s64 = -2113929216;
	// fmuls f13,f13,f12
...
loc_82C534D8:
	// lwz r31,336(r29)
	r31.u64 = PPC_LOAD_U32(r29.u32 + 336);
	// lwz r3,24(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + 24);
	// bl 0x82cd2c98
	sub_82CD2C98(ctx, base);
...
loc_82C535DC:
	...
	// rldicl r11,r9,63,1
	r11.u64 = __builtin_rotateleft64(ctx.r9.u64, 63) & 0x7FFFFFFFFFFFFFFF;
	// add r8,r11,r10
	ctx.r8.u64 = r11.u64 + ctx.r10.u64;
	// std r8,624(r29)
...
PPC_FUNC_IMPL(__imp__sub_82C53A00) {
	...
	// lwz r7,636(r31)
	ctx.r7.u64 = PPC_LOAD_U32(r31.u32 + 636);
	// lfs f12,672(r31)
	ctx.fpscr.disableFlushMode();
...
PPC_FUNC_IMPL(__imp__sub_82C53D90) {
	...
	// lwz r29,20388(r10)
	r29.u64 = PPC_LOAD_U32(ctx.r10.u32 + 20388);
	// bl 0x822ba2f8
	...
	// stvx128 v60,r28,r10
	_mm_store_si128((__m128i*)(base + ((r28.u32 + ctx.r10.u32) & ~0xF)), _mm_shuffle_epi8(_mm_load_si128((__m128i*)v60.u8), _mm_load_si128((__m128i*)VectorMaskL)));
	// stvx128 v60,r28,r9
	_mm_store_si128((__m128i*)(base + ((r28.u32 + ctx.r9.u32) & ~0xF)), _mm_shuffle_epi8(_mm_load_si128((__m128i*)v60.u8), _mm_load_si128((__m128i*)VectorMaskL)));
	// addi r1,r1,144
	ctx.r1.s64 = ctx.r1.s64 + 144;
	// lfd f31,-48(r1)
...
loc_82C54094:
	...
	ctx.r4.u64 = r30.u64;
	// lwz r5,676(r30)
	ctx.r5.u64 = PPC_LOAD_U32(r30.u32 + 676);
	// bl 0x82c526c8
...
loc_82C5410C:
	...
	r30.s64 = r31.s64 + 284;
	// lwz r31,284(r31)
	r31.u64 = PPC_LOAD_U32(r31.u32 + 284);
	// cmplwi cr6,r31,0
	cr6.compare<uint32_t>(r31.u32, 0, xer);
	// beq cr6,0x82c54190
...
loc_82C54514:
	...
	r11.s64 = -2113929216;
	// lwz r6,652(r30)
	ctx.r6.u64 = PPC_LOAD_U32(r30.u32 + 652);
	// addi r5,r1,80
	ctx.r5.s64 = ctx.r1.s64 + 80;
	// mr r4,r26
	ctx.r4.u64 = r26.u64;
...
PPC_FUNC_IMPL(__imp__sub_82C54CA8) {
	...
	// lwz r3,20388(r31)
	ctx.r3.u64 = PPC_LOAD_U32(r31.u32 + 20388);
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// beq cr6,0x82c54d6c
...
PPC_FUNC_IMPL(__imp__sub_82C54DB0) {
	...
	ctx.r4.s64 = ctx.r1.s64 + 80;
	// lwz r11,20388(r9)
	r11.u64 = PPC_LOAD_U32(ctx.r9.u32 + 20388);
	// addi r3,r11,300
	ctx.r3.s64 = r11.s64 + 300;
	// lwz r7,312(r11)
	ctx.r7.u64 = PPC_LOAD_U32(r11.u32 + 312);
	// stb r8,685(r10)
...
loc_82C54E98:
	...
	r11.s64 = -2113929216;
	// lwz r6,656(r31)
	ctx.r6.u64 = PPC_LOAD_U32(r31.u32 + 656);
	// addi r5,r1,80
	ctx.r5.s64 = ctx.r1.s64 + 80;
	// addi r3,r31,376
...
loc_82C54F64:
	...
	ctx.r10.u64 = __builtin_rotateleft64(r30.u32 | (r30.u64 << 32), 29) & 0x1;
	// stw r29,396(r31)
	PPC_STORE_U32(r31.u32 + 396, r29.u32);
	// rlwinm r9,r30,28,31,31
	ctx.r9.u64 = __builtin_rotateleft64(r30.u32 | (r30.u64 << 32), 28) & 0x1;
	// stw r28,632(r31)
...
PPC_FUNC_IMPL(__imp__sub_82C550C0) {
	...
	// lwz r31,284(r30)
	r31.u64 = PPC_LOAD_U32(r30.u32 + 284);
	// subf r28,r4,r11
...
PPC_FUNC_IMPL(__imp__sub_82C553D0) {
	...
	// lwz r11,104(r12)
	r11.u64 = PPC_LOAD_U32(r12.u32 + 104);
	// mtctr r11
	ctr.u64 = r11.u64;
	// bctr 
	PPC_CALL_INDIRECT_FUNC(ctr.u32);
...
PPC_FUNC_IMPL(__imp__sub_82C55648) {
	...
	// stvx128 v60,r31,r9
	_mm_store_si128((__m128i*)(base + ((r31.u32 + ctx.r9.u32) & ~0xF)), _mm_shuffle_epi8(_mm_load_si128((__m128i*)v60.u8), _mm_load_si128((__m128i*)VectorMaskL)));
	// stw r11,80(r31)
...
PPC_FUNC_IMPL(__imp__sub_82C557A8) {
	...
	// stvx128 v127,r11,r9
	_mm_store_si128((__m128i*)(base + ((r11.u32 + ctx.r9.u32) & ~0xF)), _mm_shuffle_epi8(_mm_load_si128((__m128i*)v127.u8), _mm_load_si128((__m128i*)VectorMaskL)));
	// stw r8,16(r11)
...
PPC_FUNC_IMPL(__imp__sub_82C566A0) {
	...
	// lwz r22,26364(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + 26364);
	// lwz r22,26424(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + 26424);
	// lwz r22,26604(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + 26604);
	// lwz r22,26484(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + 26484);
	// lwz r22,26544(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + 26544);
loc_82C566FC:
	// lwz r3,0(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + 0);
	// cmplwi cr6,r3,0
...
PPC_FUNC_IMPL(__imp__sub_82C56828) {
	...
	// lwz r22,26736(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + 26736);
	// lwz r22,26744(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + 26744);
	// lwz r22,26752(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + 26752);
	// lwz r22,26760(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + 26760);
	// lwz r22,26768(r5)
	r22.u64 = PPC_LOAD_U32(ctx.r5.u32 + 26768);
loc_82C56870:
	// lwz r3,0(r11)
	ctx.r3.u64 = PPC_LOAD_U32(r11.u32 + 0);
	// blr 
...
PPC_FUNC_IMPL(__imp__sub_82C568A0) {
	...
	r11.s64 = -2113929216;
	// lwz r3,20404(r30)
	ctx.r3.u64 = PPC_LOAD_U32(r30.u32 + 20404);
	// cmplwi cr6,r3,0
	cr6.compare<uint32_t>(ctx.r3.u32, 0, xer);
	// lfs f31,3084(r11)
	temp.u32 = PPC_LOAD_U32(r11.u32 + 3084);
