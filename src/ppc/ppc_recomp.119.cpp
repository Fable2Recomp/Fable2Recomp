...
PPC_FUNC_IMPL(__imp__sub_82C52648) {
	...
	ctx.r11.s64 = 32;
	// lvx128 v63,r4,r11
	ctx.v63 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r11.u32) & ~0xF), VectorMaskL);
	// stvx128 v63,r0,r3
	ea = (ctx.r3.u32) & ~0xF;
...
loc_82C5266C:
	...
	// lvx128 v62,r4,r8
	ctx.v62 = simd::load_and_shuffle(base + ((ctx.r4.u32 + ctx.r8.u32) & ~0xF), VectorMaskL);
	// vsubfp128 v13,v62,v0
	ctx.fpscr.enableFlushModeUnconditional();
	simd::store_f32_aligned(ctx.v13.f32, simd::sub_f32(simd::load_f32_aligned(ctx.v62.f32), simd::load_f32_aligned(ctx.v0.f32)));
	// frsp f10,f12
	...
	simd::store_shuffled(ctx.v61.u8, base + (temp.u32 & ~0xF), &VectorMaskL[(temp.u32 & 0xF) * 16]);
	// vspltw128 v12,v61,0
	simd::store_i32(ctx.v12.u32, simd::permute_i32(simd::load_i32(ctx.v61.u32), 0xFF));
...
loc_82C52CD8:
	...
	ctx.fpscr.enableFlushModeUnconditional();
	simd::store_f32_aligned(ctx.v63.f32, simd::dp_f32(simd::load_f32_aligned(ctx.v63.f32), simd::load_f32_aligned(ctx.v63.f32), 0xEF));
	// stvx128 v63,r0,r10
	ea = (ctx.r10.u32) & ~0xF;
	simd::store_shuffled_i8(base + ea, ctx.v63,
		VectorMaskL);
...
PPC_FUNC_IMPL(__imp__sub_82C53420) {
	...
	ctx.r10.s64 = 32;
	// lvx128 v63,r0,r3
	ctx.v63 = simd::load_and_shuffle(base + ((ctx.r3.u32) & ~0xF), VectorMaskL);
	// cmplwi cr6,r29,0
	ctx.cr6.compare<uint32_t>(ctx.r29.u32, 0, ctx.xer);
	// stw r29,4(r31)
